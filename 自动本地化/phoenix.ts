    ...
    FacetArray_B: [
        {
            ...
            related_abilities: [
                {
                    ability_classname: "imba_phoenix_sun_ray",
                    description: "烈日炙烤的光束末端对目标造成的伤害/治疗增加。光束强度从光束的后半段开始增加，在{focal_point_full_length_tooltip_only}距离达到最高的{focal_point_max_multiplier}%基础伤害/治疗。如果使烈日炙烤的光束距离增加，在{focal_point_full_length_tooltip_only}距离之外的伤害和治疗量会超过{focal_point_max_multiplier}%。"
                }
            ],
            related_talents: []
        }
