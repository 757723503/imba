    ...
    AbilityArray: [
        {
            ...
            shard_description: "棒击大地对沿途和末端的敌人施加乾坤之跃，威力为最长持续施法时间的{spring_channel_pct}%。棒击大地设为多样施法后，齐天大圣还会跳跃至金箍棒的另一端。",
            notes: [
                "不会作用于减益免疫单位。"
            ]
        },
    ...
    FacetArray_B: [
        {
            ...
            name: "猿猴步法 | 大圣坚阵",
            description: "齐天大圣的生命值高于{s:bonus_no_cooldown_hp_threshold}%时丛林之舞无冷却。 齐天大圣的猴子猴孙持续时间更长，而且离开圆阵后不会马上消散，除非他在圆阵外停留的时间超过{s:bonus_leadership_time_buffer}秒。",
            related_abilities: [
                {
                    ability_classname: "imba_monkey_king_tree_dance",
                ...
                {
                    ability_classname: "imba_monkey_king_wukongs_command",
                    description: "齐天大圣的猴子猴孙持续时间更长，而且离开圆阵后不会马上消散，除非他在圆阵外停留的时间超过{leadership_time_buffer}秒。"
                }
            ],
            related_talents: []
        }
