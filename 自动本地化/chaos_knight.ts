...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: "混沌之军",
            description: "从其他维度召唤若干个混沌骑士的幻象。幻象继承{outgoing_damage_tooltip}%攻击力，但是承受{outgoing_damage_tooltip}%伤害。\\n驱散类型：弱驱散",
    ...
    FacetArray_B: [
        {
            ...
            name: "无理",
            description: "实相裂隙除了平常效果外，还有均等几率施加破坏、缴械或沉默，持续时间为基础负面效果时间的{s:bonus_additional_debuff_duration_percent}%。",
            related_abilities: [
                {
                    ability_classname: "imba_chaos_knight_reality_rift",
                    description: "实相裂隙除了平常效果外，还有均等几率施加破坏、缴械或沉默，持续时间为基础负面效果时间的{additional_debuff_duration_percent}%。"
                }
            ],
            related_talents: []
        }
