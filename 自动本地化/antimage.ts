    ...
    AbilityArray: [
        {
            ...
            notes: [
                "幻象继承的法力损毁效果为{illusion_percentage}%。"
            ]
        },
        {
            ...
            name: "绝人之路",
            description: "攻击会根据敌人缺失的魔法值造成减速。{mana_threshold}%魔法时造成最低减速，{mana_threshold}%魔法时造成最高减速。敌人高于{mana_threshold}%魔法时没有效果。",
            notes: [
                "幻象造成全额效果。"
            ]
        },
        {
            ...
            scepter_description: "施放闪烁后，{empowered_mana_break_duration}秒内下一次的法力损毁将额外燃烧{empowered_max_burn_pct_tooltip}%最大魔法值，并且阻止目标在短时间内恢复或获得魔法。这个负面效果无法驱散。闪烁的冷却时间减少{bonus_AbilityCooldown}秒。",
            notes: [
        ...
        },
        {
            ...
            name: "友军法术反制",
            description: "在附近一个友军目标周围制造一个反魔法外壳，抵挡所有指向性技能。法术反制或友军法术反制抵挡技能后，都会在敌人身旁产生一个敌法师的幻象。",
            notes: []
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            related_abilities: [
                ...
                {
                    ability_classname: "imba_antimage_mana_void",
                    description: "敌方英雄的魔法值低于{min_bonus_pct}%时会被动提供攻击力，而且魔法值越低，提升效果越大。<br><br>如果敌人的魔法值低于{min_bonus_pct}%，敌法师获得攻击力加成的最大值，以及该英雄的视野和真实视域。会施加给{thirst_range}范围内的敌方英雄。每个英雄提供的加成效果可以叠加。"
                }
            ],
            related_talents: []
        }
