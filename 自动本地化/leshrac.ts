...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [],
            name: "时光滋养",
            description: "拉席克攻击敌人后会回复{mana_pct_per_hit}%造成伤害的魔法。只有在攻击拥有魔法的敌人时才会获得魔法。攻击非英雄单位时回复的魔法减少{mana_pct_per_hit}%。",
            notes: []
        },
        {
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "虚无主义",
            description: "减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%移动速度并且受到的魔法伤害增加{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。"
        }
    ]
};