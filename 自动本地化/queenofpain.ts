    ...
    AbilityArray: [
        {
            ...
            scepter_description: "暗影突袭变为{aoe_radius}范围型技能，并且初始伤害提升。暗影突袭效果结束后或重新施加给敌方英雄时，目标将放出痛苦尖叫，伤害附近所有敌人。",
            notes: [
        ...
        },
        {
            ...
            notes: [
                "距离为{max_radius}时效果最低，为{spell_lifesteal}%，距离在{close_radius}时提升至{spell_lifesteal}%。"
            ]
        },
        {
