...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: "掠食",
            description: "冥界亚龙的攻击会根据目标英雄缺失的生命百分比额外造成一次物理伤害，每缺失1%{造成的伤害为}damage_base{ + }damage_per_level% * 冥界亚龙等级。",
            notes: []
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            related_abilities: [
                {
                    ability_classname: "imba_viper_poison_attack",
                    description: "毒性攻击的叠加效果结束后，目标附近的敌人都会受到额外伤害，数值为毒性攻击造成魔法伤害的{accumulated_damage_explosion_pct}%。"
                },
                {
                    ability_classname: "imba_viper_corrosive_skin",
    ...
    ModifierArray: [
        {
            ...
            name: "毒性攻击减速",
            description: "移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，魔法抗性降低{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。持续受到伤害。"
        },
        {
