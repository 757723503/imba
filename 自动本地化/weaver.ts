...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            shard_description: "缩地在造成伤害的敌人身上留下一个标记，持续{geminate_attack_mark_duration}秒。编织者脱离缩地状态{shukuchi_attack_delay}秒后，附近{shukuchi_attack_mark_radius}范围内拥有印记的敌人都会被连击的第二次攻击击中。",
            notes: [
