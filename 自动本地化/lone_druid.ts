...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            scepter_description: "独行德鲁伊切断与熊灵的链接，并与目标友方英雄建立链接，与他们共享灵魂链接的加成效果，持续{duration}秒。护甲共享和攻击速度加成的效果均提升{active_bonus}%。友军造成的伤害会治疗独行德鲁伊，反之亦然。<br><br>熊灵在变形期间会被恐惧，除非熊灵也拥有阿哈利姆神杖。",
            notes: [
                "破坏会使共享吸血效果失效。"
            ]
        },
    ...
    FacetArray_B: [
        {
            ...
            name: "熊姿英发 | 一世之熊 | 熊亦求精",
            description: "灵魂链接的共享护甲增加，并且独行德鲁伊的攻击可以治疗熊灵。 真熊形态会改变熊灵的形态，而不是独行德鲁伊的。提升了独行德鲁伊和熊灵相距较远时允许熊灵攻击的距离。 独行德鲁伊的物品更具威力，而他的物品栏更少。",
            related_abilities: [
                {
                    ability_classname: "imba_lone_druid_spirit_bear",
