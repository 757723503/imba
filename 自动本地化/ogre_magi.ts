    ...
    FacetArray_B: [
        {
            ...
            name: "大有希望 | 曲线学习",
            description: "多重施法几率提升，数值为食人魔魔法师力量值的{s:bonus_strength_mult}%。 所有技能和天赋的等级要求降低了{s:bonus_required_level}级。一级时会获得{s:bonus_level_one_ability_points}点技能点，二级时会获得{s:bonus_level_two_ability_points}点技能点。",
            related_abilities: [
                {
                    ability_classname: "imba_ogre_magi_multicast",
