...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: "熠熠生辉",
            description: "破晓辰星在数次攻击后提升了力量，她的下一次攻击会造成致命一击，并治疗她附近{heal_radius}范围内所有友方英雄，治疗量为攻击伤害的一定百分比。攻击小兵和野怪产生的治疗量有所减少。对友军的治疗量为{allied_healing_pct}%。",
    ...
    FacetArray_B: [
        {
            ...
            name: "闪光之锤 | 太阳能充电",
            description: "上界重锤在地面上会治疗友军，并对敌人造成伤害。 只要破晓辰星击中目标时触发了熠熠生辉的强化攻击，她所有技能的冷却时间都会减少。",
            related_abilities: [
                {
                    ability_classname: "imba_dawnbreaker_celestial_hammer",
                    description: "上界重锤停在地面时，会产生天光现世的治疗和伤害效果，数值减少{hammer_solar_guardian_effectiveness_pct}%，作用于重锤附近{hammer_solar_guardian_radius}范围。重锤的停留时间提升至{pause_duration}秒."
                },
                {
                    ability_classname: "imba_dawnbreaker_luminosity",
