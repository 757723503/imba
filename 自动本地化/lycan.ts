    ...
    FacetArray_B: [
        {
            ...
            name: "狼群头领 | 幽灵狼 | 领头狼",
            description: "狼人或他的单位击杀敌方英雄都能延长变身的持续时间。 召狼会产生无敌且不会攻击的狼群，可以提升狼人的生命值和攻击力。 提升召狼的最高等级，但降低嗥叫和野性驱使的最高等级。",
            related_abilities: [
                {
                    ability_classname: "imba_lycan_summon_wolves",
                ...
                {
                    ability_classname: "imba_lycan_shapeshift",
                    description: "移动速度和致命一击加成效果也会施加给狼人控制下的所有单位。狼人或他的单位击杀敌方英雄后会使变身的持续时间延长{kill_duration_extension}秒。"
                }
            ],
            related_talents: [
                {
