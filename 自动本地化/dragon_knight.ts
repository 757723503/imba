...
export const data: LocalizationData = {
    ...
    FacetArray_B: [
        {
            ...
            name: "毒龙 | 火龙 | 霜龙",
            description: "龙骑士的攻击拥有腐蚀之力，古龙形态下效果还会变强。 龙骑士的攻击拥有溅射伤害，古龙形态下效果还会变强。 龙骑士的攻击拥有减速和降低治疗效果，古龙形态下效果还会变强。",
            related_abilities: [
                {
                    ability_classname: "imba_dragon_knight_dragon_blood",
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "冰霜吐息减速",
            description: "移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，攻击速度降低{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}，治疗效果降低{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。"
        },
        {
