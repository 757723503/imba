...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            scepter_description: "殁境神蚀者受到会使自身血量低于{scepter_barrier_threshold}%的伤害时触发一次强驱散。另外，效果触发时殁境神蚀者会耗尽所有魔法，产生一个伤害护盾，数值等于自身最大魔法值的{scepter_barrier_threshold}%。持续{scepter_barrier_duration}秒。这个效果每{scepter_barrier_cooldown}秒可触发一次，并且无法刷新。",
            notes: [
                "破坏会使阿哈利姆神杖效果无法触发。"
            ]
        },
