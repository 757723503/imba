...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: "球状闪电",
            description: "风暴之灵变成不稳定的电流在战场上横冲直撞，直到他的魔法耗尽或到达目标才停下。施法消耗为{ball_lightning_initial_mana_base}+总魔法量的{ball_lightning_initial_mana_percentage}%，每移动100距离消耗{ball_lightning_travel_cost_base}+总魔法量的{ball_lightning_initial_mana_percentage}%，本技能造成的伤害每飞行100距离就会递增。",
            lore: "风暴来袭。",
            notes: [
                "行进过程中可以使用技能和物品。",
                "该技能可以摧毁树木。",
    ...
    FacetArray_B: [
        {
            ...
            name: "已通电 | 滑行之影 | 电击项圈",
            description: "风暴之灵每次击杀都会获得永久魔法恢复。 残影会在风暴之灵处产生，并移动至目标地点。 电子涡流会施加负面效果，在敌人攻击时触发一次超负荷。",
            related_abilities: [
                {
                    ability_classname: "imba_storm_spirit_static_remnant",
