...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: "蛛纱陷阱",
            description: "育母蜘蛛可以制造出最多{count}个触碰已有蛛网的隐形网线。敌方英雄穿过网线将会触发陷阱，被缠绕，在战争迷雾中显形，并持续受到伤害。网线一开始被触发后，多名英雄还可以在同根网线上被绊倒，直到网线被摧毁。只要有人触发陷阱，育母蜘蛛的队友就会在小地图上发现。",
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "极度饥渴",
            description: "基础攻击力提升{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%，而且拥有{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%吸血效果。"
        },
        {
        ...
        },
        {
            ...
            name: "丝质重器",
            description: "移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，受到敌人攻击时额外承受魔法伤害，并且攻击落空{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。"
        }
    ]
};