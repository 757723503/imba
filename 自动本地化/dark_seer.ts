...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            shard_description: "奔腾单位的身后留下一道路径，作用范围为{trail_radius}，持续{trail_duration}秒，对附近的敌人造成{trail_move_slow}%减速，并且每秒造成{trail_damage}点伤害，伤害间隔为{trail_damage_interval}秒。可以设为多样施法，禁止留下路径。",
            notes: [
