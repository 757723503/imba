    ...
    FacetArray_B: [
        {
            ...
            name: "精英主义 | 不可知论",
            description: "活跃的元素球会提供<font color='#7998b5'>吸血</font>、<font color='#d671a9'>移动速度</font>和<font color='#cabe68'>技能增强</font>。 元素球在升级时被动提供<font color='#7998b5'>持续伤害</font>、<font color='#d671a9'>攻击速度</font>和<font color='#cabe68'>攻击力</font>。",
            related_abilities: [
                {
                    ability_classname: "imba_invoker_quas",
                ...
                {
                    ability_classname: "imba_invoker_exort",
                    description: "祈求者施加一个负面效果，每个<font color='#cabe68'>火</font>元素都会使目标受到的技能伤害增加，持续{resist_debuff_duration}秒。"
                }
            ],
            related_talents: [
                {
