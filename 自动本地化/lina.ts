...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [],
            name: "慢热",
            description: "莉娜的技能造成{total_damage_tooltip}%总伤害。击中时造成{total_damage_tooltip}%，然后在{burn_duration}秒内造成{total_damage_tooltip}%烧灼伤害。",
            notes: []
        },
        {
    ...
    ModifierArray: [
        {
            ...
            name: "腾焰斗篷",
            description: "拥有顺畅的移动状态。魔法抗性提升{MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS}%。技能伤害提升{MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS}%。"
        },
        {
