    ...
    AbilityArray: [
        {
            ...
            name: "感应地雷",
            description: "埋布隐形的地雷，不会被真实视域检测到，但是有敌方单位在地雷的{radius}生效范围内会显形。敌人在生效范围内停留超过{proximity_threshold}秒会使地雷爆炸，并且魔法抗性会被暂时降低。爆炸对{min_distance}范围内目标造成全额伤害，对边缘造成的伤害减少至{outer_damage}%。对建筑物造成{outer_damage}%伤害。",
            lore: "起重港的噩梦！",
            notes: [
