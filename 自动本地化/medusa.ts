...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: "魔法盾",
            description: "创造一个魔法护盾，消耗美杜莎的魔法值以吸收{absorption_pct}%的伤害，美杜莎每次升级都会使伤害吸收系数提升。幻象的伤害吸收系数减少{absorption_pct}%。",
    ...
    FacetArray_B: [
        {
            ...
            related_abilities: [
                {
                    ability_classname: "imba_medusa_mystic_snake",
                    description: "秘术异蛇返回至美杜莎后，根据异蛇回复的魔法值，每{mana_per_damage}点魔法都会使她接下来的{max_attacks}次攻击附带+1 额外伤害。加成状态持续最多{attack_buff_duration}秒。"
                },
                {
                    ability_classname: "imba_medusa_mana_shield",
                    description: "魔法盾可以主动开启，每秒消耗{aspd_increase_mana_cost_pct}%最大魔法值并每秒获得{aspd_increase_mana_cost_pct}%攻击速度加成，最高为{aspd_increase_max_tooltip}。{aspd_increase_max_aspd_time}秒后获得最大效果。加成状态持续{aspd_increase_buff_duration}秒。冷却时间为{attack_buff_cooldown}秒。"
                }
            ],
            related_talents: []
        }
