...
export const data: LocalizationData = {
    ...
    FacetArray_B: [
        {
            ...
            name: "大放异桶 | 醉酒大师",
            description: "向敌人扔出一个酒桶，对他们造成伤害并施加余烬佳酿。 浸酒后酒仙会以持续变化的移动速度进行移动，持续时间内最慢为{s:bonus_min_movement}%，最快为{s:bonus_max_movement}。",
            related_abilities: [
                {
                    ability_classname: "imba_brewmaster_cinder_brew",
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "醉酒云雾",
            description: "移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%并有{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%概率攻击不能命中。"
        },
        {
