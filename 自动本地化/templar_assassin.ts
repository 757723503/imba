...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: "灵能陷阱",
            description: "圣堂刺客放下一个隐形的神秘陷阱监视敌人的动向。启动后将减缓范围内敌人的移动速度并造成小幅伤害，陷阱放置时间越久，引爆后减速效果越强，最低为{movement_speed_min}%，放置{trap_max_charge_duration}秒后引爆将达到最大减速效果，为{movement_speed_min}%，并且还能造成额外伤害。",
