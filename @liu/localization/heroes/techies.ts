    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "proximity_threshold",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "placement_radius",
                    text: ""
                },
                {
            ...
            name: "感应地雷",
            description: "埋布隐形的地雷，不会被真实视域检测到，但是有敌方单位在地雷的{radius}生效范围内会显形。敌人在生效范围内停留超过{proximity_threshold}秒会使地雷爆炸，并且魔法抗性会被暂时降低。爆炸对{min_distance}范围内目标造成全额伤害，对边缘造成的伤害减少至{outer_damage}{。对建筑物造成{building_damage_pct}}伤害。",
            lore: "起重港的噩梦！",
            notes: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "secondary_slow_duration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "pre_chase_time",
                    text: ""
                },
                {
                    ability_special: "max_chase_time",
                    text: ""
                }
            ],
            name: "粘性炸弹",
            description: "向目标区域抛出一个粘性炸弹。如果炸弹落在一个敌方英雄身旁，炸弹会粘上去，减缓其移动速度。数秒后炸弹会爆炸，对爆炸区域内造成伤害，并再次施加减速，持续{secondary_slow_duration}秒。",
        ...
        },
        {
            ...
            name: "活性电击",
            description: "工程师放出电荷，使他们短时间内获得移动速度加成。攻击工程师的敌人被暂时缴械，并且受到弱驱散效果。效果结束时，电荷将会爆炸，使范围内所有敌人缴械。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "detonate_delay",
                    text: ""
                }
            ],
            name: "遥控炸弹",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "minefield_duration",
                    text: ""
                },
                {
                    ability_special: "trigger_radius",
                    text: ""
                },
                {
            ...
            lore: "别四处乱跑！",
            scepter_description: "提升雷区标识的作用范围和持续时间。敌方英雄进入标识的{trigger_radius}范围内时整个{aura_radius}范围变成一片雷区，持续{minefield_duration}秒。敌方单位在区域内移动都会受到伤害。雷区持续时间结束后标识会被摧毁。",
            notes: []
        },
        {
