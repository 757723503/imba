...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '神力恩泽',
            description:
                '被动提供光环，提供生命恢复加成。可以主动对友军施放，提供护甲加成，以及治疗和生命恢复增强。\\n\\n对陈施放后可以使陈控制的所有单位传送到他身旁。受到敌方英雄或控制下单位的伤害会导致传送中止。',
            lore: '陈的狂热极具感染力，他的盟友得到了生命力的祝福，还被迫在他身旁战斗。',
            scepter_description: '生命恢复光环变为全地图，而且作用于所有友方单位。',
            notes: [],
        },
        {
            ...
            description:
                '将一个友方单位传送至基地。非英雄单位将被立刻传送，英雄单位将延迟一段时间传送。如果对陈自身施放，所有通过神圣劝化控制的单位都将经过一定延迟后传送至他身边。',
            notes: [],
        },
        {
            ...
            name: '神圣劝化',
            description:
                '陈控制住敌方小兵或者中立生物，并获得击杀金钱一定百分比的金钱。被劝化目标的生命值会被设为{health_min} + {bonus_health_per_level} * 陈的等级。被劝化的单位将提升移动速度和攻击力。',
            lore: '尽管他们可能当不了骑士，但陈还是将野兽们纳入教会，就像他自己当年被改变信仰一样。',
            shard_description: '神圣劝化可以对远古中立生物施放。根据上帝之手等级可以控制最多1/2/3个远古生物。使中立生物的部分技能额外升1级。',
            scepter_description:
                '劝化单位获得一个新技能，殉道。该单位可以牺牲自己，对选定的友军施放一个单体的当前等级上帝之手进行治疗或对选定的敌人造成伤害。',
            notes: [
        ...
        },
        {
            ...
            name: '召唤信徒',
            description:
                '陈召唤一名信徒为他作战。信徒会获得神圣劝化的加成效果，陈阵亡后也会随之阵亡。最大生命值为{health_min} + {bonus_health_per_level} * 陈的英雄等级。<br><br>信徒存活时技能会保持冷却，不过陈复活时冷却状态就会重置。信徒会计入神圣劝化的单位数量上限。',
            notes: [],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '半人马信徒 | 巨狼信徒 | 地狱熊怪信徒 | 枭兽信徒 | 巨魔信徒 | 萨特信徒',
            description:
                '召唤信徒会召唤半人马猎手或半人马征服者。 召唤信徒会召唤地狱熊怪或地狱熊怪粉碎者。 召唤信徒会召唤萨特窃神者或萨特苦难使者。 召唤信徒会召唤丘陵巨魔或黑暗巨魔召唤法师。 召唤信徒会召唤巨狼或头狼。',
            related_abilities: [
                {
                    ability_classname: 'imba_chen_summon_convert',
                    description: '召唤信徒会召唤半人马猎手或半人马征服者。',
                },
            ],
            related_talents: [],
        },
