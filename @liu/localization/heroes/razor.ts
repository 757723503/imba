    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "total_ability_time",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "second_ring_delay",
                    text: ""
                },
                {
                    ability_special: "second_ring_reduction",
                    text: ""
                }
            ],
            name: "等离子场",
            description: "释放一波威力随扩张程度提升的等离子能量场，收缩时也会对经过的敌人造成伤害和减速。距离雷泽越远，伤害和减速越高。等离子场对每个单位造成两次伤害。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "drain_range_buffer",
                    text: ""
                },
                {
                    ability_special: "radius",
                ...
                {
                    ability_special: "attack_speed_factor",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "min_pull_range",
                    text: ""
                },
                {
            ...
            notes: [
                "链接在一方单位死亡或双方距离超过{drain_range_buffer}后断裂。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "strike_cd_reduction_during_storm",
                    text: ""
                },
                {
                    ability_special: "hit_targets_inside_eye_of_the_storm",
                    text: ""
                },
                {
                    ability_special: "eye_of_the_storm_chance_multiplier",
                    text: ""
                }
            ],
            name: "风暴涌动",
            description: "被攻击时拥有几率、每次受到指向性技能时都会释放一道叉状闪电，击中目标和附近其他敌人，优先打击与目标类型相同的单位，造成伤害并减缓移动速度。",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "movespeed_per_level_pct",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "spell_amp_damage_divisor",
                    text: ""
                },
                {
                    ability_special: "spell_amp_mult",
                    text: ""
                },
                {
