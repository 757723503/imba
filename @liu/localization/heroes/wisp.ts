...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            name: '羁绊',
            description:
                '将艾欧和一个友方单位连接在一起，提高双方的移动速度。当艾欧回复生命或魔法时，连在一起的友军将获得一部分回复效果。距离过远时连接将会断开，也可以主动断开连接。羁绊会对触碰到的敌人造成减速和伤害。',
        ...
        },
        {
            ...
            name: '幽魂',
            description:
                '召唤五个围绕艾欧起舞的幽魂，对所有碰触到的单位造成伤害。如果碰到的是敌方英雄，幽魂会爆炸，对其附近的所有敌人造成伤害。普通单位碰到幽魂会受到轻微伤害，但是不会使其爆炸。持续时间结束后，幽魂将自动爆炸。',
            lore: '艾欧用它不可思议的力量扭曲了宇宙中的粒子。',
            scepter_description: '每秒被动产生幽魂围绕艾欧，直至数量上限。幽魂撞到英雄会将其短暂减速。可以主动施放来引爆幽魂。',
            notes: ['召唤后艾欧可以拉近或拉远幽魂。'],
        },
        {
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '羁绊',
            description:
                '受到伤害。移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，攻击速度降低{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}。',
        },
        {
        ...
        },
        {
            ...
            name: '过载',
            description:
                '攻击速度提升{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}，技能增强提升{MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE}%，并且获得{MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT}点/秒生命恢复。',
        },
        {
