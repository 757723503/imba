...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "latch_distance",
                    text: ""
                },
                {
                    ability_special: "latch_speed",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "tether_mana_amp",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "tether_attack_damage_pct",
                    text: ""
                }
            ],
            name: "羁绊",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "revolution_time",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "hero_hit_radius",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "spirit_movement_rate",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "bonus_channel_speed",
                    text: ""
                }
            ],
            name: "视野先知",
    ...
    ModifierArray: [
        ...
        {
            modifier_classname: "modifier_imba_wisp_tether_slow_description",
            name: "受到伤害。移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，攻击速度降低{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}。"
        },
        {
