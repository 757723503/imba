    ...
    AbilityArray: [
        {
            ...
            notes: [
                "尖刺的移动速度是每秒{speed}，最远作用距离为{length}。",
                "穿刺不会被林肯法球格挡。"
            ]
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "damage_echo_duration",
                    text: ""
                },
                {
            ...
            name: "神智爆裂",
            description: "对敌人造成等同于其最大魔法值乘以系数的伤害。另外还会根据过去{damage_echo_duration}秒内目标受到来自司夜刺客的伤害再造成一定百分比的伤害。瞬间秒杀非远古非英雄单位。",
            lore: "",
            notes: []
        },
        {
            ...
            name: "尖刺外壳",
            description: "激活状态下，尖刺外壳可以反弹并无效化司夜刺客受到的伤害（每个攻击者最多作用一次），同时眩晕攻击者。激活尖刺外壳不会打破复仇的隐身状态。\\n\\n钻地状态下尖刺外壳施放后将立刻眩晕周围的敌人。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "health_regen_rate_scepter",
                    text: ""
                },
                {
                    ability_special: "mana_regen_rate_scepter",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "free_pathing_duration",
                    text: ""
                },
                {
                    ability_special: "free_pathing_movement_speed_bonus",
                    text: ""
                },
                {
                    ability_special: "attack_animation_bonus",
                    text: ""
                },
                {
            ...
            name: "复仇",
            description: "司夜刺客进入隐身状态并获得移动速度加成。如果司夜刺客以攻击打破隐身，当次攻击将造成超高额外伤害。司夜刺客当次攻击具有{attack_range_bonus}额外攻击距离，并且攻击动作加快{attack_animation_bonus}%。",
            lore: "圣甲虫为女王的荣耀而杀戮。",
        ...
        },
        {
            ...
            name: "钻地",
            description: "司夜刺客经过短时间的掘地后钻入地下。钻地后尖刺外壳一施放就会直接眩晕附近所有敌人，神智爆裂和穿刺的施法距离提升，穿刺的冷却时间减少。钻地后司夜刺客固定在原地，无法攻击，并且是隐身状态。同时受到的所有伤害都会降低。",
