    ...
    AbilityArray: [
        {
            ...
            notes: ['末日使者将获得该生物的正常金钱，还有技能的额外金钱。', '如果吞噬的单位没有技能，之前获得的技能将会保留。'],
        },
        {
        ...
        },
        {
            ...
            shard_description: '治疗末日使者及其控制单位，数值为每秒伤害的{heal_pct}%。',
            notes: ['焦土会跟随末日使者，以他所在位置为中心。'],
        },
        {
            ...
            name: '阎刃',
            description:
                '末日挥舞他的炽烈之剑，将敌人点燃。造成{ministun_duration}秒眩晕，并施加一个燃烧效果，持续{burn_duration}秒，每秒造成伤害，数值为基础伤害+目标最大生命值的一定百分比。',
        ...
        },
        {
            ...
            ability_specials: [],
            name: '恶魔的交易',
            description: '末日使者能以原价的{bonus_item_sellback_percent}%出售物品，但是他的买活价格增加{bonus_item_sellback_percent}%。',
            notes: [],
        },
    ],
    TalentArray: [
    ...
    FacetArray_B: [
        {
            ...
            name: '暴食 | 末日来临',
            description:
                '吞噬现在拥有{s:bonus_AbilityCharges}点能量点数，并且获得的单位技能会升一级。 末日的持续时间每{s:bonus_upgrade_interval}分钟都会提升{s:bonus_upgrade_amount}秒。末日的每秒伤害降低。',
            related_abilities: [
                {
                    ability_classname: 'imba_doom_bringer_devour',
                    description: '吞噬现在拥有{AbilityCharges}点能量点数，并且获得的单位技能会升一级。',
                },
                {
                    ability_classname: 'imba_doom_bringer_doom',
                    description: '末日的持续时间每{upgrade_interval}分钟都会提升{upgrade_amount}秒。末日的每秒伤害降低。',
                },
            ],
            related_talents: [],
        },
