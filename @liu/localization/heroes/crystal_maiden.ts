    ...
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "proximity_bonus_factor",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "explosion_min_dist",
                    text: ""
                },
                {
                    ability_special: "explosion_max_dist",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "frostbite_delay",
                    text: ""
                },
                {
                    ability_special: "shard_bonus_explosion",
                    text: ""
                },
                {
                    ability_special: "shard_self_movement_speed_slow_pct",
                    text: ""
                },
                {
                    ability_special: "can_move",
                    text: ""
                },
                {
            ...
            shard_description: "使自身在极寒领域期间可以移动、施法和攻击。仍然可以被敌人打断。在此期间移动速度降低{shard_self_movement_speed_slow_pct}{。<br><br>冰爆总数提升{shard_bonus_explosion}}。",
            scepter_description: "使自身在极寒领域期间可以移动、施法和攻击。仍然可以被敌人打断。在此期间移动速度降低{shard_self_movement_speed_slow_pct}{。冰爆总数提升{shard_bonus_explosion}}。对极寒领域内停留超过{frostbite_delay}秒的所有单位都会施加冰封禁制。",
            notes: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "frostbite_radius",
                    text: ""
                },
                {
                    ability_special: "anim_delay",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "mana_regen_multiplier",
                    text: ""
                }
            ],
            name: "蓝心浮冰",
