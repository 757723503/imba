...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            shard_description:
                '使自身在极寒领域期间可以移动、施法和攻击。仍然可以被敌人打断。在此期间移动速度降低{shard_self_movement_speed_slow_pct}%。<br><br>冰爆总数提升{shard_self_movement_speed_slow_pct}%。',
            scepter_description:
                '使自身在极寒领域期间可以移动、施法和攻击。仍然可以被敌人打断。在此期间移动速度降低{shard_self_movement_speed_slow_pct}%。冰爆总数提升{shard_self_movement_speed_slow_pct}%。对极寒领域内停留超过{frostbite_delay}秒的所有单位都会施加冰封禁制。',
            notes: [
        ...
        },
        {
            ...
            name: '冰晶克隆',
            description:
                '向一个方向滑行，在原地制造一个自身的冰晶克隆，并且躲避多种飞行过程中的攻击和技能弹道。如果克隆受到了足量伤害，或者超过一定时间都会碎裂，对附近{frostbite_radius}范围内敌人施加冰封禁制。克隆体也可以被水晶室女自身的技能摧毁。',
            notes: [],
        },
        {
