    ...
    AbilityArray: [
        {
            ...
            name: '战神迅矛',
            description:
                '玛尔斯以致命的精准掷出他强大的战矛，对击中的每个敌方单位造成伤害。击中的第一个敌方英雄将被战矛刺穿，并被击退。若战矛击中树木、建筑或悬崖，目标将会被钉在上面，并受到眩晕。',
            lore: '玛尔斯的传奇战矛上依然闪耀着熔铸之神烈焰的热力。',
            shard_description: '战神迅矛可以刺中最多{max_impale_targets}个单位，并留下一道火焰路径，持续造成伤害并减缓移动速度。',
            notes: ['战神迅矛可以击中隐身单位，造成眩晕还使其显形。', '战神迅矛只会将单位从低地钉在地势变高的地方，否则会将他们推下高地。'],
        },
        {
        ...
        },
        {
            ...
            name: '护身甲盾',
            description:
                '每当玛尔斯受到来自正面或侧面的攻击时，他就挥舞他那面巨大的战盾来格挡一定百分比的伤害。<br><br>可以开启，开启后获得相位移动状态，但无法攻击，自身锁定为面朝的方向，并且移动速度降低，但飞向队友的攻击弹道中{redirect_chance}%将改变方向朝玛尔斯飞去。',
            lore: '只有蠢到家了才胆敢与战神公平作战。',
            scepter_description:
                '开启护身甲盾后在玛尔斯的两侧共产生{soldier_count}名无敌的士兵。士兵会随着玛尔斯前进，继承全额攻击力和攻击特效并拥有攻击力加成，附带击退和减速效果。敌人在同一时间只会被1名士兵攻击。',
            notes: ['改向只会在弹道目标位于玛尔斯身后锥形区域内或他身边100范围内才会生效。', '破坏会使正面和侧面减伤效果失效。'],
        },
        {
            ...
            name: '热血竞技场',
            description:
                '经过短暂的列队时间，玛尔斯召唤出环绕着战士的竞技场，战士们将阻挡敌人的攻击和动向。竞技场内的敌方英雄靠近边缘时将被战矛攻击，受到伤害并被击退。',
