    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "spear_speed",
                    text: ""
                },
                {
                    ability_special: "spear_width",
                    text: ""
                },
                {
                    ability_special: "spear_vision",
                    text: ""
                },
                {
                    ability_special: "max_impale_targets",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "activity_duration",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "redirect_close_range",
                    text: ""
                },
                {
                    ability_special: "attack_redirection_grace_distance",
                    text: ""
                },
                {
                    ability_special: "soldier_count",
                    text: ""
                },
                {
                    ability_special: "soldier_offset",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "stationary_attack_delay",
                    text: ""
                },
                {
                    ability_special: "knockback_distance",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "spear_distance_from_wall",
                    text: ""
                },
                {
                    ability_special: "spear_attack_interval",
                    text: ""
                },
                {
                    ability_special: "warrior_count",
                    text: ""
                },
                {
                    ability_special: "first_warrior_angle",
                    text: ""
                },
                {
                    ability_special: "warrior_fade_min_dist",
                    text: ""
                },
                {
                    ability_special: "warrior_fade_max_dist",
                    text: ""
                },
                {
                    ability_special: "cast_around_self_and_leash",
                    text: ""
                },
                {
                    ability_special: "obscure_vision",
                    text: ""
                },
                {
                    ability_special: "arena_kill_buff_duration",
                    text: ""
                },
                {
                    ability_special: "arena_kill_buff_damage_pct",
                    text: ""
                },
                {
                    ability_special: "arena_kill_buff_heal_pct",
                    text: ""
                }
            ],
            name: "热血竞技场",
