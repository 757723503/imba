    ...
    AbilityArray: [
        {
            ...
            lore: '炘之严训，炽链相伴。',
            notes: ['将随机选取炘周围的单位作为目标。', '不能作用于减益免疫或隐身单位。'],
        },
        {
        ...
        },
        {
            ...
            name: '烈火罩',
            description:
                '灰烬之灵用火焰之环将自己包裹起来，会消耗受到的魔法伤害，使受到的魔法伤害被吸收一定百分比。烈火罩开启后会对灰烬之灵周围的敌人造成每秒伤害。护盾消失后将失去伤害效果。',
            lore: '近身之敌，自讨苦吃。',
            notes: ['魔法伤害的吸收伤害值计算先于任何伤害减免效果。', '伤害在施加后会额外粘滞{linger_duration}秒。'],
        },
        {
            ...
            notes: ['破坏不会使阿哈利姆魔晶升级的残焰继承的献祭心失效。'],
        },
        {
            ...
            name: '残焰',
            description:
                '可以放出一个残焰，向目标地点冲去，速度为灰烬之灵移动速度的{speed_multiplier}%。使用“激活残焰”技能后，灰烬之灵向所有残焰像冲去，将其摧毁并造成范围伤害，并移动至最近的残焰像。灰烬之灵最后会到达离目标地点最近的残焰像。',
            lore: '身怀灵力，重焕教义。',
            shard_description: '灰烬之灵附近范围内有敌方英雄阵亡时，恢复一点残焰能量点数。',
            scepter_description: '提升施法距离、初始残焰速度和最大能量点数。',
            notes: ['学习后马上拥有3个残焰（上限数量）。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            related_abilities: [
                ...
                },
                {
                    ability_classname: 'imba_ember_spirit_sleight_of_fist',
                    description:
                        '无影拳击中的敌人超过{min_enemies_for_double_sleight}个时，距离灰烬之灵最近的敌人会再次受到攻击。第二次攻击的伤害减少{second_attack_damage_penalty}%。',
                },
            ],
            related_talents: [],
        },
