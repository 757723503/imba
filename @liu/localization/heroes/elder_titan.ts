...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            name: '回音重踏',
            description:
                '持续施法 - 上古巨神与他的灵体游魂一起践踏地面，对敌方单位造成伤害并使他们在原地昏迷。上古巨神造成物理伤害，灵体游魂造成魔法伤害。',
            lore: '创世之力依然在巨神的重踏下回响。',
            shard_description: '减少冷却时间。回音重踏可以设为多样施法状态，使上古巨神完成重踏后会取代灵体游魂。',
            notes: ['若同时处于灵体游魂和上古巨神的回音重踏作用范围内将受到两次伤害。'],
        },
        {
            ...
            name: '回音重踏',
            description:
                '上古巨神与他的灵体游魂一起践踏地面，对敌方单位造成伤害并使他们在原地昏迷。上古巨神造成物理伤害，灵体游魂造成魔法伤害。昏迷的敌人受到伤害会被惊醒。',
            lore: '创世之力依然在巨神的重踏下回响。',
            notes: [],
        },
        {
            ...
            name: '灵体游魂',
            description:
                '上古巨神放出他的灵体游魂，灵魂对任何经过的单位都会造成伤害。当它与巨神合体时，它每伤害过一个单位都会给予若干攻击力、护甲和移动速度加成。\\n\\n灵体游魂拥有回音重踏，回归和自然秩序三个技能。',
        ...
        },
        {
            ...
            name: '自然秩序',
            description:
                '使所有元素降低至基础水平，移除附近敌方单位的基础物理护甲和魔法抗性。护甲降低效果以英雄为中心，魔法抗性降低效果以灵体游魂为中心。',
            lore: '上古巨神又让创世之初重现。',
            notes: ['没有施放灵体游魂时，护甲和魔法抗性降低效果均以上古巨神为中心。'],
        },
        {
            ...
            description:
                '使所有元素降低至基础水平，移除附近敌方单位的基础物理护甲和魔法抗性。护甲降低效果以英雄为中心，魔法抗性降低效果以灵体游魂为中心。',
            lore: '上古巨神又让创世之初重现。',
            notes: ['没有施放灵体游魂时，护甲和魔法抗性降低效果均以上古巨神为中心。', '破坏会使护甲降低光环失效。'],
        },
        {
            ...
            name: '裂地沟壑',
            description:
                '上古巨神向前方放出一道不平坦的裂纹。3秒后裂纹塌陷，范围内的单位将被减速，并受到基于他们自身生命最大值的伤害。其中一半伤害为魔法伤害，另一半为物理伤害。',
            lore: '巨神创造之世，他亲手将其撕裂。',
            notes: [],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '解构',
            description: '自然秩序会持续降低魔法抗性和护甲。',
            related_abilities: [
                {
                    ability_classname: 'imba_elder_titan_natural_order',
                    description:
                        '敌方英雄在自然秩序效果下每停留{tick_rate}秒，他们的护甲就会降低{armor_per_tick}点，魔法抗性降低{magic_resistance_per_tick}%。叠加效果最多可叠加{max_stacks}次。',
                },
            ],
            related_talents: [],
        },
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '灵体巨神加成',
            description:
                '获得{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%移动速度加成，{MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS}点护甲加成和{MODIFIER_PROPERTY_PREATTACK_BONUS_DAMAGE}点攻击力加成。',
        },
        {
        ...
        },
        {
            ...
            name: '降低{MODIFIER_PROPERTY_TOOLTIP}%基础魔法抗性，并且进一步降低{MODIFIER_PROPERTY_TOOLTIP}%魔法抗性。',
        },
        {
