...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "static_remnant_radius",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "static_remnant_delay",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "is_point_targeted",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "static_remnant_vision_radius_night",
                    text: ""
                }
            ],
            name: "残影",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "electric_vortex_pull_tether_range",
                    text: ""
                },
                {
                    ability_special: "electric_vortex_self_slow",
                    text: ""
                },
                {
                    ability_special: "electric_vortex_self_slow_duration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "enemy_overload_duration",
                    text: ""
                }
            ],
            name: "电子涡流",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "shard_activation_charges",
                    text: ""
                },
                {
                    ability_special: "shard_activation_duration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "overload_cast_range",
                    text: ""
                },
                {
                    ability_special: "overload_bounces",
                    text: ""
                },
                {
                    ability_special: "overload_damage_pct",
                    text: ""
                }
            ],
            name: "超负荷",
            ...
            lore: "啪！嘶！咝！",
            shard_description: "施放后风暴之灵和附近友方英雄获得{shard_activation_charges}次超负荷效果。提供额外攻击速度。持续最多{shard_activation_duration}秒，或效果用尽。",
            notes: [
                "使用物品不会触发超负荷。",
                "超负荷效果不会叠加。"
            ]
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "ball_lightning_initial_mana_percentage",
                    text: ""
                },
                {
                    ability_special: "ball_lightning_initial_mana_base",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "ball_lightning_travel_cost_base",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "ball_lightning_vision_radius",
                    text: ""
                },
                {
                    ability_special: "blocker_duration",
                    text: ""
                },
                {
                    ability_special: "scepter_remnant_interval",
                    text: ""
                }
            ],
            name: "球状闪电",
            description: "风暴之灵变成不稳定的电流在战场上横冲直撞，直到他的魔法耗尽或到达目标才停下。施法消耗为{ball_lightning_initial_mana_base}+总魔法量的{ball_lightning_initial_mana_percentage}{，每移动100距离消耗}ball_lightning_travel_cost_base{+总魔法量的{ball_lightning_travel_cost_percent}}，本技能造成的伤害每飞行100距离就会递增。",
            lore: "风暴来袭。",
            notes: [
                "行进过程中可以使用技能和物品。",
                "该技能可以摧毁树木。",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "perma_mp_per_kill",
                    text: ""
                },
                {
                    ability_special: "mp_per_kill",
                    text: ""
                },
                {
                    ability_special: "charges_per_ult",
                    text: ""
                },
                {
                    ability_special: "aoe",
                ...
                {
                    ability_special: "charges_per_death",
                    text: ""
                }
            ],
            name: "通电",
            description: "风暴之灵每次击杀都会获得一点提供{mp_per_kill}魔法恢复的能量。每次阵亡会损失{charges_per_death}点能量。升级球状闪电会获得{charges_per_ult}点额外能量。另外每次获得一点能量时他还会永久获得{perma_mp_per_kill}点/秒魔法恢复。",
            lore: "",
            notes: [
                "破坏会使技能无法通过击杀获得新的叠加效果。"
            ]
        }
    ],
    TalentArray: [
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "超负荷减速",
            description: "受到风暴之灵超负荷效果影响。移动速度减缓 {MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，攻击速度降低 {MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}。"
        },
        {
