...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '暗言术',
            description:
                '术士低声说出一个咒语，对一个单位施展法术，使周围的敌方单位受到伤害，周围的友方单位被治疗。目标单位也会被治疗或受到伤害，取决于他是友军还是敌人。',
        ...
        },
        {
            ...
            name: '剧变',
            description:
                '持续施法 - 随施法时间增强的减速气流，还会造成伤害。持续最多{abilitychanneltime}秒。在魔法结束或目标离开生效区域后，敌人仍会被减速{duration}秒。',
            lore: '戴蒙操纵时空，削弱所有敌军。',
            shard_description:
                '持续施法时每{imps_interval}秒术士会召唤一个魔童，持续{minor_imp_duration}秒，魔童死亡时会爆炸，对周围所有敌人造成伤害。',
            notes: ['减速效果的增加是根据持续施法的时长，而不是敌人在区内停留的持续时间。'],
        },
        {
            ...
            name: '混乱之祭',
            description:
                '从深渊召唤一个地狱火，眩晕敌人{stun_duration}秒。地狱火持续{golem_duration}秒，能够减免部分技能的伤害，具有较高的减速抗性，拥有永久献祭和烈焰之拳技能。',
            lore: '戴蒙释放被他关在恐惧之木法杖中的异界灵魂，在敌阵中引发毁灭。',
            scepter_description: '召唤{number_of_golems_scepter}个地狱火。',
            notes: ['该技能将摧毁作用范围内的树木。'],
        },
        {
        ...
        },
        {
            ...
            name: '邪术召唤',
            description:
                '只要敌方单位在受到一个或多个术士的技能作用下阵亡，就会召唤出一个魔童，持续{minor_imp_duration}秒，死亡时会爆炸。魔童会自动搜寻附近单位，优先选择致命连接下的英雄，到达猎物时就会爆炸。',
            shard_description: '术士召唤的所有魔童都会得到威力的提升。',
            notes: ['魔童拥有{tooltip_imp_health}点生命值，爆炸会在{tooltip_imp_explode_radius}范围内造成{tooltip_imp_explode}点伤害。'],
        },
        {
            ...
            name: '黑暗魔典',
            description: '术士获得物品黑暗魔典，消耗物品后可以根据术士参与的击杀来获得经验。初始拥有1点能量。',
            notes: [],
        },
    ],
    TalentArray: [
    ...
    FacetArray_B: [
        {
            ...
            name: '格罗斯勇士',
            description: '混乱之祭地狱火会根据术士的生命和魔法恢复造成更高的永久献祭伤害。',
            related_abilities: [
                {
                    ability_classname: 'imba_warlock_rain_of_chaos',
                    description: '混乱之祭地狱火会根据术士的生命和魔法恢复造成更高的永久献祭伤害。',
