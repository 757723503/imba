...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            notes: ['开启黑皇杖并不会移除超强力量。', '攻击丢失还是会消耗超强力量的攻击次数。'],
        },
        {
            ...
            name: '怒意狂击',
            description:
                '熊战士的利爪深深地撕裂敌人的伤口，对同一敌人连续攻击将造成更多伤害。如果同一个目标在{bonus_reset_time}秒内不受攻击，将失去额外伤害加成。',
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '激怒',
            description:
                '承受的伤害减少{MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE}%。获得{MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE}%状态抗性。',
        },
        {
