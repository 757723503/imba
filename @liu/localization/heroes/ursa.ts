...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "shard_enrage_duration",
                    text: ""
                },
                {
                    ability_special: "fury_swipe_stacks_on_hit",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "stun_stack_count",
                    text: ""
                },
                {
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "激怒",
            description: "承受的伤害减少{MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE}%。获得{MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING}%状态抗性。"
        },
        {
