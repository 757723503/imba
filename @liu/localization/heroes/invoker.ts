...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            notes: [
                "祈求者最多只有3个元素。",
                "技能吸血效果会在施放技能时确定。之后更改元素球不会有任何效果。"
            ]
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "bonus_damage_per_instance",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "resist_debuff_duration",
                    text: ""
                },
                {
            ...
            notes: [
                "祈求者最多只有3个球。",
                "技能增强效果会在施放技能时确定。之后更改元素球不会有任何效果。"
            ]
        },
        {
            ...
            ability_specials: [],
            name: "祈唤技能",
            description: "施放元素祈唤后本技能栏会变成对应祈求者当前的<font color='#7998b5'>冰</font>、<font color='#d671a9'>雷</font>和<font color='#cabe68'>火</font>元素状态的十大技能之一。",
            lore: "",
            notes: []
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "cooldown_reduction_per_orb",
                    text: ""
                }
            ],
            name: "元素祈唤",
            description: "将当前掌握的元素精华融合，创造出新的法术供祈求者施放。每个元素球的等级都会减少{cooldown_reduction_per_orb}秒元素祈唤的冷却时间。<br><br>点击帮助按钮可查看所有可用法术。",
            lore: "知识的新纪元就此开启。",
            notes: [
                "生成的技能与三个球的排列顺序无关。",
                "只是交换现有技能的位置并不会消耗魔法，也不会触发元素祈唤的冷却。"
            ]
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "damage_trigger",
                    text: ""
                }
            ],
            name: "急速冷却",
            description: "祈求者将敌人的热量抽空，将其降到绝对零度，持续时间取决于<font color='#7998b5'>冰元素</font>等级。敌人将受到伤害并被短暂冻结，后续攻击会使敌人再次冻结，造成额外伤害并且治疗祈求者。冻结的眩晕时间固定，但是冻结的冷却时间将会随着<font color='#7998b5'>冰元素</font>等级提高而缩短。",
            lore: "塞卓昂的无尽战栗。",
            notes: [
                "只有{damage_trigger}点以上的实际伤害才能触发急速冷却。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "aura_fade_time",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "disable_time",
                    text: ""
                }
            ],
            name: "幽灵漫步",
            description: "祈求者操纵冰电之力围绕自身，使自己隐形并且获得生命和魔法恢复。各种元素的不平衡导致附近敌人的移动速度被减缓，减速效果取决于<font color='#7998b5'>冰元素</font>的等级，并使祈求者自身移动速度减缓，减速效果与<font color='#d671a9'>雷元素</font>等级成反比。",
            lore: "米瑞特之阻碍。",
            notes: [
                "减速效果对减益免疫状态下的单位无效。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "vision_distance",
                    text: ""
                },
                {
                    ability_special: "end_vision_duration",
                    text: ""
                },
                {
            ...
            name: "强袭飓风",
            description: "释放出一道快速移动的飓风，将路径上的敌方单位卷起，使其在空中无助地漂浮一段时间，然后落地受死。最大距离取决于<font color='#d671a9'>雷元素</font>等级。滞空时间取决于<font color='#7998b5'>冰元素</font>等级。落地伤害取决于<font color='#d671a9'>雷元素</font>的等级。\\n\\n驱散类型：弱驱散",
            lore: "托纳鲁斯之爪。",
            notes: [
                "被强袭飓风吹起时单位处于无敌状态，落地时受到伤害。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "shard_drag_speed",
                    text: ""
                },
                {
                    ability_special: "self_mana_restore_pct",
                    text: ""
                }
            ],
            name: "电磁脉冲",
            description: "祈求者在指定位置召唤出一道强力的自爆电磁脉冲，{delay}秒后将自动爆炸。爆炸将覆盖一定区域，并根据<font color='#d671a9'>雷元素</font>的等级损毁敌方的魔法值。对敌方英雄造成损毁魔法值一定百分比的伤害。祈求者将获得{self_mana_restore_pct}%损毁的魔法。",
            lore: "恩多利昂的恶之混动。",
            shard_description: "提升电磁脉冲燃烧魔法的伤害系数，并且将敌方单位以每秒{shard_drag_speed}距离的速度向电磁脉冲的中心牵引。",
            notes: [
                "对被吹起的单位（强袭飓风或Eul的神圣法杖）无效。"
            ]
        },
        {
            ...
            name: "灵动迅捷",
            description: "祈求者给友方单位灌注强大的能量，提高其攻击速度和攻击力。攻击速度提升程度取决于<font color='#d671a9'>雷元素</font>等级，攻击力提升取决于<font color='#cabe68'>火元素</font>等级。",
            lore: "盖斯特的猛战号令。",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "meteor_count",
                    text: ""
                }
            ],
            name: "混沌陨石",
            description: "祈求者从太空中召唤一枚燃烧的流星打击指定位置。流星着陆后会向前滚动一段距离，每隔一段时间撞击一次作用范围内的敌人，造成基于<font color='#cabe68'>火元素</font>等级的撞击伤害，滚动距离取决于<font color='#d671a9'>雷元素</font>的等级。每被撞击一次都将持续受到烧灼伤害，烧灼伤害取决于<font color='#cabe68'>火元素</font>的等级。",
            lore: "塔拉克的天坠之火。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "cataclysm_count",
                    text: ""
                },
                {
                    ability_special: "cataclysm_cooldown",
                    text: ""
                },
                {
                    ability_special: "cataclysm_min_range",
                    text: ""
                },
                {
                    ability_special: "cataclysm_max_range",
                    text: ""
                }
            ],
            name: "阳炎冲击",
            description: "向目标区域释放毁灭性的阳炎之光能量，一旦能量着陆，将对区域内的敌人进行灼烧。伤害取决于<font color='#cabe68'>火元素</font>等级，区域内敌人将平摊所有伤害。",
            lore: "哈雷克之火葬魔咒。",
            scepter_description: "双击阳炎冲击发动毁天灭地。施放后阳炎冲击的冷却时间为{cataclysm_cooldown}秒。每个敌方英雄附近{cataclysm_min_range}-{cataclysm_max_range}范围内产生{cataclysm_count}个可见的阳炎冲击。另外冰、雷和火的等级均提升1级。",
            notes: [
                "施放后立即获得目标区域的视野。",
                "祈求者使用阳炎冲击击杀英雄后，即使不在经验范围内也能获得经验。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "armor_per_attack",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "spirit_attack_speed",
                    text: ""
                },
                {
                    ability_special: "extra_spirit_count_quas",
                    text: ""
                },
                {
                    ability_special: "extra_spirit_count_exort",
                    text: ""
                }
            ],
            name: "熔炉精灵",
            description: "祈求者融合火之灼热和冰之坚毅，创造出熔炉精灵。熔炉精灵的攻击力和护甲取决于<font color='#cabe68'>火元素</font>的等级，攻击距离、持续时间和生命值取决于<font color='#7998b5'>冰元素</font>的等级。元素的灼热攻击能够熔化敌方英雄的护甲。冰元素和火元素都达到4级后可以产生2个熔炉精灵。",
            lore: "卡尔维因的至邪造物。",
            notes: [
                "施放此技能后原有的熔炉精灵将会死亡。"
            ]
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "wall_place_distance",
                    text: ""
                },
                {
                    ability_special: "num_wall_elements",
                    text: ""
                },
                {
                    ability_special: "wall_element_spacing",
                    text: ""
                },
                {
                    ability_special: "wall_element_radius",
                    text: ""
                },
                {
                    ability_special: "vector_cast_range",
                    text: ""
                }
            ],
            name: "寒冰之墙",
            description: "在祈求者前方创造一堵寒冰之墙，持续时间取决于<font color='#7998b5'>冰元素</font>的等级。冰霜之墙放射出的寒冰之气将对敌方单位造成减速和伤害，减速效果取决于<font color='#7998b5'>冰元素</font>的等级，每秒伤害取决于<font color='#cabe68'>火元素</font>的等级。",
            lore: "科瑞克斯的杀戮之墙。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "radius_start",
                    text: ""
                },
                {
                    ability_special: "radius_end",
                    text: ""
                },
                {
                    ability_special: "end_vision_duration",
                ...
                {
                    ability_special: "radial_count",
                    text: ""
                }
            ],
            name: "超震声波",
            description: "祈求者在自己前方释放出超强的声波，对所有敌方单位造成伤害，伤害量取决于<font color='#cabe68'>火元素</font>的等级。声波的绝对冲击能够将敌方单位击退，击退时间取决于<font color='#7998b5'>冰元素</font>的等级，同时让他们无法进行攻击，禁止攻击时间取决于<font color='#d671a9'>雷元素</font>的等级。",
            lore: "布鲁冯特之无力声波。",
            notes: []
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "xp_on_deny_percent",
                    text: ""
                }
            ],
            name: "聪明绝顶",
        ...
        },
        {
            ...
            name: "急速冷却（OMG）",
            description: "祈求者将敌人的热量抽空，将其降到绝对零度，持续一定时间。敌人将伤害并被短暂冻结，后续攻击同样会使敌人冻结并造成额外伤害。被冻结的频率固定，但是冻结的冷却时间将会随着等级提高而缩短。",
            lore: "塞卓昂的无尽战栗。",
            notes: [
                "只有{damage_trigger}点以上的实际伤害才能触发急速冷却。"
            ]
        },
        {
            ...
            name: "幽灵漫步（OMG）",
            description: "祈求者操纵冰雷之力围绕自身，使自己隐形。各种元素的不平衡导致附近敌人的移动速度被减缓，并使祈求者自身移动速度减缓，减速效果基于技能等级。",
            lore: "米瑞特之阻碍。",
            notes: [
                "减速效果对减益免疫状态下的单位无效。"
            ]
        },
        {
            ...
            name: "强袭飓风（OMG）",
            description: "释放出一道快速移动的飓风，将路径上的敌方单位卷起，使其在空中无助的漂浮一段时间，然后落地受死。行进距离取决于技能等级，敌人将滞空一定时间。\\n\\n驱散类型：弱驱散",
            lore: "托纳鲁斯之爪。",
            notes: [
                "被强袭飓风吹起时单位处于无敌状态，落地时受到伤害。"
            ]
        },
        {
            ...
            name: "电磁脉冲（OMG）",
            description: "祈求者在指定位置召唤出一道强力的自爆电磁脉冲，{delay}秒后将自动爆炸。爆炸将覆盖一定区域，损毁敌方的魔法值。对敌方英雄造成损毁魔法值一定百分比的伤害。祈求者将获得50%损毁的魔法。",
            lore: "恩多利昂的恶之混动。",
            shard_description: "提升电磁脉冲燃烧魔法的伤害系数，并且将敌方单位以每秒{shard_drag_speed}距离的速度向电磁脉冲的中心牵引。",
            notes: [
                "对被吹起的单位（强袭飓风或Eul的神圣法杖）无效。"
        ...
        },
        {
            ...
            lore: "哈雷克之火葬魔咒。",
            scepter_description: "增加毁天灭地。双击阳炎冲击进行施放。施放后阳炎冲击的冷却时间为{cataclysm_cooldown}秒。每个敌方英雄附近{cataclysm_min_range}-{cataclysm_max_range}范围内产生{cataclysm_count}个可见的阳炎冲击。",
            notes: [
                "施放后立即获得目标区域的视野。",
                "祈求者使用阳炎冲击击杀英雄后，即使不在经验范围内也能获得经验。"
            ]
        ...
        },
        {
            ...
            name: "混沌陨石（OMG）",
            description: "祈求者从太空中召唤一枚燃烧的流星打击指定位置。流星着陆后会向前滚动一段距离，根据技能等级持续造成伤害和向前滚动。每被撞击一次都将在短时间内受到烧灼伤害，",
            lore: "塔拉克的天坠之火。",
            notes: [
                "每个敌方单位受到撞击伤害的间隔为{damage_interval}秒，后续较低的烧灼伤害持续{burn_duration}秒。",
                "陨石移动的速度为{travel_speed}。"
        ...
        },
        {
            ...
            lore: "科瑞克斯的杀戮之墙。",
            notes: [
                "如果敌人在受到寒冰之墙作用后获得减益免疫状态，那么减速效果对其依然有效。"
            ]
        },
        {
            ...
            name: "超震声波（OMG）",
            description: "祈求者在自己前方释放出超强的声波，对所有敌方单位造成伤害。声波的绝对冲击能够将敌方单位击退一定时间，同时让他们无法进行攻击，持续一定时间。",
            lore: "布鲁冯特之无力声波。",
            notes: []
        }
    ],
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "幽灵漫步",
            description: "隐身，移动速度改变{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，并且减缓附近敌人的移动速度。获得{MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT}点/秒生命恢复和{MODIFIER_PROPERTY_MANA_REGEN_CONSTANT}点/秒魔法恢复。"
        },
        {
