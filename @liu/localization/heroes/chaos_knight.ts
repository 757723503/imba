    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                {
                    ability_special: "chaos_bolt_speed",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "fake_bolt_distance",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "pierces_immunity",
                    text: ""
                },
                {
                    ability_special: "additional_debuff_duration_percent",
                    text: ""
                }
            ],
            name: "实相裂隙",
        ...
        },
        {
            ...
            name: "混沌一击",
            description: "混沌骑士和他的幻象在攻击时有几率造成威力不一的致命一击，并且触发时具有吸血效果。对非英雄单位造成{creep_multiplier}倍伤害，但是吸血效果减少{creep_lifesteal_reduction_pct}%。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "chance_for_extra_illusion",
                    text: ""
                }
            ],
            name: "混沌之军",
            description: "从其他维度召唤若干个混沌骑士的幻象。幻象继承{outgoing_damage_tooltip}{攻击力，但是承受{incoming_damage_tooltip}}伤害。\\n驱散类型：弱驱散",
            lore: "凭借混沌骑士在各个世界丰富的战斗经验，他的幻象足以压制所有敢于反抗他的人。",
            scepter_description: "产生全地图上所有友方英雄的一个幻象。额外产生一个混沌骑士的幻象。",
            notes: [
                "能够移除混沌骑士的大部分负面状态。",
                "混沌骑士在施放时有{invuln_duration}秒的无敌时间，可以躲避眩晕和伤害技能。"
            ]
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "bonus_illusion_chance",
                    text: ""
                },
                {
                    ability_special: "bonus_illusion_count",
                    text: ""
                }
            ],
            name: "混沌称霸",
