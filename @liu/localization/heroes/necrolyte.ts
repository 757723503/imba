...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                {
                    ability_special: "projectile_multiplier",
                    text: ""
                },
                {
                    ability_special: "ethereal_duration",
                    text: ""
                },
                {
                    ability_special: "magic_resistance_reduction",
                    text: ""
                }
            ],
            name: "死亡搜寻",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "heal_regen_to_damage",
                    text: ""
                }
            ],
            name: "竭心光环",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "movement_transfer",
                    text: ""
                },
                {
            ...
            name: "幽魂护罩",
            description: "瘟疫法师步入将生者与死者相隔的领域。散发出一片灵气，减缓周围敌人的移动速度。在这个形态下，瘟疫法师无法攻击或被攻击，受到的魔法伤害增加，但是生命/魔法恢复效果加强。",
        ...
        },
        {
            ...
            name: "死神镰刀",
            description: "眩晕目标敌方英雄，然后造成基于他当前损失生命值的伤害。瘟疫法师击杀敌人后将永久获得生命和魔法恢复。如果目标在死神镰刀效果下死亡，击杀者为瘟疫法师。",
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "死神镰刀",
            description: "因击杀永久获得{MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT}点/秒生命恢复和{MODIFIER_PROPERTY_MANA_REGEN_CONSTANT}点/秒魔法恢复。"
        },
        {
