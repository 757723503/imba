    ...
    AbilityArray: [
        {
            ...
            name: '粘性燃油',
            description:
                '用粘性油浸透一块区域，蝙蝠骑士的攻击和技能对敌人造成额外伤害，并降低他们的移动速度和转身速率。再次施法可以继续提高伤害，最多叠加{max_stacks}次。每次施放还会造成少量伤害。',
        ...
        },
        {
            ...
            notes: ['对一名敌方英雄使用的技能或物品施加了强制位移效果后，会获得移动速度和技能增强加成。不会叠加。'],
        },
        {
    ...
    ModifierArray: [
        {
            ...
            name: '粘性燃油',
            description:
                '施法者造成的伤害提高{MODIFIER_PROPERTY_TOOLTIP}。\\n转身速率降低{MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE}%。\\n移动速度降低{MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE}%。',
        },
        {
        ...
        },
        {
            ...
            name: '火上浇油',
            description:
                '获得{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%移动速度加成，和{MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE}技能增强加成。',
        },
    ],
};
