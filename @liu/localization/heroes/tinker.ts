...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            scepter_description:
                '修补匠的激光升级成缩小射线，使其模型大小、当前生命值和最大生命值减少{scepter_reduction_pct}%（可以叠加）。光线可以弹射一次到离主目标最远的目标身上，最远为{scepter_bounce_radius}距离，以英雄优先。',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            notes: ['机器人的产生速率是每秒{machines_per_sec}个。'],
        },
        {
        ...
        },
        {
            ...
            name: '折跃耀光',
            description:
                '向一个敌人扔出一枚光弹，造成伤害，将其向远离修补匠的方向传送并且缠绕，同时降低施法和攻击距离，持续{debuff_duration}秒。<br><br>传送地点和修补匠扔出光弹时的地点之间相距的距离总是技能的当前施法距离 + {bonus_distance}。',
            notes: ['如果相距超过{max_distance}则不会使敌人传送。'],
        },
    ],
    TalentArray: [
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '维修机器人 | 易位器',
            description:
                '机械行军在穿过友方英雄时会施加不可叠加的持续治疗效果。 在对自身施放的防御矩阵护盾被完全吸收后，修补匠会向前方的随机方向闪烁。<br><br>驱散类型：弱驱散',
            related_abilities: [
                {
                    ability_classname: 'imba_tinker_defense_matrix',
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '折跃耀光',
            description:
                '被缠绕。因折跃迷乱，施法距离减少{MODIFIER_PROPERTY_CAST_RANGE_BONUS_PERCENTAGE}%，攻击距离减少{MODIFIER_PROPERTY_CAST_RANGE_BONUS_PERCENTAGE}%。',
        },
        {
