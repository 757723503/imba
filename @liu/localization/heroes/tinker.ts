...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "minimun_distance",
                    text: ""
                },
                {
                    ability_special: "maximum_distance",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "additional_starting_cooldown",
                    text: ""
                },
                {
                    ability_special: "creep_teleport_level",
                    text: ""
                },
                {
                    ability_special: "hero_teleport_level",
                    text: ""
                },
                {
                    ability_special: "outpost_channel_time",
                    text: ""
                },
                {
                    ability_special: "jungle_outpost_channel_time",
                    text: ""
                }
            ],
            name: "基恩载具",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "int_per_one_cdr",
                    text: ""
                },
                {
                    ability_special: "one_percent_tooltip",
                    text: ""
                },
                {
                    ability_special: "max_cdr",
                    text: ""
                },
                {
            ...
            name: "尤里卡！",
            description: "修补匠的每{int_per_one_cdr}点智力提供{one_percent_tooltip}{物品冷却时间减少，最多为{max_cdr}}。",
            lore: "",
            notes: []
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "scepter_bonus_cast_range",
                    text: ""
                },
                {
                    ability_special: "scepter_reduction_pct",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "machines_per_sec",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "bonus_distance",
                    text: ""
                },
                {
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "折跃耀光",
            description: "被缠绕。因折跃迷乱，施法距离减少{MODIFIER_PROPERTY_CAST_RANGE_BONUS_PERCENTAGE}%，攻击距离减少{MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_PERCENTAGE}%。"
        },
        {
