    ...
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "goo_duration_creep",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            name: "刺针扫射",
            description: "将尖刺喷射向敌人，对钢背兽附近的敌人造成伤害。任何单位最近{quill_stack_duration}秒内每次受到刺针扫射的打击都会受到额外伤害。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "side_angle",
                    text: ""
                },
                {
                    ability_special: "back_angle",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "quill_release_interval",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "activation_cooldown",
                    text: ""
                },
                {
                    ability_special: "activation_manacost",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "activation_num_quill_sprays",
                    text: ""
                },
                {
                    ability_special: "activation_spray_interval",
                    text: ""
                },
                {
                    ability_special: "activation_angle",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "activation_movement_speed_pct",
                    text: ""
                },
                {
                    ability_special: "activation_turn_rate_pct",
                    text: ""
                },
                {
                    ability_special: "activation_disable_turning",
                    text: ""
                },
                {
                    ability_special: "activation_ignore_cast_angle",
                    text: ""
                },
                {
                    ability_special: "activation_turn_rate",
                    text: ""
                }
            ],
            name: "钢毛后背",
            description: "如果伤害来自钢背兽的侧面或者背后，他所受的伤害将会降低。钢背兽每次从背后受到{quill_release_threshold}点伤害会自动释放一次当前等级的刺针扫射。",
            lore: "在战斗中背部迎人或许正好合适。",
            scepter_description: "钢毛后背增加主动效果。钢背兽将背部转向目标方向，{activation_delay}秒后以{activation_spray_interval}秒间隔朝背部前方的锥形范围强行连续喷出{activation_num_quill_sprays}次刺针扫射。钢背兽在这段时间内面朝方向被锁定，被缴械，并且移动速度减缓{activation_movement_speed_pct}%。",
            notes: [
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "amp_pct",
                    text: ""
                },
                {
                    ability_special: "angle",
                    text: ""
                }
            ],
            name: "尖刺在背",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "active_view_angle_restriction",
                    text: ""
                }
            ],
            name: "战意",
