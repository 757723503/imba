    ...
    AbilityArray: [
        {
            ...
            notes: ['龙破斩最远能伤害1225距离外的单位。', '不会触发法术抵抗或法术反弹。'],
        },
        {
        ...
        },
        {
            ...
            notes: ['每次技能击中敌人时都会刷新持续时间。', '使用物品不会触发炽魂。'],
        },
        {
        ...
        },
        {
            ...
            notes: ['神灭斩在技能施放到伤害生效有{damage_delay}秒延迟，因此有若干技能可以躲避该伤害。'],
        },
        {
            ...
            name: '慢热',
            description:
                '莉娜的技能造成{total_damage_tooltip}%总伤害。击中时造成{total_damage_tooltip}%，然后在{burn_duration}秒内造成{total_damage_tooltip}%烧灼伤害。',
            notes: [],
        },
        {
            ...
            name: '燎火',
            description:
                '莉娜每对一名敌方英雄造成{damage_threshold}点伤害都会使他们过热，对附近他们的友军造成伤害。单次伤害可以多次触发该效果。过热的幻象造成的伤害会减少。',
            notes: [],
        },
    ],
    TalentArray: [
    ...
    FacetArray_B: [
        {
            ...
            name: '慢热 | 热力失控',
            description: '莉娜的技能会持续造成额外伤害。 施放神灭斩会暂时让莉娜的能量达到顶峰，给予炽魂的叠加效果。',
            related_abilities: [
                {
                    ability_classname: 'imba_lina_laguna_blade',
                    description: '施放神灭斩会暂时让莉娜的能量达到顶峰，给予炽魂的叠加效果。',
                },
            ],
            related_talents: [],
        },
    ...
    ModifierArray: [
        {
            ...
            name: '腾焰斗篷',
            description:
                '拥有顺畅的移动状态。魔法抗性提升{MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS}%。技能伤害提升{MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS}%。',
        },
        {
