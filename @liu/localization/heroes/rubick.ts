...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            shard_description:
                '可以对自身或友军施放隔空取物。以队友为目标时投掷距离增加{shard_max_land_distance_bonus_pct}%，投掷延迟降低至{shard_teammate_throw_delay}秒。',
            notes: ['目标滞空时，拉比克可以使用次级技能将目标扔往目标方向。', '单位落地后，自身不会受到范围眩晕效果。'],
        },
        {
        ...
        },
        {
            ...
            name: '失效力场',
            description:
                '拉比克对奥术的精通能够影响周围敌人的感知，降低他们的魔法抗性。可以在防御和进攻之间切换，选择降低敌人的魔法抗性或提升队友的魔法抗性。',
        ...
        },
        {
            ...
            lore: '不是每一个魔导师都能成为大魔导师……',
            notes: ['破坏会使技能无法获得新的奥术积累叠加效果。', '破坏不会使现有的奥术积累叠加效果提供的加成失效。'],
        },
        {
            ability_classname: 'imba_rubick_might_and_magus',
            ability_specials: [],
            name: '力量与魔法',
            description: '每{one_tooltip}%技能增强也会使拉比克的攻击力提升{one_tooltip}%，魔法抗性提升{one_tooltip}%。',
            notes: [],
        },
        {
            ...
            name: '技能窃取',
            description:
                '拉比克钻研一个敌方英雄的魔法精华之痕，学习这个英雄最后释放的技能的秘密。拉比克将可以使用这个技能，维持几分钟或直到他死亡，对敌人施放被窃取的技能时该技能的负面效果持续时间得到加长。',
            lore: '……不过即使是他们那些低级魔法也能变得非常实用。',
            scepter_description: '可窃取的技能提升至2个。提升施法距离，并且施放的技能会升级成神杖版本。',
            notes: ['无法窃取物品类技能。', '拉比克若拥有阿哈利姆魔晶，则窃取的技能会是魔晶升级版本。', '不会触发法术反弹。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '节俭窃贼 | 奥术积累',
            description: '施放技能会暂时提升拉比克施放后续技能的作用范围。 窃取技能的魔法消耗也会降低。',
            related_abilities: [
                {
                    ability_classname: 'imba_rubick_arcane_supremacy',
                    description: '施放技能会暂时提升拉比克施放后续技能的作用范围。',
                },
                {
                    ability_classname: 'imba_rubick_spell_steal',
                    description: '窃取技能的魔法消耗也会降低。',
                },
            ],
            related_talents: [],
        },
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '失效力场',
            description:
                '拉比克的队友受到作用时，魔法抗性提升{MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS}%。拉比克的敌人受到作用时，魔法抗性降低{MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS}%。',
        },
        {
