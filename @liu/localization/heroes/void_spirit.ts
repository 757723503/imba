    ...
    AbilityArray: [
        {
            ...
            shard_description:
                '提升残阴的观察距离，并且只牵引敌方英雄单位。其他单位处于残阴路径时每{damage_tick_rate}秒受到{creep_damage_pct}%伤害，但是残像不会被摧毁。冷却时间降低至{AbilityCooldown}秒。',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            name: '太虚之径',
            description:
                '虚无之灵撕裂现实进入精神位面，再出现在目标地点，对沿途的所有敌人造成伤害。此次攻击将施加一个太虚印记，造成{pop_damage_delay}秒减速，然后引爆。',
        ...
        },
        {
            ...
            name: '共鸣脉冲',
            description:
                '虚无之灵将自己包裹在保护性护盾之中，可以吸收物理伤害，并围绕自身发出一次伤害性脉冲。脉冲每击中一名敌方英雄，护盾的伤害吸收量都会提升。',
    ...
    FacetArray_B: [
        {
            ...
            name: '对称 | 庇佑 | 太虚的呼唤',
            description:
                '共鸣脉冲会产生更强的全伤害护盾，而不是物理伤害护盾。 退出异化时，残阴会在离虚无之灵最远的{s:bonus_aether_remnant_count}个灵扉处产生。',
            related_abilities: [
                {
                    ability_classname: 'imba_void_spirit_dissimilate',
                    description:
                        '退出异化时，距离虚无之灵最远的{aether_remnant_count}个灵扉处会产生残阴。如果在中央的灵扉重组则没有效果。残阴会面朝中央的灵扉，牵引时间和伤害降低。',
                },
                {
                    ability_classname: 'imba_void_spirit_resonant_pulse',
