...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            name: '月神之箭',
            description:
                '射出一支绝对精准的箭矢，对第一个击中的敌人造成伤害并眩晕目标。目标距离越远，眩晕时间越长，最短{arrow_min_stun}秒，最长可达{arrow_max_stun}秒。根据箭矢飞行的距离还将对目标额外造成最多{arrow_bonus_damage}点伤害。若击中的是非远古的普通单位，将直接秒杀。',
            lore: '明月的能量让月之公主的箭矢变得愈发致命。',
            scepter_description: '月神之箭在主神箭行进途中对敌人释放群星风暴。对击中的单位施放第二个群星风暴，造成的伤害有所降低。',
            notes: ['神箭每飞行150码，中箭后眩晕的持续时间将提高0.5秒，额外伤害增加14点。', '月神之箭可以射中隐身单位。'],
        },
        {
        ...
        },
        {
            ...
            name: '太阳金辉',
            description:
                '逐渐提升米拉娜和所有友方英雄的白天视野范围、攻击速度和攻击力，{max_damage_time}秒后达到最大威力。白天视野范围的提升速度比攻击速度和攻击力快{day_vision_multiplier}倍。<br><br>友军获得{ally_pct}%加成效果。',
            notes: [],
        },
        {
            ...
            shard_description:
                '落地时沿着塞根的跳跃方向放出一个弹道，对敌人造成伤害和减速，施放群星风暴会让他们必定被次级群星风暴击中。跳跃不会脱离月之暗面的隐身效果。<br><br>可以设为多样施法来选择跳跃的距离和面朝方向。<br><br>获得{shard_bonus_charges}点额外能量点数。',
            notes: [],
        },
        {
            ...
            name: '群星风暴',
            description:
                '召唤一波流星砸向附近的敌方单位。{starfall_secondary_radius}范围内最近的敌方单位将会再受到一次{secondary_starfall_damage_percent}%伤害的冲击。',
    ...
    FacetArray_B: [
        {
            ...
            name: '月之暗面 | 太阳金辉',
            description: '米拉娜的终极技能使友军获得隐身状态和移动速度加成。 米拉娜的终极技能使友军获得逐渐增加的攻击速度和攻击力加成。',
            related_abilities: [],
            related_talents: [
                {
                    talent_key: 'special_bonus_unique_mirana_4_facet_mirana_sunlight',
                    description: '-{s:bonus_AbilityCooldown}秒 太阳金辉冷却',
                },
                {
                    talent_key: 'special_bonus_unique_mirana_5_facet_mirana_sunlight',
                    description: '太阳金辉提供+{s:bonus_evasion}% 闪避',
                },
            ],
        },
    ],
    ModifierArray: [
        ...
        },
        {
            ...
            name: '太阳金辉',
            description:
                '攻击力提升{MODIFIER_PROPERTY_PREATTACK_BONUS_DAMAGE}点。攻击速度提升{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}。白天视野提升{MODIFIER_PROPERTY_BONUS_DAY_VISION}。',
        },
    ],
};
