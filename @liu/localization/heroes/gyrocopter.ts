    ...
    AbilityArray: [
        {
            ...
            notes: ['火箭弹幕不能伤害矮人直升机视野之外的单位。', '追踪导弹发射的火箭弹幕不会触发加力燃烧器。'],
        },
        {
            ...
            shard_description:
                '追踪导弹现在从施放{shard_delay}秒后开始不断发射{shard_radius}作用范围的火箭弹幕。火箭弹幕优先以追踪导弹的目标为目标。',
            notes: ['防御塔对导弹造成半额伤害。', '准星效果仅对队友可见。', '导弹会跟随并击中隐身单位。'],
        },
        {
            ...
            notes: ['对主目标的攻击距离没有改变。', '破坏会使侧翼机枪失效。'],
        },
        {
        ...
        },
        {
            ...
            notes: ['无法拆分圣剑或迈达斯之手。', '矮人直升机总是能以原价出售配方图纸。'],
        },
    ],
    TalentArray: [
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '二次打击 | 加力燃烧器',
            description: '召唤飞弹会在击中的英雄周围延后产生二次爆炸。 火箭弹幕每次成功击中敌方英雄都会提升矮人直升机的移动速度。',
            related_abilities: [
                {
                    ability_classname: 'imba_gyrocopter_rocket_barrage',
                    description: '火箭弹幕每次成功击中敌方英雄都会提升矮人直升机的移动速度。',
                },
                {
                    ability_classname: 'imba_gyrocopter_call_down',
                    description:
                        '每次打击的间隔减少{bonus_strike_delay}秒。被飞弹击中的敌方英雄都会被标记，朝他们发射一枚拥有{tracking_strike_radius}作用范围的追踪飞弹。这枚飞弹造成{tracking_missile_damage}%伤害。',
                },
            ],
            related_talents: [],
        },
