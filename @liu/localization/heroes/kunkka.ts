...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            notes: ['初始泡泡效果仅对队友可见，并且提供战争迷雾中的视野。', '飞到半空的单位将会被眩晕并且可以被攻击。'],
        },
        {
        ...
        },
        {
            ...
            name: 'X标记',
            description:
                '对友方或敌方英雄使用，用 X 标记他们当前位置，数秒后将他们送回 X 标记处。在技能持续时间内，昆卡可以手动触发送回。对友方英雄使用后持续时间加倍。',
        ...
        },
        {
            ...
            name: '幽灵船',
            description:
                '召唤一艘幽灵船驶过战场，直到撞成粉碎，残骸周围的敌人将会因撞击受到伤害并眩晕。友军被泡在统帅朗姆酒中，移动速度提升并对受到的伤害反应麻木，一定百分比的伤害将会延后到持续时间结束时结算。',
            lore: '铁帆舰队最后的战舰虽然只是个幻影，但它给昆卡的敌人带来的死亡却是完全真实的。',
            scepter_description:
                '幽灵船在目标地点以{fleet_interval}秒的间隔产生{fleet_count}艘船组成的舰队。每艘船现在还会从左舷和右舷发射{num_cannon_volleys}波炮弹，穿过敌人时造成{cannon_ball_damage_pct}%幽灵船伤害。',
            notes: [
        ...
        },
        {
            ...
            name: '统帅朗姆酒',
            description:
                '如果昆卡受到来自敌方英雄、建筑或肉山的伤害会使他的生命低于临界值，那么他会沉浸在统帅朗姆酒中，获得移动速度加成，并且延后承受即将受到的伤害。',
            notes: ['与其他来源的统帅朗姆酒完全叠加。'],
        },
    ],
    TalentArray: [
        {
