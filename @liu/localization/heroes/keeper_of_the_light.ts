...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "max_channel_time",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "channel_vision_radius",
                    text: ""
                },
                {
                    ability_special: "channel_vision_interval",
                    text: ""
                },
                {
                    ability_special: "channel_vision_duration",
                    text: ""
                },
                {
                    ability_special: "channel_vision_step",
                    text: ""
                }
            ],
            name: "冲击波",
        ...
        },
        {
            ...
            notes: [
                "如果目标在0.1秒内移动超过300码（例如闪烁技能），法力流失对此次移动不会造成任何效果。"
            ]
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "off_duration",
                    text: ""
                },
                {
                    ability_special: "on_duration",
                    text: ""
                },
                {
                    ability_special: "off_duration_initial",
                    text: ""
                },
                {
                    ability_special: "fixed_movement_speed",
                    text: ""
                },
                {
            ...
            notes: [
                "幻火会对作用范围内所有敌人施加朝其牵引的效果，该牵引效果不会打断。"
            ]
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "movespeed_bonus_duration",
                    text: ""
                },
                {
            ...
            name: "召回",
            description: "短暂延迟后，将友方英雄目标传送到你的位置。如果在此期间，友方英雄目标受到来自玩家的伤害，召回将被打断。施放时会对光之守卫和传送目标同时施加查克拉魔法和移动速度加成。<br><br>如果设为多样施法，会把光之守卫传送至目标友军。<br><br>技能等级随着灵魂形态的等级提升。",
            lore: "朝着光明前行。",
            notes: [
                "如果光之守卫死亡，技能效果将会中断。",
                "召回将打断持续施法。",
        ...
        },
        {
            ...
            name: "致盲之光",
            description: "一道致盲之光在目标区域闪现，击退并致盲区域内的单位，使他们的攻击不能命中。在{knockback_duration}秒内击退{knockback_distance}距离。",
            lore: "原初的光芒将战局的优势转向伊扎洛和他的盟友。",
            notes: [
                "落地后受作用单位将摧毁150范围内的树木。"
            ]
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "bonus_mana_pct",
                    text: ""
                }
            ],
            name: "法力俱增",
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "炎阳之缚",
            description: "移动速度被减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，魔法抗性降低{MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS}%。"
        },
        {
