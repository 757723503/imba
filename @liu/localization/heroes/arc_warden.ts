    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                {
                    ability_special: "tooltip_scepter_cooldown",
                    text: ""
                },
                {
                    ability_special: "tooltip_scepter_manacost",
                    text: ""
                }
            ],
            name: "",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "applies_silence",
                    text: ""
                }
            ],
            name: "乱流",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "attack_magic_damage",
                    text: ""
                },
                {
            ...
            shard_description: "磁场会对身处其中的敌人造成减速，敌方的攻击弹道也会被减速。另外磁场内的友军获得攻击弹道速度加成。作用范围提升{bonus_radius}。",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "wraith_vision_radius",
                    text: ""
                },
                {
                    ability_special: "wraith_vision_duration",
                    text: ""
                },
                {
                    ability_special: "scepter_activation_delay",
                    text: ""
                },
                {
            ...
            name: "闪光幽魂",
            description: "召唤一个缓慢实体化的闪光怨灵萦绕在目标区域，直到有敌人进入范围。一旦有敌方单位进入范围，怨灵将贴近敌人自我熔化，造成魔法伤害并使目标减速。非英雄单位受到的伤害增加{creep_damage_bonus_pct}%。",
            lore: "泽特原始自我的低级碎片。",
            scepter_description: "闪光幽魂会在击中一个敌人后再产生一个闪光幽魂，新的幽魂具有{scepter_activation_delay}秒启动延迟。新的闪光幽魂持续{scepter_duration}秒，作用范围为{scepter_radius}。",
            notes: [
                "闪光幽魂无法被躲避。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "ignore_penalty_distance",
                    text: ""
                },
                {
            ...
            name: "风暴双雄",
            description: "天穹守望者将破碎的自我汇聚到一起，创造出自身的完美电子复制体。复制体可以使用天穹守望者的当前所有物品和特殊的风暴双雄版本技能，但是大部分消耗品以及死亡时会掉落的物品除外。复制体的物品和技能冷却时间会独立计算。<br><br>复制体被击杀后敌人将获得经验和金钱奖励，而且技能重新开始冷却。<br><br>复制体离天穹守望者过远会失去自我意识，承受更多伤害。",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "regeneration_effect",
                    text: ""
                },
                {
                    ability_special: "duration",
                ...
                {
                    ability_special: "water_bounty_rune_duration_pct",
                    text: ""
                }
            ],
            name: "神符灌注",
            ...
            lore: "",
            notes: [
                "激活赏金或圣水神符时持续时间为{water_bounty_rune_duration_pct}%。"
            ]
        }
    ],
    TalentArray: [
