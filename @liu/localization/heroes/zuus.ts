    ...
    AbilityArray: [
        {
            ...
            name: '神圣一跳',
            description:
                '宙斯作出神圣一跳，向前跳跃并震击最近的可见敌人（以英雄优先），造成伤害，并减缓其移动速度、攻击速度。宙斯获得附近900范围的顺畅视野，持续3秒。',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            name: '雷击',
            description:
                '召唤一道闪电打击一个敌方单位，造成伤害及短暂眩晕。施放后，雷击在目标周围{sight_radius_night}范围内提供空中视野和真实视域。本技能可以对地施放，将会自动作用于{spread_aoe}范围内最近的敌方英雄上。',
            lore: '对那些反叛的异教徒最震慑的天罚。',
            notes: ['该技能可以打断持续施法类技能和物品。'],
        },
        {
        ...
        },
        {
            ...
            name: '雷神之怒',
            description:
                '用闪电打击所有敌方英雄，对他们造成伤害，无论他们身在何处。<br><br>雷神之怒还会提供每个受攻击的英雄周围的真实视域。隐身的英雄不会受到伤害，但依然会获得他所在之处的真实视域。',
    ...
    FacetArray_B: [
        {
            ...
            related_abilities: [
                ...
                },
                {
                    ability_classname: 'imba_zuus_thundergods_wrath',
                    description:
                        '从最低生命值的英雄开始，逐一对敌人造成伤害，最后是生命值最高的敌人。如果有敌人被这个技能击杀，那么接下来所有敌人受到的伤害都会增加。',
                },
            ],
            related_talents: [],
        },
