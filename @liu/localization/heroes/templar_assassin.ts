...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "bonus_damage_per_instance_burn",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "cast_while_disabled",
                    text: ""
                },
                {
                    ability_special: "dispels",
                    text: ""
                }
            ],
            name: "折光",
            description: "圣堂刺客变得高度难以捉摸，获得一个小型护盾，同时获得攻击力加成。攻击力加成和免伤效果相互独立，并且都是有限次数的效果。如果护盾被摧毁，只要还有能量点数就会再产生一个新的。如果单次伤害超过了剩余的护盾，所有的伤害都会被吸收。",
            lore: "通过操控她的灵能面纱，拉娜娅让自然法则为她所用。",
            notes: [
                "生命移除类伤害将无视折光（也不会减少折光次数）。",
                "伤害超过{damage_threshold}点才会被折光格挡。",
                "折光对敌人可见。"
            ]
        },
        {
            ...
            name: "隐匿",
            description: "圣堂刺客将自己隐藏起来，只要静止不动将一直处于隐身状态。只要在隐匿状态下攻击敌人打破隐身，拉娜娅将对敌人造成额外伤害，并降低其护甲，持续{abilityduration}秒。",
            lore: "拉娜娅本人就和她与隐之圣堂的契约一样神秘。",
            notes: [
                "除了停留在原地或持续施放灵能投射，其他任何动作都会打破隐匿效果。",
                "隐匿的护甲降低作用对防御塔无效。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "attack_spill_width",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "meld_strike_spills",
                    text: ""
                },
                {
            ...
            name: "灵能之刃",
            description: "圣堂刺客锋利的灵能之刃可以穿透敌人，对其正后方的敌方单位造成伤害，并且攻击距离得到提升。每对一个单位造成伤害后，飞溅伤害都会减少一定百分比。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "trap_fade_time",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "instant_trap_damage",
                    text: ""
                },
                {
                    ability_special: "extra_damage",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "trap_max_charge_duration",
                    text: ""
                },
                {
            ...
            name: "灵能陷阱",
            description: "圣堂刺客放下一个隐形的神秘陷阱监视敌人的动向。启动后将减缓范围内敌人的移动速度并造成小幅伤害，陷阱放置时间越久，引爆后减速效果越强，最低为{movement_speed_min}{，放置}trap_max_charge_duration{秒后引爆将达到最大减速效果，为{movement_speed_max}}，并且还能造成额外伤害。",
        ...
        },
        {
            ...
            name: "灵能投射",
            description: "持续施法 - 圣堂刺客经过{abilitychanneltime}秒持续施法后可以传送至任意灵能陷阱，到达时引爆灵能陷阱，陷阱总是最大效果，并且立刻造成{extra_damage}点额外伤害。灵能投射在持续施法时不会脱离隐匿效果。",
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "陷阱",
            description: "移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，最多减速{MODIFIER_PROPERTY_TOOLTIP}%。"
        },
        {
