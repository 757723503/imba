...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '不稳定化合物',
            description:
                '炼金术士调制一瓶不稳定的化合物，投向敌方英雄，对爆炸点周边范围的单位造成伤害并眩晕。调制的时间越久，伤害越大，眩晕时间也越长。炼金术士在调制期间获得移动速度加成。调制{brew_time}秒后达到最大伤害量和最长眩晕时间。然而，若{brew_explosion}秒后未扔出药剂，则会在炼金术士自己手中爆炸。',
        ...
        },
        {
            ...
            name: '贪魔的贪婪',
            description:
                '炼金术士将敌人的尸体和赏金神符转化成额外的金币。炼金术士每杀死一个单位，就能获得基础额外金钱和附加额外金钱。如果炼金术士在接下来{duration}秒内又杀死了一个单位，获得了黄金，那么他所获得的附加额外金钱将有一定幅度的增加。另外，赏金神符将提供成倍金钱。',
        ...
        },
        {
            ...
            notes: ['拥有{transformation_time}秒的变身时间，可以用来躲避攻击和技能弹道以及眩晕技能。'],
        },
        {
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '化学狂暴',
            description:
                '攻击间隔降低至{MODIFIER_PROPERTY_BASE_ATTACK_TIME_CONSTANT}，每秒生命回复提高{MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT}点，移动速度提升{MODIFIER_PROPERTY_MOVESPEED_BONUS_CONSTANT}。',
        },
        {
            modifier_classname: 'modifier_imba_alchemist_scepter_bonus_damage',
            name: '阿哈利姆神杖送出数量',
            description:
                '因向队友送出阿哈利姆神杖，获得{MODIFIER_PROPERTY_PREATTACK_BONUS_DAMAGE}点攻击力加成和{MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE}%技能增强加成。',
        },
        {
