...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "chemical_rage_cooldown_reduction_pct",
                    text: ""
                }
            ],
            name: "狂暴药剂",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "brew_time",
                    text: ""
                },
                {
                    ability_special: "brew_explosion",
                    text: ""
                },
                {
                    ability_special: "min_stun",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "midair_explosion_radius",
                    text: ""
                },
                {
                    ability_special: "brew_explosion",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "starting_gold_bonus",
                    text: ""
                }
            ],
            name: "贪魔的贪婪",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "bonus_mana_regen",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "scepter_gold_damage",
                    text: ""
                },
                {
    ...
    ModifierArray: [
        ...
        {
            modifier_classname: "modifier_imba_alchemist_corrosive_weaponry_debuff_description",
            name: "移动速度降低{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。基础攻击力降低{MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING}%"
        },
        {
