    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "remnant_smash_radius_tooltip",
                    text: ""
                },
                {
                    ability_special: "creep_multiplier",
                    text: ""
                }
            ],
            name: "巨石冲击",
            description: "大地之灵将敌方单位或友方单位作为目标，将其击飞，目标将沿他面朝的方向飞行一段距离。如果大地之灵点地为目标，他将击飞{remnant_smash_radius_tooltip}范围内距离最近的单位，优先以残岩为目标。击飞的单位或残岩会对碰到的所有单位造成伤害。如果敌人是被残岩击中还将额外被减速。残岩被击飞的距离比其他单位更远。对非英雄单位造成{creep_multiplier}倍伤害。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "destroy_stone",
                    text: ""
                },
                {
                    ability_special: "can_roll_over_allied_heroes",
                    text: ""
                },
                {
                    ability_special: "allied_bonus_movespeed",
                    text: ""
                },
                {
                    ability_special: "allied_bonus_movespeed_duration",
                    text: ""
                },
                {
            ...
            name: "巨石翻滚",
            description: "大地之灵化身为巨石，经过{delay}秒延迟后向目标位置翻滚，对经过的敌人造成伤害和眩晕，伤害值为{damage} + {damage_str}%力量。如果撞到敌方英雄或自身被眩晕，翻滚都会中止。如果翻滚过程中经过残岩将会大幅提高翻滚距离和速度，造成的眩晕时间更长。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "total_pull_distance",
                    text: ""
                },
                {
                    ability_special: "AbilityCooldown",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "polarization_distance",
                    text: ""
                },
                {
                    ability_special: "vision_radius",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "rolling_offset_distance",
                    text: ""
                },
                {
                    ability_special: "hero_level_increment",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "is_stepping_stone",
                    text: ""
                }
            ],
            name: "残岩",
            description: "在指定位置召唤一块残岩。残岩没有视野，为无敌状态，可以加强大地之灵的技能效果。召唤残岩需要消耗一点能量点数。英雄每升{hero_level_increment}级都会额外获得能量点数。",
        ...
        },
        {
            ...
            name: "残岩魔咒",
            description: "大地之灵对一名英雄施法，使其暂时获得残岩的属性。经过短时间后残岩就会碎裂，释放出英雄，并对周围单位造成伤害。<br><br>可以对残岩施放。对残岩施放时冷却时间为5秒。<br>对友方英雄施放时施法距离更远。",
            lore: "考林操控大地的元素之力，使生命体暂时石化，将其收编于他的兵马俑大军中。",
            notes: [
                "如果大地之灵自身受到残岩魔咒的效果，也可以成为巨石冲击的目标。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "rock_explosion_radius",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "rock_explosion_delay",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "magnetized_rocks_buff_self",
                    text: ""
                },
                {
                    ability_special: "magnetized_rocks_buff_self_duration",
                    text: ""
                },
                {
            ...
            name: "磁化",
            description: "将附近小范围内的敌方单位磁化，使其短时间内受到伤害。被磁化的英雄单位将会引起附近残岩的爆炸，每次爆炸都将摧毁残岩并刷新残岩附近单位身上的磁化时间（若附近单位未被磁化则为其施加一个磁化效果）。该过程可重复数次。如果一个被磁化的英雄受到了地磁之握或巨石冲击的作用，那么所有被磁化的英雄都会受到同样效果。",
