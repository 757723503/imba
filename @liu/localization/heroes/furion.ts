    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "sprout_damage_radius",
                    text: ""
                },
                {
                    ability_special: "sprout_heal_interval",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "building_healing_pct",
                    text: ""
                }
            ],
            name: "发芽",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "treant_damage_min",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "kill_damage",
                    text: ""
                },
                {
                    ability_special: "kill_damage_duration",
                    text: ""
                },
                {
                    ability_special: "AbilityCooldown",
                ...
                {
                    ability_special: "scepter_min_entangle_duration",
                    text: ""
                },
                {
                    ability_special: "scepter_max_entangle_duration",
                    text: ""
                }
            ],
            name: "自然之怒",
            description: "伤害性的能量在全地图跳跃，打击视野中距目标点最近的多个敌人。每击中一个敌人伤害都会增加，击中{max_targets}个目标后达到最高伤害。",
            lore: "自然先知召唤维萝迪希娅的狂怒，消灭那些想要毁坏自然的敌人。",
            scepter_description: "冷却时间降低{bonus_AbilityCooldown}秒。缠绕所有击中的敌人。持续时间根据弹跳次序从{scepter_min_entangle_duration}秒开始增加，弹跳数达到上限时为{scepter_max_entangle_duration}秒。",
            notes: [
                "自然的愤怒只能伤害视野内的单位。",
                "可以通过点击小地图施放；初始目标将选择施放地点最近的有效单位。"
            ]
        },
        {
            ...
            name: "青森诅咒",
            description: "对{range}范围内所有敌方英雄施加一个诅咒，使他们在迷雾中显形，根据{radius}范围内树木的数量对他们造成减速和持续伤害。在此情况下树人也被视为树木。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "trees_per_stack",
                    text: ""
                },
                {
            ...
            name: "树林之力",
            description: "自然先知附近每{trees_per_stack}棵树都能让他获得一个攻击力加成的叠加效果。每次攻击都会减少攻击力的叠加效果，但是提升自然先知的护甲。",
            lore: "",
            notes: []
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "damage_per_tree_pct",
                    text: ""
                },
                {
                    ability_special: "radius",
            ...
            name: "丛林之魂",
            description: "附近{radius}范围内每棵树都会让自然先知获得{damage_per_tree_pct}{攻击力加成，}radius_treant%范围内每个树人也会让自然先知获得若干倍数的加成。",
            lore: "",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "tree_sprout_delay",
                    text: ""
                },
                {
                    ability_special: "tree_duration",
                    text: ""
                }
            ],
            name: "",
