    ...
    AbilityArray: [
        {
            ...
            name: "掘地",
            description: "挖掘进入地下，对自身施加驱散效果，无敌且不能作为目标，持续{duration}秒。持续时间内回复最大生命值的{hp_restore}%。被缠绕时无法施放。<br><br>驱散类型：弱驱散",
            lore: "",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "megameepo_net_offset",
                    text: ""
                }
            ],
            name: "地之束缚",
            ...
            notes: [
                "地之束缚可以使敌方单位在进入隐身后显形，但是不能作用于已经隐身的单位。",
                "对减益免疫单位和肉山无效。"
            ]
        },
        {
            ...
            name: "忽悠",
            description: "通过从大地中汲取神秘的能量，一个米波可以在持续施法{cast_duration}秒后传送至另一个米波或自身所在之处，在离开和到达的区域都对敌人造成伤害。<br><br>如果技能设为多样施法状态，所有米波也会对目标施放忽悠。对地施放后，除了选中的米波外所有米波会忽悠至最近的地点。",
        ...
        },
        {
            ...
            lore: "所以你要吗，还是……？",
            shard_description: "洗劫在击中敌人时拥有30%{几率施加地之突袭的负面效果，减缓20}%移动速度并造成每秒20点伤害，持续4秒。来自不同米波的效果可以叠加。",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "tooltip_share_percentage",
                    text: ""
                },
                {
                    ability_special: "tooltip_share_percentage_scepter",
                    text: ""
                },
                {
                    ability_special: "respawn",
                    text: ""
                },
                {
                    ability_special: "tooltip_respawn",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "required_level",
                    text: ""
                },
                {
                    ability_special: "levels_between_upgrades",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "main_meepo_stats_pct",
                    text: ""
                }
            ],
            name: "分则能成",
            description: "米波召唤一个不完美的半自主性自身复制体，可以像本体一样获得金钱和经验，并拥有本体的经验、属性和技能。但是，克隆只能使用本体装备的鞋类物品。任何一个克隆死亡都会导致所有米波全体死亡。分则能成向所有米波提供魔法抗性加成。",
            lore: "我是不是在哪见过你？",
            shard_description: "任意米波在{fling_radius}范围内还存在其他米波时都能施放分则能成。使附近的米波将自身扔向{AbilityCastRange}距离内的目标，造成伤害并减缓目标的移动速度。魔法消耗：{AbilityManaCost}",
            notes: [
                "克隆体不能使用奥术鞋和卫士胫甲。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "damage_distribution_duration",
                    text: ""
                },
                {
                    ability_special: "end_knockback_duration",
                    text: ""
                },
                {
                    ability_special: "end_knockback_distance",
                    text: ""
                },
                {
                    ability_special: "end_knockback_height",
                    text: ""
                },
                {
                    ability_special: "stats_pct",
                    text: ""
                }
            ],
            name: "超大米波",
            description: "主米波将{radius}范围内其他米波放到自己的肩膀上。在这个形态下，他会获得其他米波{stats_pct}%的属性，并且可以把他们扔向敌人，造成伤害和减速。\\n\\n生效时地之束缚会产生额外的网，忽悠会根据身上的米波数量造成额外伤害。",
            lore: "",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "fling_radius",
                    text: ""
                },
                {
                    ability_special: "fling_movespeed",
                    text: ""
                },
                {
                    ability_special: "fling_slow_duration",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "pack_rat",
                    text: ""
                },
                {
                    ability_special: "cooldown_pct",
                    text: ""
                }
            ],
            name: "囤积狂鼠",
