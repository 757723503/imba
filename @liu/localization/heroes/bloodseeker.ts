    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "shard_max_health_dmg",
                    text: ""
                }
            ],
            name: "血怒",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "strong_dispel_count",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "delay_plus_castpoint_tooltip",
                    text: ""
                }
            ],
            name: "血祭",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "invis_threshold_pct",
                    text: ""
                },
                {
            ...
            name: "焦渴",
            description: "血魔能够感知到敌人的伤口中涌出的鲜血，敌方英雄的生命值低于{min_bonus_pct}{，他的移动速度就会提升，而且生命值越低，提升效果越大。如果生命值低于{invis_threshold_pct}}，他还将获得该英雄的视野和真实视域。焦渴的效果可以叠加。血魔可以突破最大速度限制。",
            lore: "史德利古尔闻到血腥味就会变得无比狂热。",
            notes: [
                "幻象不能触发该技能。",
                "移动速度加成在敌人生命值低于{max_bonus_pct}%时达到上限。",
                "目标死亡后效果延续{linger_duration}秒。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "damage_cap_amount",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "barrier_decay_pct",
                    text: ""
                },
                {
            ...
            name: "血雾",
            description: "血魔将自己的鲜血撒向一片区域，伤害自身的同时对敌人造成伤害和减速。开启时食血动物的治疗效果提升。技能处于冷却时无法关闭。<br><br>另外，被动使来自自身技能的超量治疗变成全伤害护盾，最多可达血魔最大生命的50%{。护盾数值每秒衰减{barrier_decay_pct}}。",
            lore: "",
            notes: [
                "对血魔造成的伤害不能致死，而且不能杀死英雄。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "heal_hp_pct_per_level",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "deny_lifesteal_reduction_pct",
                    text: ""
                },
                {
            ...
            name: "食血动物",
            description: "血魔每杀死一个单位都会回复部分生命，回复量为每级血魔等级为{heal_hp_pct_per_level}{单位最大生命值，加上基础}base_heal%点。<br><br>友军击杀了附近的敌方英雄时会回复半额数值。",
            lore: "",
            notes: [
