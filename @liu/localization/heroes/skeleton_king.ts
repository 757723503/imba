...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "min_skeleton_spawn",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "talent_skeleton_damage",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            name: "幽魂之剑",
            description: "冥魂大帝对攻击的单位施加诅咒，经过一定延迟后造成一定量伤害和攻击伤害的一定百分比。吸血灵魂的吸血效果对诅咒伤害有效，而一个单位在短时间内不会被再次诅咒。",
            lore: "",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "wraith_cd_mult",
                    text: ""
                },
                {
                    ability_special: "wraith_crit_bonus",
                    text: ""
                }
            ],
            name: "本命一击",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "clear_curse",
                    text: ""
                },
                {
                    ability_special: "shard_skeleton_count",
                    text: ""
                },
                {
            ...
            name: "绝冥再生",
            description: "冥魂大帝倒下后，他飞散的冥魂会重组，使他复活。死亡时附近{slow_radius}范围内的敌人会被减速。可以对自身施放，使冥魂大帝立刻阵亡。",
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "重生",
            description: "深受冥魂大帝的绝冥再生影响。移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，攻击速度降低{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}。"
        },
        {
