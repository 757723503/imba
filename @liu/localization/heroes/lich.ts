    ...
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "mana_restore_pct_from_creep",
                    text: ""
                },
                {
                    ability_special: "mana_restore_pct_from_hero",
                    text: ""
                }
            ],
            name: "死亡充能",
            description: "巫妖无法获得被动魔法恢复，但是巫妖附近{radius}范围内任何单位阵亡都会使他回复{mana_restore_pct_from_creep}{最大魔法值（英雄阵亡会回复{mana_restore_pct_from_hero}}最大魔法值）。物品和技能的瞬间魔法回复还是照常生效。",
            lore: "",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "channel_duration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "creep_duration_multiplier",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "initial_projectile_speed",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "has_unlimited_jumps",
                    text: ""
                },
                {
                    ability_special: "should_fire_chain_frost_on_death",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "hero_kill_spire_health",
                    text: ""
                },
                {
                    ability_special: "hero_health_tooltip",
                    text: ""
                },
                {
                    ability_special: "creep_kill_spire_health",
                    text: ""
                },
                {
                    ability_special: "creep_health_tooltip",
                    text: ""
                },
                {
                    ability_special: "spire_duration",
                    text: ""
                },
                {
                    ability_special: "bonus_intelligence_per_stack",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "additional_projectile_speed",
                    text: ""
                }
            ],
            name: "",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "additional_jumps",
                    text: ""
                }
            ],
            name: "",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "max_creep_attacks",
                    text: ""
                },
                {
                    ability_special: "duration",
