    ...
    AbilityArray: [
        {
            ...
            name: '寒霜爆发',
            description:
                '破坏性的寒霜在目标敌方单位身上爆发，造成范围伤害并降低范围内敌人的移动和攻击速度，持续{abilityduration}秒。主要目标所受伤害最高。',
        ...
        },
        {
            ...
            name: '不洁契约',
            description:
                '攻击速度提升，维持数次攻击，每次攻击吸取一定百分比魔法。施放需要消耗一定百分比当前生命值。最多持续{duration}秒，或攻击次数提前耗尽。',
            notes: [],
        },
        {
            ...
            name: '死亡充能',
            description:
                '巫妖无法获得被动魔法恢复，但是巫妖附近{radius}范围内任何单位阵亡都会使他回复{mana_restore_pct_from_creep}%最大魔法值（英雄阵亡会回复{mana_restore_pct_from_creep}%最大魔法值）。物品和技能的瞬间魔法回复还是照常生效。',
            notes: [],
        },
        {
            ...
            name: '阴邪凝视',
            description:
                '持续施法 - 使一个敌方单位着魔，缓慢走到巫妖与其之间的一点，并吸取其当前魔法值的一定百分比。<br><br>巫妖在持续施法时可以使用他的其他技能。<br><br>如果对非英雄单位施放，持续时间会增加至{creep_duration_multiplier}倍，并且每秒造成{creep_damage}点伤害。',
            lore: '当心寒意……',
        ...
        },
        {
            ...
            notes: ['如果开启自动施放，巫妖将对附近受到攻击的友方单位施放该技能。'],
        },
        {
            ...
            name: '冰霜魔盾',
            description:
                '施加一个冰霜魔盾环绕目标，减少受到的普通攻击伤害。魔盾生效时，每{interval}秒都会对附近的敌方单位放出冰霜魔法，造成少量伤害和减速。',
            lore: '在人世的那些年最初学会的护身法术，而艾斯瑞安现在编织在周围的冰霜魔法随着时间愈发冰冷。',
            notes: ['免疫技能的敌人不会受到伤害或减速。', '冰霜魔盾可以对友方建筑施放。'],
        },
        {
            ...
            notes: ['连环霜冻无法被躲避。', '连环霜冻的移动速度为{projectile_speed}。', '连环霜冻不会弹跳到墓碑召唤的僵尸身上。'],
        },
        {
        ...
        },
        {
            ...
            name: '寒冰尖柱',
            description:
                '在目标地点创造一根寒冰尖柱，减缓范围内敌人的移动速度。可以承受5次英雄攻击或10次非英雄攻击，并且被摧毁时会在附近产生一个寒霜爆发的效果。<br><br>连环霜冻可以对尖柱施放，并且范围内没有其他敌人时可以弹跳至冰柱上。<br><br>巫妖可以对其施放冰霜魔盾。冰霜魔盾每次造成伤害时会治疗尖柱，使其回复1次英雄攻击次数。',
            notes: [],
        },
    ],
    TalentArray: [
    ...
    FacetArray_B: [
        {
            ...
            name: '寒意渐增 | 冰霜之缚',
            description:
                '敌人被连环霜冻击杀，或者在冰霜魔盾作用下阵亡，相应技能的持续时间都会延长。 连环霜冻无法弹跳时会停留在上个目标身上，如果出现新目标可以再次弹跳。',
            related_abilities: [
                {
                    ability_classname: 'imba_lich_frost_shield',
