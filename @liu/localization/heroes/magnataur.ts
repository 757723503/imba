...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            notes: ['攻击力加成根据基础攻击力和主属性加成计算。', '分裂伤害无视减益免疫。', '远程单位的攻击没有分裂效果。'],
        },
        {
            ...
            name: '巨角冲撞',
            description:
                '马格纳斯向前冲刺，用他巨大的犀角将敌人挑起。被击中的英雄将被拽至终点，然后受到伤害并且攻击速度和移动速度都被降低。使敌人穿过树木或高台时造成额外伤害。',
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '授予力量',
            description:
                '基础攻击力提升{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%，造成{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%分裂伤害。',
        },
        {
            modifier_classname: 'modifier_imba_magnataur_empower_aura_buff',
            name: '授予力量光环',
            description:
                '基础攻击力提升{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%。近战英雄的攻击可以造成{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%的分裂伤害。',
        },
        {
