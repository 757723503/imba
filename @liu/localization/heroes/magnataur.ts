...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "destination_offset",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "horn_toss_slow_pct",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "shock_speed",
                    text: ""
                },
                {
                    ability_special: "shock_width",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "return_damage_pct",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "should_self_cast",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "secondary_cleave_distance",
                    text: ""
                },
                {
                    ability_special: "self_multiplier",
                    text: ""
                }
            ],
            name: "授予力量",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "terrain_hit_cooldown",
                    text: ""
                }
            ],
            name: "巨角冲撞",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "stat_buff_duration",
                    text: ""
                },
                {
                    ability_special: "stats_per_stack",
                    text: ""
                }
            ],
            name: "两极反转",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "knockback_reduction",
                    text: ""
                }
            ],
            name: "坚固核心",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "strength_per_stack",
                    text: ""
                },
                {
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "授予力量",
            description: "基础攻击力提升{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%，造成{MODIFIER_PROPERTY_TOOLTIP}%分裂伤害。"
        },
        {
            modifier_classname: "modifier_imba_magnataur_empower_aura_buff",
            name: "授予力量光环",
            description: "基础攻击力提升{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%。近战英雄的攻击可以造成{MODIFIER_PROPERTY_TOOLTIP}%的分裂伤害。"
        },
        {
