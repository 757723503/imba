...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '星体禁锢',
            description:
                '将一个目标友方或敌方英雄禁锢在星体中。被禁锢的英雄处于无敌和无法行动状态。禁锢结束时，对目标造成伤害并窃取其最大魔法值的一定百分比。',
            lore: '被关在现世和殁境之间的空间中，受害者认识到自己如孩童般的学识和血肉之躯。',
            shard_description:
                '星体禁锢现在会造成范围伤害。另外友军在星体禁锢期间能以{allied_movement_speed_pct}%移动速度进行移动（他们为可见状态，但无法成为目标，也不能执行其他任何动作）。',
            notes: ['被禁锢的单位依然能受到神智之蚀的作用。', '最大魔法值窃取效果不会提升殁境神蚀者的当前魔法值，也不会直接减少目标的当前魔法值。'],
        },
        {
            ...
            notes: ['除了奥术天球，大多数没有冷却时间的技能都不能触发精气光环。'],
        },
        {
            ...
            scepter_description:
                '殁境神蚀者受到会使自身血量低于{scepter_barrier_threshold}%的伤害时触发一次强驱散。另外，效果触发时殁境神蚀者会耗尽所有魔法，产生一个伤害护盾，数值等于自身最大魔法值的{scepter_barrier_threshold}%。持续{scepter_barrier_duration}秒。这个效果每{scepter_barrier_cooldown}秒可触发一次，并且无法刷新。',
            notes: ['破坏会使阿哈利姆神杖效果无法触发。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '殁势神蚀 | 殁世神灭',
            description: '星体禁锢和神智之蚀作用下的英雄每次施放技能时都会治疗殁境神蚀者。 精华变迁回复魔法时，还会暂时增加最大魔法值。',
            related_abilities: [
                {
                    ability_classname: 'imba_obsidian_destroyer_astral_imprisonment',
                    description: '受到作用的英雄会获得一个魔力邪印的负面效果，持续{debuff_duration}秒，每次施放技能都会治疗殁境神蚀者。',
                },
                {
                    ability_classname: 'imba_obsidian_destroyer_equilibrium',
                    description: '精华变迁回复魔法时，还会暂时增加最大魔法值。',
                },
                {
                    ability_classname: 'imba_obsidian_destroyer_sanity_eclipse',
                    description: '受到作用的英雄会获得一个魔力邪印的负面效果，持续{debuff_duration}秒，每次施放技能都会治疗殁境神蚀者。',
