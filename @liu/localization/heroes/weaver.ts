...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            shard_description:
                '缩地在造成伤害的敌人身上留下一个标记，持续{geminate_attack_mark_duration}秒。编织者脱离缩地状态{shukuchi_attack_delay}秒后，附近{shukuchi_attack_mark_radius}范围内拥有印记的敌人都会被连击的第二次攻击击中。',
            notes: ['每次施放的技能只能对相同单位造成一次伤害。'],
        },
        {
            ...
            notes: ['第二次攻击将在编织者第一次攻击的{delay}秒后发出，并且没有距离限制。'],
        },
        {
            ...
            notes: ['能够移除编织者身上大部分的负面状态。', '时光倒流可以躲避攻击和技能弹道。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '虫巢思维 | 横行霸道',
            description: '虫群的甲虫攻击英雄时编织者会获得经验。 缩地的移动速度增加，穿越敌人时会造成减速。',
            related_abilities: [
                {
                    ability_classname: 'imba_weaver_the_swarm',
                    description: '虫群的甲虫攻击英雄时编织者会获得经验。',
                },
                {
                    ability_classname: 'imba_weaver_shukuchi',
                    description: '缩地的移动速度增加，穿越敌人时会造成减速。',
                },
            ],
            related_talents: [],
        },
