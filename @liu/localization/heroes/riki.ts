...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            lore: '力丸来找你了。',
            notes: ['力丸的幻象也会有背刺的动作，但是不会造成额外伤害。'],
        },
        {
        ...
        },
        {
            ...
            lore: '力丸来找你了。',
            notes: ['力丸在隐身时不会自动攻击敌人。', '力丸的幻象也会有背刺的动作，但是不会造成额外伤害。', '背刺的额外伤害无法闪避。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '消灭 | 契约杀手',
            description: '力丸获得助攻和击杀时会获得额外经验。 绝杀秘技攻击非英雄单位时拥有{s:bonus_creep_agility_multiplier}倍敏捷加成。',
            related_abilities: [
                {
                    ability_classname: 'imba_riki_innate_backstab',
                    description: '力丸获得助攻和击杀时会获得额外经验。',
                },
                {
                    ability_classname: 'imba_riki_tricks_of_the_trade',
                    description: '绝杀秘技攻击非英雄单位时拥有{creep_agility_multiplier}倍敏捷加成。',
                },
            ],
            related_talents: [],
        },
