...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "fail_stun_duration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "shackle_distance",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "shackle_count",
                    text: ""
                },
                {
                    ability_special: "shackle_angle",
                    text: ""
                }
            ],
            name: "束缚击",
        ...
        },
        {
            ...
            name: "强力击",
            description: "持续施法 - 风行者为她的弓蓄力，射出一支强力的箭矢，最长可蓄力{abilitychanneltime}秒，其间可以打断蓄力，蓄力时间越长，箭矢伤害和减速效果越高。这支箭会对穿过的所有敌方单位造成伤害，并破坏树木。每伤害一个单位，箭矢的伤害和减速效果都会降低。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "enemy_movespeed_bonus_pct",
                    text: ""
                },
                {
                    ability_special: "radius",
                ...
                {
                    ability_special: "scepter_movespeed_bonus_pct",
                    text: ""
                },
                {
                    ability_special: "physical_damage_pct",
                    text: ""
                },
                {
                    ability_special: "cannot_be_dispelled",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "focusfire_fire_on_the_move",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "is_unfocused",
                    text: ""
                },
                {
                    ability_special: "duration_increase_per_kill",
                    text: ""
                },
                {
                    ability_special: "cooldown_reduction_per_kill",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "unfocused_cancel_initial_cooldown",
                    text: ""
                }
            ],
            name: "集中火力",
            description: "风行者受风的引领，攻击敌方单位或建筑的攻击速度增加{bonus_attack_speed}，但是攻击力降低。不过次级物品效果的额外伤害不会降低。",
