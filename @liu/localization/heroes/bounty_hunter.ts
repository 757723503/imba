    ...
    AbilityArray: [
        {
            ...
            name: '投掷飞镖',
            description:
                '向一个敌方单位掷出一枚致命的飞镖，对目标造成伤害，并且减缓目标{slow}%移动速度，持续{slow_duration}秒。只要目标周围{bounce_aoe}范围内存在被追踪术标记的单位，飞镖就能向其弹射。',
        ...
        },
        {
            ...
            name: '追踪术',
            description:
                '追踪一个敌方英雄，获得目标的真实视域，使目标受到的伤害增加，同时掌握目标当前携带的金钱数额。赏金猎人在被追踪者周围可以获得移动速度提升。如果目标在被追踪期间死亡，赏金猎人和附近友方英雄都将获得若干金钱奖励。施放追踪术不会脱离隐身。',
            lore: '利用他高度敏锐的视觉和嗅觉，刚铎的袭击成功率很高。',
            shard_description:
                '追踪术可以对地面施放，产生一个捕兽陷阱。3秒后陷阱启动，变为隐形状态。走过陷阱的单位会被施加追踪术。陷阱拥有400视野。最大陷阱数：8。对地施放追踪术时拥有1200施法距离加成。',
            notes: [
    ...
    FacetArray_B: [
        {
            ...
            name: '穿针引线',
            description: '投掷飞镖会对经过的所有敌人造成伤害和减速。',
            related_abilities: [
                {
                    ability_classname: 'imba_bounty_hunter_shuriken_toss',
                    description: '投掷飞镖会对经过的所有敌人造成伤害和减速。',
