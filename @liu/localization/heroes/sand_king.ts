    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "burrow_speed",
                    text: ""
                },
                {
                    ability_special: "burrow_anim_time",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "burrow_speed_scepter",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "scepter_max_power",
                    text: ""
                }
            ],
            name: "掘地穿刺",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "sand_storm_move_speed_pct",
                    text: ""
                },
                {
                    ability_special: "sand_storm_max_distance_from_caster",
                    text: ""
                },
                {
                    ability_special: "sand_storm_move_speed_bonus_when_outside_radius",
                    text: ""
                }
            ],
            name: "沙尘暴",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "shard_interval",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "scepter_explosion_radius_pct",
                    text: ""
                },
                {
                    ability_special: "scepter_explosion_min_dist",
                    text: ""
                },
                {
                    ability_special: "scepter_explosions_per_pulse",
                    text: ""
                },
                {
                    ability_special: "spine_tick_rate",
                    text: ""
                },
                {
                    ability_special: "spine_damage_pct",
                    text: ""
                },
                {
                    ability_special: "shard_explosions_per_pulse",
                    text: ""
                }
            ],
            name: "地震",
            ...
            scepter_description: "地震的脉冲开始时每{spine_tick_rate}秒会在随机地点产生{scepter_explosions_per_pulse}片尾刺的攻击区域，每片区域为地震当前范围的{scepter_explosion_radius_pct}{，对击中的敌人造成{spine_damage_pct}}尾刺伤害。魔晶的地震波会产生{shard_explosions_per_pulse}次攻击。",
            notes: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "inner_radius",
                    text: ""
                },
                {
                    ability_special: "inner_radius_bonus_damage_pct",
                    text: ""
                },
                {
