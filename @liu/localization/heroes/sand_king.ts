    ...
    AbilityArray: [
        {
            ...
            name: '掘地穿刺',
            description:
                '沙王钻入地面挖掘隧道前进，穿出地面时伤害并眩晕上方的敌方单位。对击中的英雄施加腐尸毒。<br><br>可以设为多样施法，直接朝指定方向立刻施放，不需要走向目标地点。',
        ...
        },
        {
            ...
            notes: ['沙尘暴可以用来躲避攻击和技能弹道。', '沙王在沙尘暴中攻击或使用技能会暂时显形。{fade_delay}秒后将再次隐形。'],
        },
        {
        ...
        },
        {
            ...
            name: '地震',
            description:
                '经过{abilitycastpoint}秒施法前摇后，沙王向地中发送扰动，引起大地剧烈震动。所有范围内的敌人会受到伤害并被减速。每次后续震波都会提高伤害传播半径。',
            lore: '许多探险家丧生于闪烁荒原的流沙。',
            shard_description: '提升地震波伤害，每{shard_interval}秒都会在沙王身上产生一道较小的地震波。',
            scepter_description:
                '地震的脉冲开始时每{spine_tick_rate}秒会在随机地点产生{scepter_explosions_per_pulse}片尾刺的攻击区域，每片区域为地震当前范围的{scepter_explosion_radius_pct}%，对击中的敌人造成{scepter_explosion_radius_pct}%尾刺伤害。魔晶的地震波会产生{shard_explosions_per_pulse}次攻击。',
            notes: ['地震波将以沙王为中心，而不是他施放技能的地点。'],
        },
        {
            ...
            name: '尾刺',
            description:
                '沙王袭击一片区域，对范围内所有敌人发动一次攻击，对每个敌人造成额外伤害。最中心{inner_radius}范围内敌人将受到{inner_radius_bonus_damage_pct}%额外伤害。对所有击中的敌人施加腐尸毒和减速效果。',
            notes: [],
        },
    ],
    TalentArray: [
