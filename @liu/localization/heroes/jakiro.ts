...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            notes: ['最远能伤害1025距离外的单位。', '两次吐息有{fire_delay}秒的间隔。', '不会触发法术抵抗或法术反弹。'],
        },
        {
            ...
            notes: ['路径完全成形需要{path_delay}秒。', '冰封路径消失后眩晕效果也会消失。'],
        },
        {
            ...
            shard_description: '杰奇洛的液态火攻击还会造成{pct_health_damage}%敌方目标最大生命值的每秒伤害。该伤害不会对建筑生效。',
            notes: ['对单位和建筑都有效。'],
        },
        {
            ...
            name: '液态冰',
            description:
                '杰奇洛的攻击使他的敌人受寒，减缓其移动速度，持续{duration}秒，并且被杰奇洛的攻击和其他技能击中后承受额外伤害。这个效果对建筑无效。',
            shard_description: '杰奇洛的液态冰攻击还会造成{pct_health_damage}%敌方单位最大生命值的每秒伤害。',
            notes: [],
        },
        {
            ...
            scepter_description:
                '提升烈焰焚身的持续时间、宽度，并且变为纯粹伤害。杰奇洛会在烈焰焚身边缘放出两道冰墙，对试图穿过的所有敌人减速{ice_edge_movement_slow}%。',
            notes: ['被烈焰焚身击中后离开区域还将额外受到{linger_duration}秒伤害效果。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '液态火 | 液态冰',
            description:
                '杰奇洛可以使攻击附带范围内的攻击速度降低和持续伤害。 杰奇洛可以使攻击附带移动速度减缓和一个负面效果，加深他其他技能造成的伤害。',
            related_abilities: [],
            related_talents: [
                {
                    talent_key: 'special_bonus_unique_jakiro_3_facet_jakiro_ice',
                    description: '获得液态火',
                },
                {
                    talent_key: 'special_bonus_unique_jakiro_4_facet_jakiro_ice',
                    description: '+{s:bonus_bonus_instance_damage_from_other_abilities} 液态冰额外伤害',
                },
            ],
        },
    ],
    ModifierArray: [
        ...
        },
        {
            ...
            name: '液态冰',
            description:
                '移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，并且受到杰奇洛攻击和其他技能伤害时承受{MODIFIER_PROPERTY_TOOLTIP}额外伤害。',
        },
        {
            modifier_classname: 'modifier_imba_jakiro_dual_breath_slow',
            name: '冰火交加',
            description:
                '正被杰奇洛的冰火交加减速。移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，攻击速度降低{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}。',
        },
        {
