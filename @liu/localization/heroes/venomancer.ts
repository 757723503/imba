    ...
    AbilityArray: [
        {
            ...
            name: '剧毒之威',
            description:
                '在目标地点制造一个{radius}作用范围的毒池，造成剧毒新星的伤害效果并减缓20%%移动速度。敌人在该区域内阵亡时将产生一个瘟疫守卫。',
            notes: [],
        },
        {
            ...
            notes: ['瘴气可以致死。', '技能持续时间内每{tick_interval}秒造成一次伤害。', '初始减速效果为{movement_slow}%，减速效果将逐渐降低。'],
        },
        {
            ...
            notes: ['毒刺的伤害可以致死。', '毒刺造成的持续性伤害不会打断物品的回复效果，也不能使闪烁匕首进行冷却状态。'],
        },
        {
            ...
            name: '瘟疫守卫',
            description:
                '召唤一个瘟疫守卫来攻击敌方单位和建筑。守卫对魔法免疫。守卫拥有毒刺攻击，效果与毒刺技能的当前等级相同，造成50%的原技能伤害。',
        ...
        },
        {
            ...
            name: '恶性瘟疫',
            description:
                '使一名敌人感染致命的瘟疫，造成初始爆发伤害和基于最大生命值的额外持续伤害。瘟疫会减缓目标和附近敌人的移动速度，取决于他们与目标之间的距离。目标阵亡或负面状态消失时，附近所有敌人都会感染不可再次传播的瘟疫。',
            notes: [],
        },
        {
            ...
            name: '剧毒新星',
            description:
                '每当剧毒术士或瘴气效果下的敌方英雄阵亡就会爆出一个剧毒之环。被剧毒击中的敌人会持续受到不致死的魔法伤害，并且魔法抗性降低。这个效果每{trigger_cd}秒触发一次，无法被刷新。',
        ...
        },
        {
            ...
            name: '脓毒休克',
            description:
                '剧毒术士的攻击会根据目标身上拥有的负面效果数量造成额外伤害。额外伤害为魔法伤害。只会计算来自剧毒术士或他的瘟疫守卫的负面效果。',
            scepter_description: '提升每个负面效果提供的基础伤害。瘟疫守卫也会根据他们的攻击力造成脓毒休克伤害。',
            notes: ['破坏只会使剧毒术士攻击的额外伤害失效。'],
        },
    ],
    TalentArray: [
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '零号病人 | 瘟疫傍身',
            description: '恶性瘟疫可以再次扩散。 瘟疫守卫可以附着在友军身上，并且拥有额外能量点数。',
            related_abilities: [
                {
                    ability_classname: 'imba_venomancer_plague_ward',
                    description:
                        '瘟疫守卫可以附着在友军身上，并且拥有{max_charges}点能量点数。附着守卫的生命值取决于携带者的最大生命值，被摧毁时只会提供{gold_bounty_pct}%击杀金钱。',
                },
                {
                    ability_classname: 'imba_venomancer_noxious_plague',
                    description: '恶性瘟疫可以扩散{spread_count}次。第一次之后的扩散的即时伤害减少{impact_damage_reduce}%。',
                },
            ],
            related_talents: [],
        },
