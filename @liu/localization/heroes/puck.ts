    ...
    AbilityArray: [
        {
            ...
            notes: ['幻象法球在飞行途中提供顺畅视野。', '将自己传送到幻象法球可以躲避攻击和技能弹道。'],
        },
        {
        ...
        },
        {
            ...
            name: '顽皮克敌',
            description:
                '每当帕克躲避攻击时，它就会回复{mana_restore_pct}%最大魔法值和{mana_restore_pct}%最大生命值。躲避指向性技能的弹道将回复{dodged_spell_multiplier}倍数值。',
            notes: [],
        },
        {
            ...
            scepter_description:
                '新月之痕现在额外具有{scepter_radius}作用范围和距离，并且在{scepter_pushback_duration}秒内击退敌人{scepter_pushback}距离（不会打断）。显示区域内隐形的单位和守卫，持续{scepter_vision_duration}秒。',
            notes: [],
        },
        {
            ...
            notes: ['帕克在相位转移状态下依然具有碰撞体积。', '进行任何动作都会中止相位转移。', '帕克在相位转移状态下无敌。'],
        },
        {
            ...
            name: '梦境缠绕',
            description:
                '创造一个变化无常的的魔法梦境来困住敌方英雄，对他们造成伤害和束缚。如果被困住的敌方英雄试图挣脱缠绕走出梦境，将因为梦境破碎而受到眩晕和额外伤害。',
            lore: '仙女龙散播混乱，让敌人陷入鲜活的梦境，见证自己死亡的命运。',
            scepter_description:
                '梦境缠绕作用下的所有敌人都会被帕克攻击，攻击频率基于帕克攻击频率的{attack_rate_pct}%。即使目标挣脱梦境，被眩晕时攻击也会继续。',
            notes: [],
        },
    ],
    TalentArray: [
