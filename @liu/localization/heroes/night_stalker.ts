    ...
    AbilityArray: [
        {
            ...
            name: '虚空',
            description:
                '制造一个伤害性的虚空，对一个敌方单位造成减速及伤害，同时降低其视野。夜晚时虚空可以造成短暂眩晕，打断持续施法，并且持续时间更长。',
            lore: '巴拉那制造一个无限之夜的漩涡，将敌人猛烈地撕扯进永恒的黑暗。',
            notes: ['虚空在白天不会对敌人造成眩晕。'],
        },
        {
            ...
            scepter_description: '减少伤残恐惧的冷却时间，并且变为开关型技能，开启后在原初始持续时间结束后每秒会消耗最大魔法值的一定百分比。',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            ability_specials: [],
            name: '黑暗之心',
            description: '在夜晚期间，暗夜魔王的生命恢复提升{hp_regen_during_night_pct}%，而在白天会减少{hp_regen_during_night_pct}%。',
            notes: [],
        },
        {
            ...
            name: '长夜之治',
            description: '比赛现在会从夜晚开始，而不是白天。夜晚时间比白天长。',
            notes: [],
        },
    ],
    TalentArray: [
    ...
    FacetArray_B: [
        {
            ...
            name: '失明虚空',
            description: '虚空作用下的敌人不会与友军共享视野。当不在友军视野中，他们会受到每秒伤害。',
            related_abilities: [
                {
                    ability_classname: 'imba_night_stalker_void',
                    description: '虚空作用下的敌人不会与友军共享视野。当不在友军视野中，他们会受到每秒伤害。',
    ...
    ModifierArray: [
        {
            ...
            name: '永夜虚无',
            description:
                '移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，攻击速度降低{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}。视野降低{MODIFIER_PROPERTY_BONUS_NIGHT_VISION}。',
        },
        {
