    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "procs_onhit_effects",
                    text: ""
                }
            ],
            name: "虚张声势",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "can_double_jump",
                    text: ""
                },
                {
                    ability_special: "AbilityCooldown",
                ...
                {
                    ability_special: "jump_duration_gyroshell",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "jump_height_gyroshell",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "parry_swashbuckles",
                    text: ""
                },
                {
                    ability_special: "parry_chance",
                    text: ""
                },
                {
                    ability_special: "parry_cooldown",
                    text: ""
                },
                {
                    ability_special: "parry_damage_threshold",
                    text: ""
                }
            ],
            name: "甲盾冲击",
            description: "石鳞剑士跃入空中，再落向当前位置的前方地面造成冲击，对范围内所有敌人造成伤害和减速。冲击时每击中一名敌方英雄，他就能在短时间内获得一定数值的全伤害护盾。\\n\\n地雷滚滚过程中使用甲盾冲击将会保持前进，并且可以使地雷滚滚跨过地形障碍。\\n\\n地雷滚滚期间甲盾冲击的冷却时间会有所减少。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "turn_rate_boosted",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "bounce_duration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "jump_recover_time",
                    text: ""
                },
                {
            ...
            name: "地雷滚滚",
            description: "石鳞剑士卷成一个减益免疫状态的圆球，拥有{magic_resistance}%魔法抗性加成，隆隆地向前滚去。滚动时移动速度提升，可以碾过树木，但是转身速率降低。敌人被击中后会被击退，然后受到基于石鳞剑士攻击力的伤害，落地时会被眩晕。\\n\\n与地形障碍相撞后会暂时停止滚动，并且滚动方向变反。\\n\\n地雷滚滚期间，甲盾冲击的冷却时间会有所减少。\\n\\n驱散类型：弱驱散",
        ...
        },
        {
            ...
            name: "卷土重来",
            description: "石鳞剑士将自身卷成保护性的圆球，获得减益免疫状态，拥有{magic_resistance}%魔法抗性加成，并且可以转身。可以在地雷滚滚期间施放，暂停滚动。可以在卷土重来期间施放地雷滚滚和甲盾冲击。若敌人在此期间发动攻击，将滚离攻击者，对途中的敌人施加地雷滚滚的伤害/眩晕。",
            lore: "",
            notes: []
        },
        {
