    ...
    AbilityArray: [
        {
            ...
            notes: ['所有直接攻击魅惑魔女的敌方单位都会被减速。', '减速效果在攻击单位产生攻击动作时出现，而不是伤害生效时。'],
        },
        {
            ...
            name: '跃动',
            description:
                '向后跳跃，躲避多种飞行过程中的攻击和技能弹道，并向魅惑魔女的攻击距离+{bonus_attack_range}范围内最远的{attack_targets}个敌方单位发动一次附有推进的攻击。',
            lore: '跃动就是活跃灵动。',
            notes: [],
        },
        {
            ...
            name: '密友',
            description:
                '魅惑魔女缠绕一个敌方单位。目标附近所有敌方、友方和中立非英雄单位会攻击魅惑魔女选定的目标，并且具有攻击速度和移动速度加成，持续{duration}秒。',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            notes: ['不会选择满血单位进行治疗。', '破坏会使过度保护的小精灵失效。'],
        },
        {
            ...
            notes: ['造成伤害上限的距离是{distance_cap}。', '计算与目标之间的距离在攻击弹道击中目标时。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            related_abilities: [
                ...
                },
                {
                    ability_classname: 'imba_enchantress_natures_attendants',
                    description:
                        '只要魅惑魔女受到敌方英雄的伤害超过{overprotective_damage_threshold}点，{overprotective_wisp_count}个小精灵就会出现，{overprotective_wisp_duration}秒内进行治疗。同一时间最多只能存在{overprotective_max_wisps}个过度保护的小精灵。',
                },
            ],
            related_talents: [],
        },
