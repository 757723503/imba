    ...
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "dominate_duration",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "overprotective_damage_threshold",
                    text: ""
                },
                {
                    ability_special: "overprotective_damage_reset_interval",
                    text: ""
                },
                {
                    ability_special: "overprotective_wisp_duration",
                    text: ""
                },
                {
                    ability_special: "overprotective_wisp_count",
                    text: ""
                },
                {
                    ability_special: "overprotective_max_wisps",
                    text: ""
                }
            ],
            name: "自然之助",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "base_damage_amp",
                    text: ""
                },
                {
            ...
            name: "煽动野怪",
            description: "所有中立生物对敌方英雄造成更多的伤害。增加的伤害为{base_damage_amp}{ + {damage_amp_per_level}} * 魅惑魔女的英雄等级。",
            lore: "",
            notes: [
                "不会影响劝化的中立生物、痛苦魔方和肉山。"
            ]
