...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            notes: ['如果目标在受到此技能后{buff_duration}秒内被杀死，小蜘蛛就会孵化。', '被小蜘蛛杀死的单位会生出额外的小蜘蛛。'],
        },
        {
        ...
        },
        {
            ...
            name: '织网',
            description:
                '编织出一张蜘蛛网，育母蜘蛛在蛛网里被动提升移动速度和转身速率，并且获得无视地形移动的能力。<br><br>织网拥有最多{AbilityCharges}点能量点数，充能时间为每{abilitychargerestoretime}秒。<br><br>织网现在可向其他蛛网触及的区域全地图施放。蛛网永久存在，不过可以手动摧毁。当其数量超过上限，最早的蛛网将会消失。',
            lore: '编制出一张蛛丝之床，艾拉齐娜的网保护她和她的后代，同时给予前进的敌人警告。',
            scepter_description: '提升蛛网内移动速度，并且提升蛛网最大数量',
            notes: ['也会作用于小蜘蛛。', '100{生命时获得全额移动速度加成，1点生命时获得0}移动速度加成'],
        },
        {
            ...
            name: '蜘蛛奶',
            description:
                '育母蜘蛛击杀一个单位后，她和{kill_heal_aoe}范围内她控制的所有单位都会获得一个状态效果，每{tick_rate}秒治疗一定生命，治疗量为遇害者生命值的一定百分比。非英雄单位提供的治疗量减少{kill_creeps_penalty}%。',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            name: '极度饥渴',
            description:
                '对活物体液的强烈饥渴提高了育母蜘蛛的攻击力，并使她的攻击附带吸血效果。对非英雄单位的吸血效果减少{creep_lifesteal_reduction_pct}%。',
            lore: '虽然大多数猎物都被她用丝茧包裹，作为饲料留给后代，但育母蜘蛛对那些迷路的英雄情有独钟。',
            shard_description: '提升持续时间。开启极度饥渴后，攻击力加成每{shard_damage_tick_interval}秒提升{shard_damage_per_tick}%。',
            notes: ['与其他吸血效果完全叠加。'],
        },
        {
            ...
            name: '蛛纱陷阱',
            description:
                '育母蜘蛛可以制造出最多{count}个触碰已有蛛网的隐形网线。敌方英雄穿过网线将会触发陷阱，被缠绕，在战争迷雾中显形，并持续受到伤害。网线一开始被触发后，多名英雄还可以在同根网线上被绊倒，直到网线被摧毁。只要有人触发陷阱，育母蜘蛛的队友就会在小地图上发现。',
    ...
    FacetArray_B: [
        {
            ...
            name: '疯狂喂食 | 坏死之网',
            description: '极度饥渴还会施加给附近的小蜘蛛。 减少蛛网上敌人的生命恢复。',
            related_abilities: [
                {
                    ability_classname: 'imba_broodmother_spin_web',
                    description: '减少育母蜘蛛所在蛛网上敌人的生命恢复。',
                },
                {
                    ability_classname: 'imba_broodmother_silken_bola',
                    description: '丝质重器会把移动速度降低至0。',
                },
                {
                    ability_classname: 'imba_broodmother_insatiable_hunger',
                    description: '极度饥渴还会施加给附近的小蜘蛛。',
                },
            ],
            related_talents: [],
        },
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '麻痹之咬',
            description: '落空率提升{MODIFIER_PROPERTY_MISS_PERCENTAGE}%，移动速度降低{MODIFIER_PROPERTY_MISS_PERCENTAGE}%。',
        },
        {
            modifier_classname: 'modifier_imba_broodmother_insatiable_hunger',
            name: '极度饥渴',
            description:
                '基础攻击力提升{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%，而且拥有{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%吸血效果。',
        },
        {
        ...
        },
        {
            ...
            name: '丝质重器',
            description:
                '移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，受到敌人攻击时额外承受魔法伤害，并且攻击落空{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。',
        },
    ],
};
