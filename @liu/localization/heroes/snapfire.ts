    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "blast_speed",
                    text: ""
                },
                {
                    ability_special: "blast_width_initial",
                    text: ""
                },
                {
                    ability_special: "blast_width_end",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "point_blank_dmg_bonus_pct",
                    text: ""
                },
                {
                    ability_special: "bonus_applies_at_long_range",
                    text: ""
                },
                {
                    ability_special: "shard_knockback_distance",
                    text: ""
                },
                {
                    ability_special: "shard_knockback_duration",
                    text: ""
                },
                {
                    ability_special: "shard_stun_duration",
                    text: ""
                },
                {
                    ability_special: "shard_bonus_point_blank_dmg_pct",
                    text: ""
                }
            ],
            name: "电光石火",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "projectile_vision",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "dist_change_speed",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "delay_after_last_projectile",
                    text: ""
                },
                {
                    ability_special: "burn_linger_duration",
                    text: ""
                }
            ],
            name: "蜥蜴绝吻",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "max_time_in_belly",
                    text: ""
                }
            ],
            name: "血盆大口",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "pre_hop_duration",
                    text: ""
                },
                {
                    ability_special: "jump_duration",
                    text: ""
                },
                {
                    ability_special: "jump_height",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "pre_land_anim_time",
                    text: ""
                },
                {
                    ability_special: "landing_gesture_duration",
                    text: ""
                },
                {
                    ability_special: "impact_radius",
                ...
                {
                    ability_special: "self_cast_delay",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "shard_damage_multiplier_tooltip",
                    text: ""
                }
            ],
            name: "龙炎饼干",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "glancing_shot_damage_pct",
                    text: ""
                }
            ],
            name: "铅弹",
            description: "电炎绝手的普通攻击造成的伤害增加{damage_amp}{，但是有{miss_chance}}几率射偏，只造成{glancing_shot_damage_pct}%伤害。",
            lore: "",
            notes: [
                "跳弹II的攻击不会落空。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "buffed_attacks",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "buff_duration_tooltip",
                    text: ""
                },
                {
