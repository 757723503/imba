    ...
    AbilityArray: [
        {
            ...
            name: '电光石火',
            description:
                '电炎绝手开枪产生大范围的爆炸，对锥形区域内的敌人造成伤害和减速。平射距离内的伤害、移动速度减缓、攻击速度降低和减速持续时间额外提升{point_blank_dmg_bonus_pct}%。',
        ...
        },
        {
            ...
            name: '蜥蜴绝吻',
            description:
                '电炎绝手的伙伴在{duration_tooltip}秒内喷吐出密集的火团。火团造成冲击伤害，在地面上产生炽烈的炎洼，可以使敌人减速并造成持续伤害。电炎绝手在持续时间内转身速率降低，并且具有最小喷吐距离，为{min_range}。点击右键可以选择火团的目标区域。',
            lore: '碧婆婆收养小莫迪时她一无所知，龙蜥——根本都不是蜥蜴——和他们遥远的龙族表亲并非只是名字一样而已。',
            notes: ['可以通过停止、停在原位或使用其他技能来终止。', '最短飞行时间为{min_lob_travel_time}秒，最长飞行时间为{max_lob_travel_time}秒。'],
        },
        {
        ...
        },
        {
            ...
            notes: ['饼干的弹道速度为{projectile_speed}。'],
        },
        {
        ...
        },
        {
            ...
            name: '霹雳铁手',
            description:
                '电炎绝手开动蜥蜴坐骑上的加农炮，快速发动{buffed_attacks}次固定伤害加上自身攻击伤害一定百分比的攻击。每次攻击都将削弱敌人的护甲。在持续时间内提供攻击距离加成。',
            lore: '碧婆婆一直在修补她原来为秘密计划离开劫匪帮所设计的作品。',
            notes: ['持续时间内基础攻击间隔变为{base_attack_time}。', '霹雳铁手的攻击也有几率触发攻击特效。'],
        },
    ],
    TalentArray: [
        {
