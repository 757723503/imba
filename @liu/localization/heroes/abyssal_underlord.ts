...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            notes: ['被动会使攻击力降低光环失效，并且孽主无法获得新的叠加效果。'],
        },
        {
            ...
            name: '黑暗之门',
            description:
                '以友方单位或建筑作为目标地点打开黑暗的大门。经过短暂的延迟，孽主和附近所有友方英雄都将传送至目标地点。 黑暗之门在传送生效前可以取消。如果在技能生效前取消，或者目标单位死亡，黑暗之门都会进入冷却。',
        ...
        },
        {
            ...
            name: '恶魔之扉',
            description:
                '打开2个传送门，一个在孽主身旁，另一个在目标地点。英雄可以对一个传送门持续施法{warp_channel_duration}秒，传送至另一端。传送门之间的距离必须超过{minimum_distance}。<br><br>双击会传送至己方基地的泉水前。',
            lore: '他们的到来全无征兆，王国曾经繁荣的地方只剩下烈火和血海。',
        ...
        },
        {
            ...
            name: '深渊大军',
            description:
                "穿过恶魔之扉后，在恶魔之扉持续时间内每{underling_spawn_interval}秒孽主就会召唤一个战士或一个射手来援助他。<br><br><font color='#c04048'>战士</font>每次攻击都会燃烧魔法，并且对击杀它的单位造成魔法伤害。<font color='#c04048'>射手</font>拥有被动移速和攻速光环。",
            notes: [],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '恶魔之势 | 深渊大军',
            description: '孽主在拥有衰退光环的攻击力加成时攻击具有分裂效果。 恶魔之扉会定期召唤部下。',
            related_abilities: [
                {
                    ability_classname: 'imba_abyssal_underlord_atrophy_aura',
                    description: '孽主在拥有衰退光环的攻击力加成时攻击具有分裂效果。',
                },
                {
                    ability_classname: 'imba_abyssal_underlord_dark_portal',
                    description:
                        '孽主穿过恶魔之扉后会召唤不可控的恶魔战士和射手，攻击附近敌人。这些单位对建筑造成{underling_building_damage_reduction_tooltip}%伤害。',
                },
            ],
            related_talents: [],
        },
