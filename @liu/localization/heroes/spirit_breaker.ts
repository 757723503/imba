...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "out_of_world_time",
                    text: ""
                },
                {
                    ability_special: "guaranteed_bash_time",
                    text: ""
                },
                {
                    ability_special: "reveal_charge",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "min_movespeed_bonus_pct",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "damage_barrier",
                    text: ""
                }
            ],
            name: "威吓",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "bonus_movespeed_pct",
                    text: ""
                },
                {
                    ability_special: "movespeed_duration",
                    text: ""
                },
                {
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "威吓",
            description: "获得{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%移动速度加成和{MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING}%状态抗性。"
        },
        {
