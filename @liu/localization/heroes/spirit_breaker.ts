    ...
    AbilityArray: [
        {
            ...
            name: '暗影冲刺',
            description:
                '裂魂人盯紧一个敌方单位，开始无视一切物体的冲刺，起始为{min_movespeed_bonus_pct}%额外移速，{windup_time}秒后达到最大速度。<br><br>途中经过的所有敌方单位和目标单位都将受到巨力重击。如果目标单位在到达前死亡了，裂魂人将他的目标改为原路径上最近的一个敌方单位。',
            lore: '巴拉森带着一股狂蛮之力从黑暗中冲出。',
            shard_description: '暗影冲刺的移动速度加成提升{bonus_movement_speed}。',
            notes: ['裂魂人在冲刺过程中能穿过树木，悬崖和任何单位。', '冲刺指示特效仅对队友可见。', '裂魂人将获得并共享目标的视野。'],
        },
        {
        ...
        },
        {
            ...
            lore: '巴拉森幽灵般链球的标志性一击。',
            notes: ['不与碎颅锤叠加。', '破坏会使攻击触发巨力重击失效。暗影冲刺或幽冥一击还是会施加巨力重击。'],
        },
        {
