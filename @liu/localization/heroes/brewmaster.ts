...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '余烬佳酿',
            description:
                '使自身和一片区域被烈酒浸透，敌方单位移动变慢，受到魔法或纯粹伤害后还将被点燃。点燃时持续时间增加{extra_duration}秒。酒仙浸满佳酿后，他的醉拳拳法威力更大。造成或受到魔法伤害都会使酒仙的浸酒持续时间延长。',
            lore: '奥尤社解决所有问题的方法——再喝一轮！',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            name: '好战分子',
            description:
                '酒仙从元素分离中恢复或者复活后都会获得{damage_pct}%额外攻击力，分别持续{damage_duration_split}和{damage_duration_respawn}秒。',
            notes: [],
        },
        {
            ...
            shard_description: '提升元素分离的持续时间，并且可以提前结束。',
        ...
        },
        {
            ...
            name: '元素伙伴',
            description:
                '根据酒仙的当前醉拳拳法制造一个元素战士。<br><br>如果当前的元素战士受到来自敌方英雄或者英雄控制单位的伤害，{cooldown_on_take_damage}秒内无法召唤新的元素战士。如果元素战士阵亡，技能进入{cooldown_on_death}秒的冷却状态。<br><br>同一时间只能存在一个元素战士。如果酒仙使用元素分离，现有的元素战士将会消失。',
    ...
    FacetArray_B: [
        {
            ...
            name: '大放异桶 | 醉酒大师',
            description:
                '向敌人扔出一个酒桶，对他们造成伤害并施加余烬佳酿。 浸酒后酒仙会以持续变化的移动速度进行移动，持续时间内最慢为{s:bonus_min_movement}%，最快为{s:bonus_max_movement}。',
            related_abilities: [
                {
                    ability_classname: 'imba_brewmaster_cinder_brew',
                    description: '余烬佳酿现在是装满酒的滚动酒桶，会使路径上的敌人浸满酒，并且在终点爆炸。',
                },
            ],
            related_talents: [],
        },
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '醉酒云雾',
            description:
                '移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%并有{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%概率攻击不能命中。',
        },
        {
        ...
        },
        {
            ...
            name: '虚无打击',
            description: '受酒仙的攻击特效影响。',
        },
        {
            modifier_classname: 'modifier_imba_brewmaster_void_astral_pulse',
            name: '灵体脉冲',
            description: '被缴械，移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。',
        },
        {
