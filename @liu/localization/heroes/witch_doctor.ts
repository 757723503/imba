    ...
    AbilityArray: [
        {
            ...
            notes: ['目标可以受到多次作用，只要附近有其他单位可以进行弹跳。'],
        },
        {
            ...
            notes: ['治疗间隔为{heal_interval}秒。', '对减益免疫单位有效。', '巫毒咒法的伤害量等于治疗量。'],
        },
        {
            ...
            notes: ['受到作用的英雄如果在结算时当前血量高于原血量，则额外伤害为0。'],
        },
        {
            ...
            name: '死亡守卫',
            description:
                '持续施法 - 召唤一个死亡守卫，会优先攻击其攻击距离内的敌方英雄。最多持续{abilitychanneltime}秒。死亡守卫拥有{bonus_accuracy}%额外必中率。',
        ...
        },
        {
            ...
            name: '驱邪护符',
            description:
                '巫医获得了驱邪护符，这件物品无法丢弃或放在背包里。拥有者阵亡时，死亡损失金钱的{death_gold_lost_reduction_pct_tooltip}%会加入到该物品中，物品被消耗后将退回这些金钱。驱邪护符的价值每{gold_tick_interval_tooltip}秒会增加1金。<br><br>右键点击可以消耗这件物品，并将其永久移除。',
            notes: [],
        },
    ],
    TalentArray: [
