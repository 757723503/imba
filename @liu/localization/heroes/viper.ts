    ...
    AbilityArray: [
        {
            ...
            name: '毒性攻击',
            description:
                '蝮蛇的毒液得到强化，使他的普通攻击附带效果，可以降低目标的移动速度和魔法抗性，并持续造成伤害。效果可以叠加，最多叠加{max_stacks}次。',
        ...
        },
        {
            ...
            name: '幽冥剧毒',
            description:
                '蝮蛇向目标区域释放幽冥剧毒。范围内的单位持续受到伤害，在区域内停留的时间越长，受到的伤害也越高。同时他们的攻击速度会被降低。',
        ...
        },
        {
            ...
            name: '腐蚀皮肤',
            description:
                '蝮蛇分泌出感染性的毒素，{max_range}范围内任何伤害它的敌人都将受到伤害，同时攻击速度也被降低。这种酸性分泌物还能提高蝮蛇的魔法抗性。',
            lore: '对冥界亚龙出击后，手中的刀剑和盾牌会遭到腐蚀并不稀奇。',
            scepter_description: '腐蚀皮肤对冥界亚龙附近{effect_multiplier_distance}范围内敌人施加{effect_multiplier}倍攻击速度降低效果。',
            notes: ['与其他提升魔法抗性的物品和技能叠加。', '破坏会使腐蚀皮肤不再施加效果。极恶俯冲还是会施加腐蚀皮肤。'],
        },
        {
            ...
            name: '掠食',
            description:
                '冥界亚龙的攻击会根据目标英雄缺失的生命百分比额外造成一次物理伤害，每缺失1%{造成的伤害为}damage_base{ + }damage_per_level% * 冥界亚龙等级。',
            notes: [],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '毒爆 | 腐蚀之浴',
            description: '毒性攻击的叠加效果结束后，目标附近的敌人都会受到额外伤害。 冥界亚龙处于幽冥剧毒内时，腐蚀皮肤的效果会逐渐增强。',
            related_abilities: [
                {
                    ability_classname: 'imba_viper_poison_attack',
                    description:
                        '毒性攻击的叠加效果结束后，目标附近的敌人都会受到额外伤害，数值为毒性攻击造成魔法伤害的{accumulated_damage_explosion_pct}%。',
                },
                {
                    ability_classname: 'imba_viper_corrosive_skin',
                    description: '冥界亚龙处于幽冥剧毒内时，腐蚀皮肤的效果会逐渐增强。',
                },
            ],
            related_talents: [],
        },
    ...
    ModifierArray: [
        {
            ...
            name: '毒性攻击减速',
            description:
                '移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，魔法抗性降低{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。持续受到伤害。',
        },
        {
        ...
        },
        {
            ...
            name: '蝮蛇突袭减速',
            description:
                '被动技能被禁用。移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，攻击速度降低{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}。',
        },
        {
