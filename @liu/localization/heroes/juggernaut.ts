...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '剑刃风暴',
            description:
                '舞起具有破坏性力量的剑刃风暴，使主宰获得减益免疫状态，魔法抗性提升80%{，并且对主宰周围的敌方单位造成伤害。主宰造成伤害的间隔为自身攻击速度的}blade_fury_aspd_multiplier%倍。旋转结束时施加强驱散效果。',
        ...
        },
        {
            ...
            name: '治疗守卫',
            description:
                '召唤一个治疗守卫，按周围友军单位最大生命值的一定比例治疗他们。治疗守卫可以移动，移动速度为{healing_ward_movespeed_tooltip}。持续{abilityduration}秒。',
            lore: '在遮面之岛习得的仪式之一，治疗伤口时加上一点巫毒法术往往会很有效。',
            notes: ['可以控制治疗守卫。', '多个治疗守卫的效果不会叠加。'],
        },
        {
            ...
            name: '无敌斩',
            description:
                '主宰挥剑跃向敌方目标单位，随后再以更短的攻击频率斩击该单位和附近的其它敌方单位。主宰在无敌斩期间无敌。\\n\\n驱散类型：弱驱散',
            lore: '“自律已有成果；勤练带来力量。”',
            notes: ['无敌斩期间可以使用物品。'],
        },
        {
        ...
        },
        {
            ...
            notes: [
                '主宰未受到伤害时每{stack_gain_time}秒获得一层剑心的叠加层数。每层叠加效果提供{agi_bonus_pct_per_stack}%基础敏捷加成和{agi_bonus_pct_per_stack}%移动速度。最高为{max_stacks}层叠加。叠加效果在受到任何伤害时会粘滞{linge_duration}秒后再消失。',
                '破坏会使技能无法获得新的叠加效果。',
                '破坏不会使现有叠加效果提供的加成失效。',
            ],
        },
    ...
    FacetArray_B: [
        {
            ...
            name: '刀剑风暴',
            description: '剑刃风暴现在可以根据剑舞等级触发致命一击.',
            related_abilities: [
                {
                    ability_classname: 'imba_juggernaut_blade_fury',
                    description: '剑刃风暴现在可以根据剑舞的等级触发致命一击。',
                },
            ],
            related_talents: [],
        },
