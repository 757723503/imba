...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '海妖之歌',
            description:
                '娜迦海妖周围的所有敌人受到魔法影响陷入停滞状态，既无法行动也不会受到攻击。范围内友军每秒恢复一定百分比的生命值。再次使用海妖之歌可以提前停止效果。',
        ...
        },
        {
            ...
            name: '捕捞',
            description:
                '持续施法 - 娜迦海妖最多持续施法{AbilityChannelTime}秒，以{pull_strength}的速度将{radius}范围内所有处于娜迦海妖诱捕作用下的单位朝她拉去。诱捕单位相距{min_pull_distance}时持续施法结束。',
    ...
    FacetArray_B: [
        {
            ...
            name: '洪水 | 激流',
            description:
                '娜迦海妖可以在自身和她的幻象周围制造水花，对敌人造成伤害并降低他们的状态抗性。 娜迦海妖和她的幻象每攻击6次，周围的敌人就会受到伤害，并且护甲被降低。',
            related_abilities: [],
            related_talents: [
                {
                    talent_key: 'special_bonus_unique_naga_siren_2_facet_naga_siren_active_riptide',
                    description: '+{s:bonus_damage}% 洪水伤害',
                },
            ],
        },
    ],
