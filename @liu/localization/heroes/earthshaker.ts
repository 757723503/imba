    ...
    AbilityArray: [
        {
            ...
            notes: ['小兵将会等待沟壑消失，不会去尝试绕开它。', '沟壑不会被林肯法球抵挡。'],
        },
        {
            ...
            lore: '瑞格勇猛的的蛮力能摧毁山脉。',
            scepter_description:
                '强化图腾可以对地施放，施放后会跳至半空中再降落至目标地点，在目标地点施放强化图腾。双击技能会按原技能施放，不会跳跃。强化图腾拥有分裂效果。',
            notes: ['攻击力加成是基于基础攻击力和主属性数值。'],
        },
        {
        ...
        },
        {
            ...
            name: '灵魂石冢',
            description:
                '撼地者死亡时会在他阵亡的地点产生一道{fissure_radius}范围的沟壑。这道沟壑会阻碍移动，并且使撼地者持续获得周围的经验。沟壑会一直持续到撼地者复活。',
            notes: [],
        },
    ],
    TalentArray: [
    ...
    FacetArray_B: [
        {
            ...
            name: '地壳积累 | 强击图腾',
            description:
                '利用强化图腾的攻击或撼地者的其他技能击杀敌人后都会把尸体击飞，对击中的敌人造成伤害。 英雄每升{s:bonus_aftershock_range_level_interval}级，余震的作用范围提升{s:bonus_aftershock_range_increase_per_level_interval}。',
            related_abilities: [
                {
                    ability_classname: 'imba_earthshaker_enchant_totem',
