    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                {
                    ability_special: "placement_range",
                    text: ""
                },
                {
                    ability_special: "placement_count",
                    text: ""
                },
                {
                    ability_special: "placement_duration",
                    text: ""
                },
                {
                    ability_special: "extra_brambles_placement_duration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "latch_creation_interval",
                    text: ""
                },
                {
                    ability_special: "latch_creation_delay",
                    text: ""
                },
                {
                    ability_special: "initial_creation_delay",
                    text: ""
                },
                {
            ...
            name: "荆棘迷宫",
            description: "{initial_creation_delay}秒后邪影芳灵在目标区域创造出{placement_range}范围的迷宫，迷宫拥有{placement_count}棵荆棘。进入荆棘的敌人将被缠绕，并且持续受到伤害。迷宫持续{placement_duration}秒。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "unit_targetable",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "destination_travel_speed",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "return_travel_speed",
                    text: ""
                },
                {
                    ability_special: "starting_height",
                    text: ""
                },
                {
                    ability_special: "telegraph_to_enemies",
                    text: ""
                },
                {
            ...
            name: "恐吓",
            description: "邪影芳灵放出她的精灵宠物恐吓她的敌人。经过一定延迟后，目标区域内所有敌人变得害怕，朝自己的泉水狂奔。作祟开启期间不能使用恐吓。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "max_damage_duration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "aura_linger",
                    text: ""
                },
                {
                    ability_special: "aura_damage_pct",
                    text: ""
                }
            ],
            name: "暗影之境",
            description: "邪影芳灵遁入暗影之境，无法成为攻击或技能的目标。她的下次攻击具有{attack_range_bonus}额外攻击距离，并且造成额外魔法伤害，暗影之境技能也会随之结束。在暗影中时间越长，伤害越高。在暗影之境内的时间超过{max_damage_duration}秒将达到最高伤害。",
            lore: "你看不见的东西肯定会害你。",
            scepter_description: "发动普通攻击不再使邪影芳灵脱离暗影之境。持续时间内每次攻击都带有额外伤害。",
            notes: [
                "施法时能躲避弹道。",
                "获得相位移动状态。",
                "需要视野的技能无法作用于暗影之境中的邪影芳灵。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "shard_delay_reduction",
                    text: ""
                },
                {
                    ability_special: "shard_bramble_amount",
                    text: ""
                },
                {
                    ability_special: "shard_spawn_radius",
                    text: ""
                }
            ],
            name: "诅咒王冠",
            ...
            shard_description: "诅咒王冠在倒计时结束时会围绕目标在{shard_spawn_radius}范围内产生{shard_bramble_amount}朵荆棘。即使效果被驱散也会触发。眩晕延迟降低{shard_delay_reduction}秒。",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "mana_regen_amp",
                    text: ""
                }
            ],
            name: "仙灵粉尘",
            description: "每当有技能让邪影芳灵无法成为目标，她就会在该状态下获得{hp_regen}{生命恢复和{mana_regen_amp}}魔法恢复。",
            lore: "",
            notes: []
        }
    ],
