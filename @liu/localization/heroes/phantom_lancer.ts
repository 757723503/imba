    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "fake_lance_distance",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "scepter_total_hits",
                    text: ""
                }
            ],
            name: "灵魂之矛",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "illusion_1_damage_out_pct",
                    text: ""
                },
                {
                    ability_special: "illusion_1_damage_in_pct",
                    text: ""
                },
                {
                    ability_special: "illusion_2_damage_out_pct",
                    text: ""
                },
                {
                    ability_special: "illusion_2_damage_in_pct",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "illusion_2_amount",
                    text: ""
                },
                {
                    ability_special: "hp_missing_per_extra_illusion_pct",
                    text: ""
                }
            ],
            name: "神行百变",
            description: "幻影长矛手暂时从战场上消失。经过{delay}秒，幻影长矛手和附近的所有幻象都会出现在目标地点的随机位置，并产生两个新的幻象。施放技能后延长所有幻象的持续时间。新加的两个幻象拥有不同的特性：一个承受正常百分比的伤害，不具有攻击力，另一个额外承受{illusion_2_damage_in_pct}{伤害，继承的攻击力相比本体减少{illusion_2_damage_out_pct}}。\\n\\n驱散类型：弱驱散",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "illusion_from_illusion_duration",
                    text: ""
                },
                {
                    ability_special: "shard_bonus_illusions",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "invis_movespeed",
                    text: ""
                },
                {
                    ability_special: "uncontrollable_illusions",
                    text: ""
                },
                {
