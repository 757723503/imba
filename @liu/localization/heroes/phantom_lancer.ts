...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '神行百变',
            description:
                '幻影长矛手暂时从战场上消失。经过{delay}秒，幻影长矛手和附近的所有幻象都会出现在目标地点的随机位置，并产生两个新的幻象。施放技能后延长所有幻象的持续时间。新加的两个幻象拥有不同的特性：一个承受正常百分比的伤害，不具有攻击力，另一个额外承受{illusion_2_damage_in_pct}%伤害，继承的攻击力相比本体减少{illusion_2_damage_in_pct}%。\\n\\n驱散类型：弱驱散',
        ...
        },
        {
            ...
            name: '并列',
            description:
                '幻影长矛手的攻击有一定几率使自己的存在破碎，产生自身的幻象。幻象也有几率进一步破碎，再产生幻象。幻影长矛手产生的幻象持续{illusion_duration}秒，幻象产生的幻象则持续{illusion_from_illusion_duration}秒。',
            lore: '阿兹瑞斯的每次刺击感觉就像一个普通战士的两次，或三次，或四次……',
            shard_description:
                '并列增加主动技能。使幻影长矛手进入隐身，最多持续{invis_duration}秒，同时产生一个复制幻象来迷惑敌人。隐身期间自身移动速度提升{invis_movespeed}%。',
            notes: [],
        },
        {
            ...
            notes: ['如果冲锋中途取消攻击指令，那么移动速度加成就会消失。', '冲锋过程中移动速度为{bonus_speed}。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '汇聚 | 离散',
            description:
                '神行百变会产生额外幻象，数量取决于幻影长矛手的当前生命值。 并列的幻象会在附近随机单位身旁产生，继承更高的攻击力，但是无法控制。',
            related_abilities: [
                {
                    ability_classname: 'imba_phantom_lancer_doppelwalk',
