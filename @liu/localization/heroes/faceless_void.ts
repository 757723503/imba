    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "dodge_chance_pct",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "attack_projectile_slow",
                    text: ""
                },
                {
                    ability_special: "slow_distance_max",
                    text: ""
                }
            ],
            name: "扭曲力场",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "duration_creep",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            name: "时间膨胀",
            description: "虚空假面将附近所有敌人困在一个时间膨胀场中，持续{duration}秒，技能的冷却将会延长，每延长一个技能的冷却，敌人的移动和攻击速度就会降低{slow}%。根据冷却中技能的数量造成每秒额外伤害。负面状态的持续时间在时间结界内不会变少。",
            lore: "",
            notes: [
                "不会影响物品的冷却时间。"
            ]
        },
        {
            ...
            name: "时间结界",
            description: "在时空中创造一个泡状遮罩，将所有位于其中的单位定住，并使虚空假面在其内部来去自如。所有技能和物品冷却全部冻结。只有虚空假面和他控制的单位不受影响。在其中的隐形敌人会显形。",
        ...
        },
        {
            ...
            name: "逆转时空",
            description: "在时空中创造一个遮罩，改变其中所有单位的移动、攻击、施法、弹道和转身速度。友军的速度提升，敌人的速度降低。<br><br>敌人在逆转时空内为束缚状态。",
            lore: "",
            notes: []
        }
    ],
