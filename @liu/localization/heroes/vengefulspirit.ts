...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                {
                    ability_special: "magic_missile_speed",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "bounce_range_pct",
                    text: ""
                },
                {
                    ability_special: "damage_per_lasthit",
                    text: ""
                }
            ],
            name: "魔法箭",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "scepter_illusion_damage_out_pct",
                    text: ""
                },
                {
                    ability_special: "scepter_illusion_damage_in_pct",
                    text: ""
                },
                {
                    ability_special: "scepter_illusion_ms_bonus_pct",
                    text: ""
                }
            ],
            name: "复仇光环",
    ...
    ModifierArray: [
        ...
        {
            modifier_classname: "modifier_imba_vengefulspirit_wave_of_terror_fear_description",
            name: "被复仇之魂恐惧"
        },
        {
