...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            scepter_description:
                '死亡时产生一个复仇之魂的强幻象，继承全额攻击力，承受100%%伤害，可以施放自己的所有技能。复仇之魂复活时若幻象依然存在，则自身会直接将其取代。幻象获得的经验将给予英雄。强幻象不会被相关技能秒杀。',
            notes: ['破坏会使攻击力光环失效。'],
        },
        {
        ...
        },
        {
            ...
            name: '移形换位',
            description:
                '与一个目标英雄瞬间交换位置，不论敌我。移形换位会打断目标的持续施法。敌方英雄被交换后受到伤害。复仇之魂和被交换的友方英雄都会获得等同于造成伤害的护盾。',
            lore: '牺牲只是为了复仇付出的小小代价。',
            notes: ['对减益免疫单位有效。', '技能施放后复仇之魂和目标附近的树木将会被摧毁。', '移形换位能够打断持续施法。'],
        },
        {
