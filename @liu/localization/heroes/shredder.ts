...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '死亡旋风',
            description:
                '伐木机使极其锋利的刀刃飞旋，对敌人造成伤害并摧毁他周围的树木。如果敌方英雄受到了作用，他的主属性将在短时间内降低少许。如果该技能施放过程中砍倒了树木则会根据砍倒的数量造成额外伤害。',
        ...
        },
        {
            ...
            scepter_description:
                '活性护甲可以主动施放，获得最大叠加次数和{initial_shield}点生命的护盾。护盾的恢复速度为每秒{shield_per_sec} + 伐木机{radius}范围内每名敌方英雄都会增加{shield_per_sec_per_enemy}，最高为{max_shield}。{duration}秒后伐木机会对{explosion_radius}范围内每个英雄造成伤害，数值为{base_explosion} + 护盾剩余生命，而且失去全部护盾。',
        ...
        },
        {
            ...
            name: '锯齿飞轮',
            description:
                '伐木机将主锯刃射向目标区域，锯刃会高速旋转，对周围的敌方单位造成伤害。在锯刃作用范围内的敌方单位每损失最大生命值的{slow_health_percentage}%，他们的移动速度都会进一步被降低。锯刃在发射和收回的过程中都将造成伤害并砍倒碰到的树木。在发射锯刃后伐木机将无法攻击，同时会持续消耗魔法。',
            lore: '消灭植物的终极武器。',
            scepter_description: '提升锯齿飞轮和锯齿飞轮（二）的每秒伤害。',
            notes: ['如果伐木机魔法不足或移动超过{break_distance}距离，锯齿飞轮将会飞回。'],
        },
        {
            ...
            lore: '我砍砍砍砍砍砍砍砍砍！',
            notes: ['如果伐木机魔法不足或移动超过{break_distance}距离，锯齿飞轮将会飞回。', '两个锯齿飞轮的减速效果不会叠加。'],
        },
        {
        ...
        },
        {
            ...
            name: '锯齿轮旋',
            description:
                '发射第二个独立的锯齿飞轮，会沿着一道弧线飞出再返回至伐木机，对经过的敌人造成伤害和减速。在锯刃作用范围内的敌方单位每损失最大生命值的{slow_health_percentage}%，他们的移动速度都会进一步被减缓。',
            notes: [],
        },
        {
            ...
            related_abilities: [
                {
                    ability_classname: 'imba_shredder_timber_chain',
                    description:
                        '伐木机与目标树木相撞时，树木会破碎，向四面八方放出{tree_splinter_count}片碎木，最远为{tree_splinter_distance}距离。如果碎木击中了敌人，将会造成伤害和短时间的减速。',
                },
            ],
            related_talents: [],
        },
