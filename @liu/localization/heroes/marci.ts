    ...
    AbilityArray: [
        {
            ...
            name: '过肩摔',
            description:
                '玛西抓起一个友方或敌方目标，将其轻松地向她身后摔去，敌方目标将受到伤害并被减速。落地区域内所有敌方单位也会受到伤害并被减速。',
        ...
        },
        {
            ...
            name: '怒拳破',
            description:
                '玛西释放潜藏的力量，获得狂怒的猛攻效果，使自身可以发动快速的打击，并且降低打击目标的移动和攻击速度，持续{pulse_debuff_duration}秒。每次狂怒连技的最后一击都会创造一个脉冲效果，对目标周围的敌人造成伤害。在狂怒连技的间隔，玛西无法攻击，持续{time_between_flurries}秒。\\n\\n玛西施放怒拳破时移动速度提升{bonus_movespeed}%。',
            lore: '虽然有不少人在探究玛西神力的源头，但玛西对他们全不理睬。',
            scepter_description:
                '怒拳破的冷却时间减少{scepter_cooldown_reduction}秒，并且施放时对玛西施加弱驱散。怒拳破生效期间，玛西的所有技能在施放时都会施放脉冲。玛西的所有怒拳破脉冲都会沉默敌人，持续{pulse_silence_duration}秒。<br><br>驱散类型：弱驱散',
            notes: ['每次狂怒连技开始后，每次攻击都必须在1秒内完成，否则连技将会终止。', '移除攻击速度限制。'],
        },
        {
        ...
        },
        {
            ...
            name: '健体术',
            description:
                '玛西的忠诚保证了她的安全，为选定的友方英雄和她自身注入了共享吸血效果和攻击力加成。如果玛西和她的友军相距超过{max_partner_distance}后友军不会获得加成效果，而玛西只会获得{max_partner_penalty}%效果，直到他们再次靠近彼此。玛西的吸血效果还会治疗友军，而友军的吸血效果也会治疗玛西。',
            lore: '玛西小时候就已经懂得，乱世之中最好的财富是可靠的伙伴。',
            notes: ['玛西无法对自身施放健体术。', '吸血效果对非英雄单位减少{creep_lifesteal_reduction_pct}%。'],
        },
        {
            ...
            name: '护卫术',
            description:
                '玛西保护一个友方英雄。在{bodyguard_duration}秒内，每当该友军攻击敌人或者被攻击，只要目标在玛西的攻击距离 + {bodyguard_attack_range_buffer}范围内，玛西就会作出反击。友军在持续时间内还会获得额外护甲，以及玛西的吸血带来的治疗效果。被动使玛西获得吸血和攻击力加成。',
            notes: [
                '玛西无法对自身施放护卫术。',
    ...
    FacetArray_B: [
        {
            ...
            name: '健体术 | 护卫术',
            description:
                '玛西可以保护一名友军，使他们获得共享吸血和攻击力。她靠近友军时效果更强。 玛西可以保护一名友军，她在敌人范围内时会在友军受到攻击后作出反击。',
            related_abilities: [
                {
                    ability_classname: 'imba_marci_guardian',
