...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '衰老',
            description:
                '一个强大的驱逐咒语，能使一个单位无法攻击/受到攻击。受作用的友军提升了治疗效果，而受作用的敌军会被减速，并且承受额外魔法伤害。',
            lore: '作为童年时期遗留下来的癖好，现在帕格纳精通于把人放逐到幽冥之境，而不管那人是善还是恶，或者仅仅是他的一时兴起。',
            notes: ['只有魔法伤害和纯粹伤害可以作用于处于衰老状态的单位。', '不会对友方单位造成减速。', '可以对幽冥守卫施放。'],
        },
        {
            ...
            name: '幽冥守卫',
            description:
                '帕格纳在目标地点放置一个幽冥守卫。守卫将对任何施法的敌方英雄发射魔力闪光。幽冥守卫造成的伤害为基础伤害加上敌方英雄施法时消耗魔法值的数倍。',
        ...
        },
        {
            ...
            name: '生命汲取',
            description:
                '持续施法 - 使用生命汲取时，帕格纳吸取目标敌方单位的生命值，并获得其视野。如果生命值已满，而且目标是名英雄，那将开始回复魔法值。\\n\\n向队友施放可以将自己的生命值转移给队友。',
            lore: '帕格纳的力量甚至已经超越湮灭术前任的上师。',
            shard_description:
                '生命汲取可以对幽冥守卫施放，使生命汲取可以折射至守卫附近{abilitycastrange}范围内所有敌方英雄，造成{shard_damage_pct_from_ward}%效果。守卫被摧毁后效果将会中断。',
            scepter_description:
                '冷却时间减少{abilitycooldown}秒。以敌方英雄为目标时，帕格纳每秒降低他们{spell_amp_drain_rate}%技能伤害输出，最高可达到{spell_amp_drain_rate}%，并且自身的技能伤害输出提升，最高可达到{spell_amp_drain_rate}%。魔晶升级下对幽冥守卫施放时降低和提升的速率为{spell_amp_drain_rate}%。负面效果持续{spell_amp_drain_duration}秒。',
            notes: ['幻象在受到第一下伤害后就会被摧毁。'],
        },
        {
            ...
            notes: ['包括需要持续施法的物品。', '同一时间还是只能持续施法一个技能。'],
        },
    ],
    TalentArray: [
        {
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '衰老',
            description:
                '提升{MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_TARGET}%治疗效果，或者移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，并且受到的魔法伤害加深{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。',
        },
        {
