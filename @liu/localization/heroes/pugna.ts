...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "structure_damage_mod",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "bonus_movement_speed_allies",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "spell_damage_reduction",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "nether_ward_gold_bounty",
                    text: ""
                },
                {
                    ability_special: "self_restoration_range",
                    text: ""
                }
            ],
            name: "幽冥守卫",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "health_drain_death_boost",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "health_to_mana_rate",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "drain_buffer",
                    text: ""
                },
                {
                    ability_special: "shard_damage_pct_from_ward",
                    text: ""
                },
                {
                    ability_special: "bonus_heal_pct",
                    text: ""
                },
                {
                    ability_special: "spell_amp_drain_rate",
                    text: ""
                },
                {
                    ability_special: "spell_amp_drain_max",
                    text: ""
                },
                {
                    ability_special: "spell_amp_drain_rate_ward",
                    text: ""
                },
                {
                    ability_special: "spell_amp_drain_duration",
                    text: ""
                },
                {
                    ability_special: "max_spell_amp_drain_pct",
                    text: ""
                },
                {
                    ability_special: "AbilityCooldown",
            ...
            scepter_description: "冷却时间减少{abilitycooldown}秒。以敌方英雄为目标时，帕格纳每秒降低他们{spell_amp_drain_rate}{技能伤害输出，最高可达到{spell_amp_drain_max}}，并且自身的技能伤害输出提升，最高可达到{max_spell_amp_drain_pct}{。魔晶升级下对幽冥守卫施放时降低和提升的速率为{spell_amp_drain_rate_ward}}。负面效果持续{spell_amp_drain_duration}秒。",
            notes: [
                "幻象在受到第一下伤害后就会被摧毁。"
            ]
        },
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "衰老",
            description: "提升{MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_TARGET}%治疗效果，或者移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，并且受到的魔法伤害加深{MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DECREPIFY_UNIQUE}%。"
        },
        {
