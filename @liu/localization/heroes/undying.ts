    ...
    AbilityArray: [
        {
            ...
            name: '腐朽',
            description:
                '不朽尸王偷取区域内所有敌方英雄的力量，造成基础伤害并将敌人的力量据为己有。对非英雄单位造成{creep_damage_multiplier}倍伤害。',
            lore: '生者的力量只不过是借用自死者。',
            scepter_description: '提升力量窃取。',
            notes: ['窃据的力量可以叠加，但是敌方英雄的力量至少为1点。', '力量的窃取先于技能造成的伤害。', '可以作用隐形单位。'],
        },
        {
        ...
        },
        {
            ...
            shard_description:
                '墓碑可以对友方英雄施放，让他们躲进墓碑。进入墓碑的英雄{tombstone_bunker_cd}秒内无法离开，离开后同样的时间内无法再次进入。如果英雄在内时墓碑被摧毁，该英雄会被眩晕{tombstone_stun_penalty}秒。',
            notes: ['墓碑免疫技能，但是可以被噬魂治疗。', '僵尸和墓碑均免疫技能。', '如果初始目标死亡或丢失视野，僵尸将会死亡。'],
        },
        {
