...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            notes: ['立即摧毁幻象。', '目标的基础移动速度为{movespeed}，但是如果目标有满速状态则移速不受影响。'],
        },
        {
            ...
            shard_description:
                '枷锁会产生{shard_ward_count}个群蛇守卫对目标进行攻击。枷锁的施法距离提升{shard_bonus_cast_range}。枷锁结束后群蛇守卫还会持续{ward_linger_duration}秒。',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            name: '禽戏',
            description:
                '受到致死伤害时，暗影萨满会获得强驱散效果，并且以1点生命的小鸡继续存活。受到的伤害将降为零，持续{damage_reduction_duration}秒。<br/><br/>冷却时间会在复活时重置。\\n\\n驱散类型：强驱散',
            notes: ['无法阻止斧王的淘汰之刃和瘟疫法师的死神镰刀的致死伤害。', '受到的伤害减免效果会阻止生命移除类效果杀死暗影萨满。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '巨蛇守卫 | 咕咕鸡群',
            description:
                '召唤一个巨大的毒蛇守卫，攻击力和击杀金钱为{s:bonus_mega_ward_multiplier_tooltip}倍，生命值为{s:bonus_mega_ward_health_tooltip}倍。 妖术可以把友军变成一群鸡，移除其他负面效果。',
            related_abilities: [
                {
                    ability_classname: 'imba_shadow_shaman_voodoo',
                    description:
                        '可以对友军施放，施加弱驱散，并使他们在{ally_invuln_duration}秒内处于无敌状态，然后变成小鸡。会额外产生不可控制的小鸡幻象。',
                },
                {
                    ability_classname: 'imba_shadow_shaman_mass_serpent_ward',
                    description:
                        '召唤一个巨大的毒蛇守卫，攻击力和击杀金钱为{bonus_mega_ward_multiplier_tooltip}倍，生命值为{mega_ward_health_tooltip}倍。',
                },
                {
                    ability_classname: 'imba_shadow_shaman_fowl_play',
