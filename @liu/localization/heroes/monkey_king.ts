    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "soldier_spawn_duration",
                    text: ""
                },
                {
                    ability_special: "acceleration_z",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "max_horizontal_acceleration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "spring_channel_pct",
                    text: ""
                }
            ],
            name: "棒击大地",
            description: "齐天大圣让金箍棒变大，并将其挥起猛击地面，眩晕一条直线上的敌人并造成额外伤害和基于他普通攻击的致命一击伤害。具有克敌机先效果。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "invul_duration",
                    text: ""
                }
            ],
            name: "七十二变",
            description: "齐天大圣以周遭事物为启发进行伪装，改变自己的外形，从而欺骗对手。受到伤害，发动攻击或使用任意物品都会失去伪装效果。变化后{invul_duration}秒内免疫伤害。",
            lore: "要小心那棵树。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "spring_leap_speed",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "ground_jump_distance",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "perched_day_vision",
                    text: ""
                },
                {
                    ability_special: "perched_night_vision",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "unperched_stunned_duration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "impact_damage_tooltip",
                    text: ""
                },
                {
                    ability_special: "impact_movement_slow_tooltip",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "no_cooldown_hp_threshold",
                    text: ""
                }
            ],
            name: "丛林之舞",
            description: "齐天大圣跳上一棵树并停在上面。停留时获得乾坤之跃技能——需要持续施法的跳跃式攻击。如果树木被摧毁，他将从树上掉下，并眩晕4秒。在地面受到伤害时丛林之舞将在一定时间内无法使用，处于冷却状态。",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "first_radius",
                    text: ""
                },
                {
                    ability_special: "second_radius",
                    text: ""
                },
                {
                    ability_special: "num_first_soldiers",
                    text: ""
                },
                {
                    ability_special: "num_second_soldiers",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "leadership_time_buffer",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "outer_attack_buffer",
                    text: ""
                },
                {
            ...
            name: "猴子猴孙",
            description: "齐天大圣变出圆形的猴子猴孙阵列，猴子猴孙从他的位置散开。若齐天大圣离开范围，猴子猴孙将会消失。猴子猴孙继承齐天大圣的攻击力并且只会以英雄为目标。在技能持续时间内齐天大圣获得护甲加成。",
            lore: "齐天大圣将一簇猴毛吹向敌人，每根毛都变成了自己的复制体。",
            scepter_description: "每隔一段时间在齐天大圣附近产生一个猴子猴孙。隐身或上树时不会产生。只有齐天大圣在附近时猴子猴孙才会攻击建筑。猴子猴孙现在独立获得如意棒法的效果。",
            notes: [
                "猴子猴孙不会获得如意棒法的加成效果。",
                "猴子猴孙不会继承碎颅锤和深渊之刃的效果。"
            ]
