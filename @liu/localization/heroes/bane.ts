...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            shard_description:
                '减少{bonus_AbilityCooldown}秒冷却时间。蚀脑变成{shard_radius}作用范围的技能。次级目标只有{shard_secondary_target_heal_pct}%治疗效果。',
            notes: [],
        },
        {
            ...
            name: '魔爪',
            description:
                '持续施法 - 抓住一个敌方单位，使其失去行动能力并持续受到大量伤害，同时每{fiend_grip_tick_interval}秒按目标最大魔法值一定比例吸取魔法。',
            lore: '阿特洛波斯的受害者经常因为噩梦中逼真的幻象痛不欲生。',
            scepter_description:
                '魔爪的冷却时间减少{bonus_AbilityCooldown}秒。魔爪将产生两个不可控制的幻象，幻象也将对目标持续施放魔爪。幻象承受{scepter_incoming_illusion_damage}%伤害，并且被打断后立刻消失。伤害不会叠加。',
            notes: [],
        },
        {
            ...
            name: '噩梦',
            description:
                '让目标敌方或友方英雄进入沉睡。睡着的单位受到攻击便会醒来，但噩梦将转移到攻击者身上。祸乱之源可以随意攻击噩梦中的目标并造成伤害。',
    ...
    FacetArray_B: [
        {
            ...
            name: '梦中潜行者 | 梦游',
            description: '祸乱之源在攻击噩梦中单位时获得额外的攻击速度。 噩梦中单位会朝选定方向走去。',
            related_abilities: [
                {
                    ability_classname: 'imba_bane_nightmare',
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '虚弱',
            description:
                '攻击力降低{MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE}%，施法距离减少{MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE}%，并且持续受到纯粹伤害。',
        },
        {
