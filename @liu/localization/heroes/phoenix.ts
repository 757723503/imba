    ...
    AbilityArray: [
        {
            ...
            name: '凤凰冲击',
            description:
                '凤凰向目标方向进行圆弧状飞行，飞行距离固定，对沿途的敌人造成持续伤害并减缓其移动速度，然后返回初始位置。飞行过程中如果施放超新星将停止飞行。',
            lore: '尽管没少在宇宙虚空之间遨游，但在大气里振翅高飞还是有不同的快感。',
            notes: ['凤凰冲击的飞行时间为{dive_duration}秒，可以在飞行途中再次施放来终止飞行。'],
        },
        {
        ...
        },
        {
            ...
            name: '烈日炙烤',
            description:
                '凤凰以损失生命能量为代价，向前射出一束炽热的光线炙烤敌人。光线对敌人造成伤害，并且能治疗友军，伤害和治疗的数值均为基础数值加上目标生命值的一定百分比。随着光线不断炙烤，百分比也会不断增加。',
        ...
        },
        {
            ...
            name: '超新星',
            description:
                '凤凰十分乐意终结自己现在的生命来换取重生。将自己变为一颗燃烧的恒星，灼烧附近一大片区域内的敌人。恒星受到敌方英雄一定次数的攻击后将会被摧毁。经过{abilityduration}秒后恒星将会爆炸，眩晕周围所有敌人。而凤凰的生命和魔法值都会回到满状态，并且所有技能的冷却时间都会刷新。\\n\\n驱散类型：强驱散',
    ...
    FacetArray_B: [
        {
            ...
            name: '热点',
            description: '烈日炙烤的光束尖端造成更多伤害。',
            related_abilities: [
                {
                    ability_classname: 'imba_phoenix_sun_ray',
                    description:
                        '烈日炙烤的光束末端对目标造成的伤害/治疗增加。光束强度从光束的后半段开始增加，在{focal_point_full_length_tooltip_only}距离达到最高的{focal_point_max_multiplier}%基础伤害/治疗。如果使烈日炙烤的光束距离增加，在{focal_point_full_length_tooltip_only}距离之外的伤害和治疗量会超过{focal_point_max_multiplier}%。',
                },
            ],
            related_talents: [],
        },
