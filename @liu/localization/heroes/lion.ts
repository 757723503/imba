    ...
    AbilityArray: [
        {
            ...
            notes: ['尖刺的移动速度是每秒{speed}码。', '不会触发法术抵抗或法术反弹。'],
        },
        {
            ...
            notes: ['即刻摧毁幻象。', '目标的基础移动速度为{movespeed}，但是如果目标有满速状态则移速不受影响。'],
        },
        {
            ...
            name: '法力吸取',
            description:
                '持续施法 - 引导魔法能量，持续吸取魔法并减缓敌人的移动速度。如果敌人没有魔法剩余，减速效果提升{movespeed_bonus_when_empty_pct}%。<br><br>可以对友军施放，给予他们{movespeed_bonus_when_empty_pct}%魔法和移动速度。',
            lore: '对恶魔巫师来说，较为弱小的法师只不过是他回复魔力的来源。',
            shard_description:
                '法力吸取可以作用最多{shard_bonus_targets}个额外敌人，并且断裂距离增加。持续施法期间莱恩为减益免疫状态，并且获得{magic_resist}%魔法抗性。',
            notes: ['立刻摧毁幻象，并阻止英雄进入隐身状态。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '死亡之拳 | 吞食精华',
            description:
                '莱恩施放死亡之指后获得拥有分裂效果的强力近战攻击。 法力吸取的每秒魔法吸取量提升，并且会造成{s:bonus_damage_pct}%吸魔量的伤害。',
            related_abilities: [
                {
                    ability_classname: 'imba_lion_mana_drain',
                ...
                },
                {
                    ability_classname: 'imba_lion_finger_of_death',
                    description:
                        '施放死亡之指后，莱恩从远程变为近战攻击，获得攻击力加成和分裂效果。被击中的敌方英雄在{punch_grace_period}秒内阵亡后也会增加死亡之指的叠加效果。',
                },
            ],
            related_talents: [],
        },
