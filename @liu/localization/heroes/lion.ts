...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "movespeed_bonus_when_empty_pct",
                    text: ""
                },
                {
                    ability_special: "shard_bonus_targets",
                    text: ""
                },
                {
            ...
            name: "法力吸取",
            description: "持续施法 - 引导魔法能量，持续吸取魔法并减缓敌人的移动速度。如果敌人没有魔法剩余，减速效果提升{movespeed_bonus_when_empty_pct}{。<br><br>可以对友军施放，给予他们{ally_pct}}魔法和移动速度。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "punch_attack_range",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "punch_grace_period",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            name: "下地狱再上来",
            description: "莱恩在复活后{duration}秒内获得{debuff_amp}{负面效果时间和{spell_amp}}技能伤害增强。",
            lore: "",
            notes: []
        }
    ],
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "地狱回来",
            description: "获得{MODIFIER_PROPERTY_STATUS_RESISTANCE_CASTER}%负面效果时间和{MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE}%技能伤害增强。"
        }
    ]
};