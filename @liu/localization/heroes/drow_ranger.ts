    ...
    AbilityArray: [
        {
            ...
            scepter_description: "霜冻之箭现在对敌人施加低温的叠加效果，提升霜冻之箭的伤害，并且每层叠加效果都会降低生命恢复。若敌人在低温效果下阵亡，他们将会爆炸，对范围内的敌人造成伤害和减速。",
            notes: [
                "减速的持续时间在下一支冰箭射中后刷新。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "arrow_angle",
                    text: ""
                },
                {
                    ability_special: "bypass_block",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "gust_reveals_invis",
                    text: ""
                }
            ],
            name: "狂风",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "trueshot_aspd_bonus_creeps",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "disable_range",
                    text: ""
                }
            ],
            name: "射手天赋",
            description: "卓尔游侠的战斗经验使她有概率发出极其精准高效的箭矢。箭矢将穿透敌人的防御，无视他们的基础护甲。如果{disable_range}范围内有敌方英雄，本技能没有效果。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "shard_count",
                    text: ""
                },
                {
                    ability_special: "shard_speed",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "shard_angle_step",
                    text: ""
                },
                {
                    ability_special: "shard_distance",
                    text: ""
                },
                {
                    ability_special: "turn_rate_slow",
                    text: ""
                },
                {
                    ability_special: "end_height",
                    text: ""
                },
                {
                    ability_special: "hilltop_offset",
                    text: ""
                },
                {
                    ability_special: "ramp_radius",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "z_speed_override",
                    text: ""
                }
            ],
            name: "冰川",
            description: "卓尔游侠在她脚下创造一片冰山。站在山上的攻击者会获得攻击距离加成和高坡优势——攻击不会丢失并且获得飞行视野。卓尔游侠站在山上时数箭齐发每波获得额外箭矢。山的前面会阻挡视野，并且除了卓尔游侠外无法穿行。施放时不会打断数箭齐发。",
            lore: "",
            notes: []
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "bonus_miss_chance",
                    text: ""
                }
            ],
            name: "制高点",
