    ...
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "hook_speed",
                    text: ""
                },
                {
                    ability_special: "hook_width",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "vector_target_distance",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "min_distance_damage",
                    text: ""
                },
                {
                    ability_special: "self_stun_duration_percent",
                    text: ""
                }
            ],
            name: "肉钩",
            description: "向一个单位或方向射出血腥的肉钩。勾住第一个遭遇的单位，并将它拖到帕吉身边，如果是非远古单位会被秒杀，其他敌方单位则会造成伤害。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "pull_distance_limit",
                    text: ""
                },
                {
            ...
            name: "肢解",
            description: "持续施法 - 帕吉撕咬一个敌方单位，使其失去行动能力并受到持续伤害。伤害量为基础伤害加上帕吉力量值的一定百分比，帕吉将回复与伤害量相等的生命。帕吉会将该单位以每秒{pull_units_per_second}的速度向自身牵引，最多牵引{pull_distance_limit}距离。",
            lore: "“等我干掉这些蠢货以后，就可以把它们做成肉饼了！”",
            shard_description: "降低冷却时间，肢解可以对友军施放，此时施法距离提升，将其生吞，每秒治疗他们最大生命值的一定百分比。",
            notes: [
                "即使肢解的目标在受到作用的过程中隐身，还是不会脱离肢解的作用。"
            ]
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "flesh_heap_strength_buff_amount",
                    text: ""
                },
                {
                    ability_special: "flesh_heap_range",
                    text: ""
                }
            ],
            name: "腐肉堆积",
            ...
            lore: "",
            notes: [
                "帕吉附近{flesh_heap_range}范围内敌方英雄阵亡时他都会获得力量加成，不论击杀者是谁。"
            ]
        }
    ],
    TalentArray: [
