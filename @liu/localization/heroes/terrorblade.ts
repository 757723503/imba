    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "is_global",
                    text: ""
                },
                {
                    ability_special: "requires_vision",
                    text: ""
                }
            ],
            name: "倒影",
            description: "恐怖利刃映出目标区域内所有敌方英雄的黑暗倒影对其进行反制，目标在短时间内将被自身倒影攻击，移动速度和攻击速度都会降低。倒影为无敌状态。",
            lore: "荒邪之狱的分形之墙中，恐怖利刃洞悉了古老的寓言：你就是自己最可怕的敌人。现在他也要让别人明白这个道理。",
            notes: [
                "无法以倒影的幻象为目标，并且幻象为无敌，减速效果被移除后幻象将被摧毁。",
                "倒影只会攻击该技能指定的目标。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "strong_illusion",
                    text: ""
                },
                {
                    ability_special: "show_particle_effect",
                    text: ""
                },
                {
                    ability_special: "appear_as_illusion",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "illusions_spawn_with_full_hp",
                    text: ""
                },
                {
                    ability_special: "AbilityManaCost",
        ...
        },
        {
            ...
            notes: [
                "近战或远程物品的冷却时间不同时将根据恐怖利刃在使用物品时处于远程或近战形态而定。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "scepter_speed",
                    text: ""
                },
                {
                    ability_special: "scepter_spawn_delay",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "reflection_pct",
                    text: ""
                }
            ],
            name: "恶魔狂热",
            description: "消耗恐怖利刃当前生命值的一部分，为恐怖利刃和他附近的幻象提供生命恢复、移动和攻击速度加成。倒影的幻象获得{reflection_pct}%加成效果。魔化状态下无法施放，而且施放魔化会移除恶魔狂热效果。",
            lore: "",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "ignore_minimum_pct_for_enemies",
                    text: ""
                },
                {
                    ability_special: "ignore_minimum_pct_for_enemies_tooltip",
                    text: ""
                }
            ],
            name: "魂断",
