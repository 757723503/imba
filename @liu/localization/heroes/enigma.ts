...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '恶魔召唤',
            description:
                '以生命为代价召唤三个谜团自身的碎片。虚灵的生命值会有所增加，数值为谜团当前生命值的{current_health_pct}%。这些虚灵都由谜团控制，在反复经过几次成功的攻击后，虚灵会再次分裂，并完全回复生命值。',
        ...
        },
        {
            ...
            lore: '世界的一部分缓缓跌入虚空。',
            notes: ['此技能将摧毁范围内的树木。', '多个午夜凋零的效果不会叠加。'],
        },
        {
            ...
            scepter_description:
                '黑洞额外造成等同于单位{scepter_pct_damage}%最大生命值的每秒伤害，并且产生一个{scepter_radius}范围，没有打断效果的牵引效果。牵引速度为{scepter_drag_speed}。',
            notes: [],
        },
        {
            ...
            name: '重力井',
            description:
                '谜团附近{max_dist}距离内的友军拥有最多{damage_reduction}%承受伤害降低。最远距离的效果为0，距离为{min_dist}时达到最大效果。不会影响谜团自身。',
            notes: [],
        },
        {
