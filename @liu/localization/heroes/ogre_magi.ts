...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "level_one_ability_points",
                    text: ""
                },
                {
                    ability_special: "level_two_ability_points",
                    text: ""
                }
            ],
            name: "傻福",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "multicast_delay",
                    text: ""
                },
                {
            ...
            notes: [
                "触发多重施法时，两次火焰爆轰之间有{multicast_delay}秒的间隔。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "multicast_fireshield_aoe",
                    text: ""
                },
                {
            ...
            name: "烈火护盾",
            description: "创造一个围绕友军目标的护盾，吸收接下来{attacks}次来自敌方英雄攻击的一定百分比伤害。吸收伤害后向攻击者发射火球。可以对防御塔施放。",
            lore: "",
            notes: [
                "触发多重施法时，{multicast_fireshield_aoe}范围内的友方单位将随机获得烈火护盾效果。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "str_multiplier",
                    text: ""
                }
            ],
            name: "未精通的火焰爆轰",
            description: "操控一波火焰轰击一个敌方单位，造成{base_damage} + {str_multiplier}倍食人魔力量的伤害并使目标眩晕。魔法消耗为食人魔魔法师当前魔法的{scepter_mana}%。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "ignite_multicast_aoe",
                    text: ""
                },
                {
                    ability_special: "required_level",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "multicast_bloodlust_aoe",
                    text: ""
                },
                {
                    ability_special: "required_level",
            ...
            notes: [
                "触发多重施法时，{multicast_bloodlust_aoe}范围内的友方单位将随机获得嗜血术效果。"
            ]
        },
        {
    ...
    ModifierArray: [
        ...
        {
            modifier_classname: "modifier_imba_ogre_magi_bloodlust_description",
            name: "移动速度提升{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，攻击速度提升{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}。"
        },
        {
        ...
        {
            modifier_classname: "modifier_imba_ogre_magi_ignite_description",
            name: "你着火了！受到持续伤害并减速{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。"
        },
        {
