...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            scepter_description: "提升施法距离，并且对目标施加弱驱散效果。可以对无敌目标施放。技能设为多样施法后，额外造成{scepter_bonus_damage}点伤害并且斯温会跟随风暴之拳行进。",
            notes: []
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "shard_passive_movespeed",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "barrier_per_strength",
                    text: ""
                }
            ],
            name: "战吼",
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "神之力量",
            description: "基础攻击力提升{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%。减速抗性提升{MODIFIER_PROPERTY_SLOW_RESISTANCE}%。"
        },
        {
