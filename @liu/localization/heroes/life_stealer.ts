...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '盛宴',
            description:
                '噬魂鬼每次攻击时会根据目标最大生命值的一定百分比造成伤害，同时获得治疗。使噬魂鬼可以攻击{creep_deny_percent}%生命值以下的友方小兵。噬魂鬼每击杀一个非英雄单位或一名英雄都会获得永久生命上限。',
        ...
        },
        {
            ...
            name: '撕裂伤口',
            description:
                '噬魂鬼撕裂一个敌方单位，减缓受害者的移动速度，并使所有友军在攻击该单位时根据造成的伤害回复一定比例的生命。所有伤害都有回复效果，包括技能的伤害。受害者在持续时间内逐渐恢复移动速度。',
        ...
        },
        {
            ...
            name: '感染',
            description:
                '噬魂鬼进入目标单位的身体，无法被察觉，而且自身在体内时每秒恢复最大生命值的一定百分比。接着可以从宿主体内现身，对周围所有敌方单位造成伤害。如果被感染单位是敌方非英雄单位或中立生物，噬魂鬼可以控制其进行移动和攻击。无法对敌方英雄生效。\\n\\n驱散类型：弱驱散',
            lore: '奈克斯通过寄生吞噬宿主的生命之血，使他的不洁之力恢复如初。',
            shard_description: '感染现身时会对伤害范围内的敌人施加{bonus_open_wounds_duration_pct}%持续时间的撕裂伤口。',
            scepter_description:
                '提升施法距离并且冷却时间降低至{bonus_AbilityCooldown}秒。感染可以对敌方英雄施放，持续时间较短，将他们缴械，并在他们体内发动攻击，同时提升噬魂鬼的恢复速率。',
            notes: [
        ...
        },
        {
            ...
            name: '吸收',
            description:
                '噬魂鬼吞下友方目标，使其藏于自己的体内。被吸收的单位将享受噬魂鬼的回复效果。被吸收的英雄离开噬魂鬼时会突然现身，对周围敌人造成伤害。\\n\\n驱散类型：强驱散',
            lore: '噬魂鬼怎能抗拒品尝队友的机会？',
            notes: [],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '狂暴 | 肆意狂怒',
            description:
                "噬魂鬼可以施放<b color='white'>狂暴</b>，变为减益免疫，并且提升魔法抗性。 噬魂鬼可以施放<b color='white'>肆意狂怒</b>，驱散自身并且抗性更高。被眩晕时可以施放。",
            related_abilities: [
                {
                    ability_classname: 'imba_life_stealer_rage',
                    description: '+{s:bonus_duration}秒 肆意狂怒持续时间',
                },
            ],
            related_talents: [
                {
                    talent_key: 'special_bonus_unique_lifestealer_facet_life_stealer_rage_dispell',
                    description: '+{s:bonus_duration}秒 肆意狂怒持续时间',
                },
            ],
        },
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '肆意狂怒',
            description: '获得{MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING}%状态抗性和{MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING}%魔法抗性。',
        },
        {
