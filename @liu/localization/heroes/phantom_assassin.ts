...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '窒碍短匕',
            description:
                '对敌方单位掷出一把匕首，减缓其移动速度，并造成物理伤害，数值为{base_damage}+幻影刺客攻击伤害的{attack_factor_tooltip}%，同时继承物品和技能的攻击效果。',
        ...
        },
        {
            ...
            name: '魅影无形',
            description:
                '幻影刺客模糊自己的身形，躲避多种飞行过程中的攻击和技能弹道，提升她的移动速度，使她无法被看到，直到她发动攻击，或者靠近敌方英雄、防御塔或前哨。',
        ...
        },
        {
            ...
            name: '恩赐解脱',
            description:
                '幻影刺客的战斗技能得到精进，每次攻击时有几率获得致命专注。攻击时若带有致命专注，幻影刺客会消耗该效果，并且必定产生一次致命一击。窒碍短匕拥有额外几率获得致命专注。',
    ...
    FacetArray_B: [
        {
            ...
            name: '有条不紊 | 魅影之纱',
            description:
                '每攻击同个英雄{s:bonus_attacks_to_proc}次触发恩赐解脱，或者攻击同个非英雄单位{s:bonus_attacks_to_proc_creeps}次触发。 发动攻击不再驱散魅影无形。魅影无形期间和结束后，物品和技能的魔法消耗减少。',
            related_abilities: [
                {
                    ability_classname: 'imba_phantom_assassin_blur',
                    description: '发动攻击不再驱散魅影无形。魅影无形期间和结束后，物品和技能的魔法消耗减少。',
                },
                {
                    ability_classname: 'imba_phantom_assassin_coup_de_grace',
                    description: '每攻击同个英雄{attacks_to_proc}次触发恩赐解脱，或者攻击同个非英雄单位{attacks_to_proc_creeps}次触发。',
                },
            ],
            related_talents: [
                {
                    talent_key: 'special_bonus_unique_phantom_assassin_2_facet_phantom_assassin_methodical',
                    description: '-{s:bonus_attacks_to_proc} 恩赐解脱触发所需次数',
                },
            ],
        },
    ],
