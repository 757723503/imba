    ...
    FacetArray_B: [
        {
            ...
            name: '腿部力量 | 苍洋守卫',
            description: '斯拉达的护甲提升，数值为侵蚀雾霭降低护甲总数的{s:bonus_armor_pct}%。 守卫冲刺开始时斯拉达获得减速抗性和额外的移动速度。',
            related_abilities: [
                {
                    ability_classname: 'imba_slardar_sprint',
                    description: '守卫冲刺开始时斯拉达获得减速抗性和额外的移动速度。',
                },
                {
                    ability_classname: 'imba_slardar_amplify_damage',
                    description: '斯拉达的护甲提升，数值为侵蚀雾霭降低护甲总数的{armor_pct}%。',
                },
            ],
            related_talents: [],
        },
