...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            shard_description:
                '双刃剑可以对敌人造成减速，并且每击中一名英雄都会暂时提升半人马战行者的力量值。每次叠加都会刷新持续时间，最多叠加{shard_max_stacks}次。',
            notes: ['双刃剑对目标和自身都造成魔法伤害。'],
        },
        {
        ...
        },
        {
            ...
            name: '奔袭冲撞',
            description:
                '半人马战行者带领所有队友向胜利冲锋，所有友方英雄达到极限移动速度，并使踩到的敌人减速。每个敌人只会受到一次踩踏作用，并受到基于半人马战行者力量值的伤害。',
        ...
        },
        {
            ...
            name: '便车',
            description:
                '半人马将一名友军抛入他身后的一辆便车中。友军在便车内是无敌状态，依然可以施法和攻击，不过无法移动，也无法成为敌人的目标。便车内近战英雄的攻击距离提升{melee_attack_range}。',
            ...
            related_abilities: [
                {
                    ability_classname: 'imba_centaur_double_edge',
                    description:
                        '双刃剑伤害提升，数值为半人马在最后{stack_duration}秒内受到来自敌方英雄伤害的{pct_of_incoming_damage_as_bonus}%，最高为{pct_of_incoming_damage_as_bonus}%双刃剑额外伤害。施放双刃剑后重置伤害累计。',
                },
            ],
            related_talents: [],
        },
