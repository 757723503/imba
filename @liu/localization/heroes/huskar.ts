...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "attrib_bonus",
                    text: ""
                },
                {
                    ability_special: "hurt_attrib_bonus",
                    text: ""
                },
                {
                    ability_special: "hurt_percent",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "aura_effectiveness",
                    text: ""
                },
                {
            ...
            notes: [
                "加成效果为线性增加，满血时没有加成，{hp_threshold_max}%生命时达到最大加成。"
            ]
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "health_cost_percent",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "life_break_heal_pct",
                    text: ""
                }
            ],
            name: "牺牲",
            description: "哈斯卡牺牲自己的生命来摧毁敌人的生命，他跃向一个目标，造成目标当前生命值一定百分比的伤害，并且降低目标的移动和攻击速度。哈斯卡在跳跃过程中为减益免疫，并且魔法抗性提升60%%。\\n\\n驱散类型：弱驱散",
            lore: "哈斯卡不顾危险，冲入只有他能幸存的激烈近身战。",
            scepter_description: "强迫敌方目标攻击哈斯卡，并提升施法距离。",
            notes: [
                "如果哈斯卡在跳跃时受到控制技能，或目标在0.015秒内移动1400码以上，跳跃就会停止。",
                "减速效果无视减益免疫。",
                "牺牲无法被躲避。"
            ]
        }
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "狂战士之血",
            description: "攻击速度提升{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}，魔法抗性提升{MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS}%，并且生命恢复提升{MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT}。"
        },
        {
