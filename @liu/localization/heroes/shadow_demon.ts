...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "illusion_outgoing_damage",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "illusion_incoming_damage",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "illusion_bounty_base",
                    text: ""
                },
                {
                    ability_special: "illusion_bounty_growth",
                    text: ""
                },
                {
                    ability_special: "can_cast",
                    text: ""
                }
            ],
            name: "崩裂禁锢",
        ...
        },
        {
            ...
            name: "灵魂猎手",
            description: "俘获区域内所有敌方单位的灵魂，使其损失当前生命值的一定百分比。暗影恶魔根据俘获英雄灵魂数量暂时获得技能增强。负面效果被移除后将重获一半损失的生命。崩裂禁锢作用下的单位也能受到灵魂猎手影响。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "bonus_stack_damage",
                    text: ""
                },
                {
                    ability_special: "radius",
            ...
            name: "暗影剧毒",
            description: "在一条直线上造成伤害，并以毒咒折磨敌方单位。根据目标身上的叠加层数，毒咒造成1/2/4/8/16倍的叠加伤害，至多{max_multiply_stacks}层。更多层的叠加每层造成{bonus_stack_damage}点伤害。这部分延缓的伤害在暗影毒的持续时间结束后生效，或者使用附属技能立刻造成伤害。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "min_slow",
                    text: ""
                }
            ],
            name: "邪恶净化",
            description: "净化目标敌方单位，移除增益魔法效果，并使目标在持续时间内减速。伤害在持续时间结束时计算，在此之前目标单位的移动速度缓慢地恢复。崩裂禁锢中的单位依然可以受到邪恶净化的影响。\\n\\n驱散类型：弱驱散",
            lore: "一旦暗影恶魔不再需要他的信徒，他会抛弃对它的奴役——还有它的生命。",
            scepter_description: "移除冷却时间，变为每隔{charge_restore_time_tooltip_scepter}秒充能一次，最多有{max_charges}点能量。另外邪恶净化还将在生效时间内破坏目标的被动技能。",
            notes: [
                "减速效果起始时为{max_slow}{，然后持续减少至{min_slow}}。",
        ...
        },
        {
            ...
            name: "邪恶净愈",
            description: "净愈目标友方单位，在持续时间内移除负面效果。在持续时间结束时该单位受到治疗效果。崩裂禁锢中的单位依然可以受到邪恶净愈的效果。<br><br>驱散类型：弱驱散",
            lore: "",
            scepter_description: "变为充能型技能，拥有{max_charges}点能量点数，每{charge_restore_time_tooltip_scepter}秒恢复一点。",
            notes: [
                "可以对无敌单位施放。",
                "净愈的持续时间内将持续移除目标的负面状态。"
            ]
        },
        {
            ...
            name: "散播",
            description: "只要目标受到伤害，目标附近{radius}范围内所有敌人，若目标为敌人那也包括目标自身，他们都将受到该伤害的一定百分比。可以对敌方或友方目标施放。敌人被崩裂禁锢隐藏时效果暂停。",
            lore: "",
            notes: []
        },
        {
    ...
    ModifierArray: [
        ...
        {
            modifier_classname: "modifier_imba_shadow_demon_demonic_purge_charge_counter_description",
            name: "使用后将开始回复能量点数。"
        },
        {
