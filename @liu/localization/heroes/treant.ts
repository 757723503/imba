    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "grace_time",
                    text: ""
                },
                {
                    ability_special: "cooldown_time",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "attack_damage_pct",
                    text: ""
                },
                {
            ...
            shard_description: "树精卫士在自然蔽护效果下隐身，攻击将缠绕敌人。如果攻击时靠近树木会造成持续伤害，并且缠绕时间更长。总伤害为{shard_damage} + {attack_damage_pct}%树精卫士基础攻击力。",
            notes: [
                "自然蔽护效果下树精卫士可以直接穿过树木。"
            ]
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "attack_damage_per_level",
                    text: ""
                }
            ],
            name: "",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "creation_interval",
                    text: ""
                },
                {
                    ability_special: "initial_latch_delay",
                    text: ""
                },
                {
                    ability_special: "vine_spawn_interval",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "can_target_ground",
                    text: ""
                },
                {
                    ability_special: "creep_damage_reduction_pct",
                    text: ""
                }
            ],
            name: "寄生种子",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "tree_respawn_seconds",
                    text: ""
                }
            ],
            name: "丛林之眼",
            description: "树精卫士对目标树木灌注魔力。注魔后树木将拥有周围的顺畅视野。如果树精卫士施放了疯狂生长，这些树木附近的单位也将会被困住，并受到伤害。被动使所有树木重生地更快。",
            lore: "对于需要守卫的，谁也不能打包票究竟是什么人，或什么东西。",
            notes: [
                "丛林之眼的树木产生的疯狂生长效果也可以造成伤害。",
                "如果敌人拥有真实视域，他们将会发现被灌注魔力的树木。"
            ]
        },
        {
