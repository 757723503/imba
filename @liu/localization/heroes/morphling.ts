...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            name: '波浪形态',
            description:
                '变体精灵化为波浪向前涌进，对路径上的敌人造成伤害。变体精灵在波浪形态中是无敌，并且对经过的所有敌人额外造成一定百分比的攻击伤害。',
            lore: '轻松卷走敌人的滔滔洪水。',
            notes: ['选择相应天赋前不会施加击中特效。'],
        },
        {
            ...
            name: '变体打击（敏捷）',
            description:
                '用猛烈的水波打击一个敌方单位，造成的伤害为基础伤害加上变体精灵自身敏捷值乘以伤害系数的额外伤害。如果变体精灵的敏捷比力量高50%{，将造成最大伤害。\\n\\n另外变体打击（力量）进入}shared_cooldown%秒冷却。',
            lore: '变体精灵唤出自身的元素，构成波浪碾碎对手。',
            shard_description: '提升敏捷加成。',
            notes: ['弹道移动速度为{projectile_speed}。'],
        },
        {
            ...
            name: '变体打击（力量）',
            description:
                '用猛烈的水波打击一个敌方单位，根据变体精灵自身力量值造成眩晕。如果变体精灵的力量比敏捷高50%{，将造成最大眩晕/击退。\\n\\n另外变体打击（敏捷）进入}shared_cooldown%秒冷却。',
            lore: '变体精灵唤出自身的元素，构成波浪碾碎对手。',
            shard_description: '提升力量加成。',
            notes: ['弹道速度为{projectile_speed}。'],
        },
        {
        ...
        },
        {
            ...
            notes: ['属性变换不能转化物品提供的属性加成。', '升级敏捷获取时也会升级力量获取。'],
        },
        {
            ...
            lore: '不断变化的流水让变体精灵的本质很难被辨别。',
            shard_description: '变体精灵在眩晕状态下可以变换属性。降低魔法消耗。',
            notes: ['属性变换不能转换物品提供的属性加成。', '升级力量获取时也会升级敏捷获取。'],
        },
        {
        ...
        },
        {
            ...
            scepter_description:
                '变形增加多样施法。开启后会产生目标英雄的强幻象，可以施放英雄的所有基础技能。如果变体精灵切换变形时幻象还存活，他就会摧毁该幻象，并取而代之。',
            notes: [
        ...
        },
        {
            ...
            name: '积少成多',
            description:
                '变体精灵每半级获得{percent_to_increment}%属性成长加成，而不是升级时获得全额加成。变体精灵从天赋树的全属性附加技能点获得+{percent_to_increment}%属性加成。',
            notes: [],
        },
    ],
    TalentArray: [
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '变形力量吸取',
            description:
                '获得{MODIFIER_PROPERTY_STATS_STRENGTH_BONUS}点力量、{MODIFIER_PROPERTY_STATS_AGILITY_BONUS}点敏捷、{MODIFIER_PROPERTY_STATS_INTELLECT_BONUS}点智力和{MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING}%状态抗性。',
        },
        {
            modifier_classname: 'modifier_imba_morphling_scepter_stats_drain_strength_debuff',
            name: '变形力量吸取',
            description:
                '失去{MODIFIER_PROPERTY_STATS_STRENGTH_BONUS_PERCENTAGE}%属性和{MODIFIER_PROPERTY_STATS_STRENGTH_BONUS_PERCENTAGE}%状态抗性。',
        },
        {
            modifier_classname: 'modifier_imba_morphling_scepter_stats_drain_agility_buff',
            name: '变形敏捷吸取',
            description:
                '获得{MODIFIER_PROPERTY_STATS_STRENGTH_BONUS}点力量、{MODIFIER_PROPERTY_STATS_AGILITY_BONUS}点敏捷、{MODIFIER_PROPERTY_STATS_INTELLECT_BONUS}点智力和{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}攻击速度。',
        },
        {
            modifier_classname: 'modifier_imba_morphling_scepter_stats_drain_agility_debuff',
            name: '变形敏捷吸取',
            description:
                '失去{MODIFIER_PROPERTY_STATS_AGILITY_BONUS_PERCENTAGE}%属性以及{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}攻击速度加成。',
        },
        {
            modifier_classname: 'modifier_imba_morphling_scepter_stats_drain_intelligence_buff',
            name: '变形智力吸取',
            description:
                '获得{MODIFIER_PROPERTY_STATS_STRENGTH_BONUS}点力量、{MODIFIER_PROPERTY_STATS_AGILITY_BONUS}点敏捷、{MODIFIER_PROPERTY_STATS_INTELLECT_BONUS}点智力和{MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE}%技能增强。',
        },
        {
            modifier_classname: 'modifier_imba_morphling_scepter_stats_drain_intelligence_debuff',
            name: '变形智力吸取',
            description:
                '失去{MODIFIER_PROPERTY_STATS_INTELLECT_BONUS_PERCENTAGE}%属性以及{MODIFIER_PROPERTY_STATS_INTELLECT_BONUS_PERCENTAGE}%技能增强。',
        },
        {
            modifier_classname: 'modifier_imba_morphling_scepter_stats_drain_all_buff',
            name: '变形全才吸取',
            description:
                '获得{MODIFIER_PROPERTY_STATS_STRENGTH_BONUS}点力量，{MODIFIER_PROPERTY_STATS_AGILITY_BONUS}点敏捷和{MODIFIER_PROPERTY_STATS_INTELLECT_BONUS}点智力。',
        },
        {
