...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            name: "奥术诅咒",
            description: "诅咒目标区域，使敌方英雄持续受到伤害，并且移动速度被减缓。期间受到作用的英雄一旦施放技能，他们就会短时间内被沉默。目标被沉默时不计入负面效果的持续时间。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "stacks_for_silence",
                    text: ""
                },
                {
                    ability_special: "silence_duration",
            ...
            name: "智慧之刃",
            description: "沉默术士用他的智慧强化刀刃，每次攻击窃取目标的智力，并造成基于他智力值的额外伤害。沉默术士。攻击同个目标{stacks_for_silence}次后敌人会被沉默{silence_duration}秒。",
            lore: "尽管无法使用传统咒语，但诺崇的风蚀之寒血统赋予他一种诡异的智慧，在肉搏中助他一臂之力。",
            shard_description: "提升每次攻击的智力窃取数值和持续时间。",
            notes: [
                "叠加效果会在{debuff_linger_duration}秒后重置。",
                "智慧之刃的沉默持续时间内不会获得叠加效果。"
            ]
        },
        {
        ...
        },
        {
            ...
            notes: [
                "沉默效果对隐身和减益免疫单位有效，但是期间获得减益免疫状态将移除该效果。"
            ]
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "permanent_int_steal_range",
                    text: ""
                },
                {
                    ability_special: "permanent_int_steal_amount",
                    text: ""
                }
            ],
            name: "智力外流",
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "永久智力窃取",
            description: "沉默术士从他击杀的任意敌方英雄身上永久窃取{MODIFIER_PROPERTY_TOOLTIP}点智力，同样还有{MODIFIER_PROPERTY_TOOLTIP}范围内阵亡的任意敌方英雄。"
        },
        {
