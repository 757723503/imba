...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            description: "激怒一个敌方单位，使他受到持续伤害，直到他杀死一个单位或者持续时间结束。伤害量会根据斧王的护甲而增加。敌人只要背朝斧王还将被减速。",
        ...
        },
        {
            ...
            scepter_description: "反击螺旋现在对击中的敌人施加一个可叠加的负面效果，使其对斧王造成的攻击伤害减少。反击螺旋不再具有冷却时间，并且斧王的攻击也会计入触发记数。"
        },
        {
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "淘汰之刃",
            description: "斧王发出战争咆哮，提升附近所有友军{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%移动速度和{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}攻击速度"
        },
        {
