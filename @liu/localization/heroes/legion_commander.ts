...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            notes: ['如果双方距离超过2000，决斗也会结束。', '决斗获胜后自动对自身施放强攻。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '石堂城甲胄 | 战争恩赐',
            description:
                '决斗胜利时，决斗期间对失败者造成过伤害的单位都会获得小额的永久攻击力。 压倒性优势会根据对敌方英雄造成的伤害提供全伤害护盾。',
            related_abilities: [
                {
                    ability_classname: 'imba_legion_commander_overwhelming_odds',
                    description: '压倒性优势会根据对敌方英雄造成的伤害提供全伤害护盾。',
                },
                {
                    ability_classname: 'imba_legion_commander_duel',
                    description: '决斗胜利时，决斗期间对失败者造成过伤害的单位都会获得小额的永久攻击力。',
                },
            ],
            related_talents: [],
        },
