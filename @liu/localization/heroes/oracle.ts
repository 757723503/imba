    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "damage_per_buff",
                    text: ""
                },
                {
                    ability_special: "heal_per_debuff",
                    text: ""
                },
                {
                    ability_special: "purge_constantly",
                    text: ""
                }
            ],
            name: "气运之末",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "magic_damage_resistance_pct_tooltip",
                    text: ""
                }
            ],
            name: "命运敕令",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "shard_fade_time",
                    text: ""
                },
                {
                    ability_special: "shard_spell_amp_bonus",
                    text: ""
                },
                {
                    ability_special: "shard_bat_bonus",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "heal_amplification",
                    text: ""
                }
            ],
            name: "预言家疗伤",
