    ...
    AbilityArray: [
        {
            ...
            name: '气运之末',
            description:
                '持续施法 - 将神谕者的力量汇聚为一股蕴含荡涤之力的能量，对敌方目标释放这股能量可以对其造成伤害，使其被缠绕，并且驱散其附近区域的魔法效果。如果目标是友军，将只造成驱散效果。缠绕效果的持续时间与引导时间相同。\\n\\n驱散类型：弱驱散',
        ...
        },
        {
            ...
            name: '涤罪之焰',
            description:
                '将目标身上一切不洁之物净化，对其造成大量魔法伤害，并使其在接下来的一段时间内逐渐恢复生命值。恢复的生命值总量将超过受到的伤害。可对友方和敌方单位施放。',
            lore: '一支蜡烛的微光在挂满镜子的厅堂中异常耀眼，无独有偶，破碎的宇宙之壁可以将预言的微光变成炫目的火炬。',
            notes: ['涤罪之焰的治疗效果可以相互叠加。', '涤罪之焰的伤害对友军不会致死。'],
        },
        {
            ...
            name: '虚妄之诺',
            description:
                '暂时篡改队友的命运，技能期间受到的任何治疗和伤害效果将在虚妄之诺结束后结算，其中治疗效果结算时效果更强。施放时将移除目标身上大部分的负面状态效果。\\n\\n驱散类型：强驱散',
            lore: '敌人和虚妄的先知一样常常会编造他人的命运。',
            scepter_description:
                '使虚妄之诺提供具有{shard_fade_time}秒渐隐延迟的隐身效果，并且友军获得{shard_spell_amp_bonus}%技能伤害加成，基础攻击间隔降低{shard_bat_bonus}秒。',
            notes: [
