    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "glaives_fired",
                    text: ""
                },
                {
                    ability_special: "glaives_attack_radius",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "lucent_beam_bounce_range",
                    text: ""
                },
                {
                    ability_special: "damage_buff_from_eclipse_pct",
                    text: ""
                }
            ],
            name: "月光",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "rotating_glaives",
                    text: ""
                },
                {
                    ability_special: "rotating_glaives_movement_radius",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "unclamp_max_radius",
                    text: ""
                },
                {
                    ability_special: "rotating_glaives_speed",
                    text: ""
                },
                {
                    ability_special: "rotating_glaives_shard_speed_bonus_tooltip",
                    text: ""
                },
                {
                    ability_special: "AbilityCooldown",
            ...
            name: "环月",
            description: "产生{rotating_glaives}个月刃在露娜身旁{rotating_glaives_movement_radius}范围内旋转。任何碰到月刃的敌方单位都会受到露娜攻击伤害的一定百分比。",
            lore: "",
            notes: []
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "bonus_night_vision_self",
                    text: ""
                },
                {
                    ability_special: "bonus_night_vision_per_level",
                    text: ""
                },
                {
                    ability_special: "bonus_damage_per_level",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "self_bonus_damage_per_level",
                    text: ""
                },
                {
            ...
            name: "月之祝福",
            description: "每级提升露娜和附近友方英雄{bonus_damage_per_level}点攻击力，露娜获得双倍的攻击力加成。夜晚期间月之祝福为全地图生效，并且露娜受到福佑后夜间视野提升{bonus_night_vision_self} + {bonus_night_vision_per_level} * 英雄等级。",
            lore: "月之女神对她的族人微笑。",
            shard_description: "月之祝福可以主动施放，使800范围内友方英雄获得诡计之雾的效果。夜晚期间脱离开雾的距离更近，移动速度加成更高。另外月蚀的夜晚时间增加10秒",
            notes: []
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "beam_interval",
                    text: ""
                },
                {
                    ability_special: "beam_interval_scepter",
                    text: ""
                },
                {
                    ability_special: "radius",
            ...
            name: "月蚀",
            description: "召唤一次月蚀，以她当前技能等级的月光随机打击附近敌人。月光只有伤害效果，不会造成眩晕，而且单一目标只能受到有限次数的打击。月蚀会暂时将白天变为黑夜。",
            lore: "在急需其帮助的时候，赛莉蒙妮亲自降临世间，遮蔽照向敌人的光芒，以及他们的希望。",
            scepter_description: "露娜可以对友方单位或自身施放月蚀，使月蚀的效果跟随目标，或者对一片区域施放。增加月光数量，减少月蚀持续时间，并且移除单体打击次数上限，月光的产生间隔缩短一半。",
            notes: [
