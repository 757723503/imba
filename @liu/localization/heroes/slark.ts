...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            name: '鱼饵',
            description:
                '减缓敌人{movement_speed}%移动速度，并且获得目标的真实视域，持续{slow_duration}秒。若斯拉克在此期间突袭该敌人，将在束缚的持续时间内获得{attack_speed}攻击速度加成。',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            name: '黑暗契约',
            description:
                '短暂延迟后，斯拉克牺牲部分生命力，清除大部分负面状态并对自己和周围敌方单位造成伤害。斯拉克自身只受到造成伤害的{self_damage_pct}%。\\n\\n驱散类型：强驱散',
        ...
        },
        {
            ...
            name: '能量转移',
            description:
                '斯拉克的攻击会偷走敌方英雄的生命能量，每次吸取他们的一点全属性并转化成自身额外的敏捷值。只要敌方英雄带着该效果在斯拉克300范围内阵亡，他将永久窃取{stat_loss}点敏捷。',
        ...
        },
        {
            ...
            notes: ['如果斯拉克受到中立生物的攻击，{neutral_disable}秒内将失去被动的移速加成和生命恢复效果。'],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '抽吸突袭 | 暗黑之礁叛徒',
            description: '斯拉克不在友方英雄附近时被敌人看到后梭子鱼效果还会粘滞一段时间。 突袭在击中敌方英雄时会施加能量转移的叠加次数。',
            related_abilities: [
                {
                    ability_classname: 'imba_slark_pounce',
                    description: '突袭在击中敌方英雄时会施加能量转移的叠加次数。',
                },
                {
                    ability_classname: 'imba_slark_barracuda',
                    description: '斯拉克不在友方英雄附近时被敌人看到后梭子鱼效果还会粘滞一段时间。',
                },
            ],
            related_talents: [],
        },
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '梭子鱼恢复',
            description:
                '获得{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%移动速度加成，并且每秒恢复{MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT}点生命。',
        },
        {
