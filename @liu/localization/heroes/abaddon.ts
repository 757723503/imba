...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: "无光之盾",
            description: "召唤黑暗能量环绕友方单位，创造一个全伤害护盾，护盾在消失前能吸收一定量的伤害。护盾消失或被摧毁后将会爆炸，对附近区域的单位造成伤害，伤害值为护盾的最大吸收量。施放时移除目标身上的负面状态和眩晕效果。\\n\\n驱散类型：强驱散",
            lore: "升腾的黑雾将敌人的招数一一吞噬，如同吞噬日光。",
            notes: [
                "不论护盾因持续时间结束或吸收足够伤害后被摧毁都将造成最大伤害。",
                "爆炸将不会对战争迷雾内单位造成伤害。"
            ],
            ability_specials: [
                {
                ...
                {
                    ability_special: "absorb_to_damage",
                    text: "%吸收伤害会反弹给附近的敌人。"
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "cooldown_reduction_creeps",
                    text: "非英雄单位阵亡时减少{cooldown_reduction_creeps}秒"
                },
                {
                    ability_special: "cooldown_reduction_heroes",
                    text: "英雄阵亡时减少{cooldown_reduction_heroes}秒"
                },
                {
                    ability_special: "radius",
                    text: "%radius%范围"
        ...
        },
        {
            ...
            name: "凋零迷雾",
            description: "对敌人造成伤害时会施加凋零迷雾的负面效果，持续{duration}秒。受作用敌人如果血量低于{hp_threshold_pct}{，那么生命恢复、治疗、吸血和技能吸血会降低{heal_reduction_pct}}。",
            lore: "",
            notes: [],
            ability_specials: [
                {
                    ability_special: "hp_threshold_pct",
                    text: ""
                },
                {
                    ability_special: "heal_reduction_pct",
                    text: ""
                },
                {
                    ability_special: "duration",
        ...
        },
        {
            ...
            name: "魔霭诅咒",
            description: "亚巴顿打击一个敌人，使其受到寒心诅咒的作用，被减速，并且持续受到伤害，同时所有攻击目标的单位将提升攻击速度。对建筑的持续伤害减少{tower_dps_pct}%。",
            ...
            ability_specials: [
                ...
                {
                    ability_special: "curse_interval",
                    text: ""
                }
            ],
        ...
        },
        {
            ...
            name: "回光返照",
            description: "启动后所有受到的伤害转而产生治疗效果，启动时还将移除大部分的负面效果。只要技能不在冷却中，在生命值低于{hp_threshold}点时技能会自动启动。\\n\\n驱散类型：强驱散",
            ...
            ability_specials: [
                ...
                {
                    ability_special: "immolate_damage",
                    text: ""
                },
                {
                    ability_special: "immolate_aoe",
                    text: ""
                },
                {
                    ability_special: "immolate_tick",
                    text: ""
                }
            ],
            scepter_description: "提升持续时间。启动回光返照后，亚巴顿附近{redirect_range_scepter}范围内友方英雄受到的伤害超过{ally_threshold_scepter}点时亚巴顿就会自动对其施放迷雾缠绕。"
        }
    ],
    ModifierArray: [
        {
            ...
            related_abilities: [
                {
                    ...
                    description: "祸乱之源在攻击噩梦中单位时获得额外的攻击速度。"
                },
                {
                    ability_classname: "imba_bane_nightmare",
                    description: "噩梦中单位会朝选定方向走去。"
                }
            ],
            related_talents: [
                {
