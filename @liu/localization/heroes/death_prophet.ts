    ...
    AbilityArray: [
        {
            ...
            notes: ['最远能伤害1110距离外的单位。', '不会触发法术抵抗或法术反弹。'],
        },
        {
        ...
        },
        {
            ...
            name: '巫术精研',
            description:
                '死亡先知的神秘学识随着经验积累而加深，每级获得{movement_speed_pct_per_level}%移动速度和{movement_speed_pct_per_level}%技能冷却时间减少。',
            notes: [],
        },
        {
            ...
            lore: '克萝贝露丝乐意向他人展示她独自无法走上的道路。',
            shard_description:
                '吸魂巫术的能量点数提升{shard_bonus_charges}点，敌人连续{shard_consecutive_siphon_duration}秒受到吸魂巫术作用后会被恐惧{shard_fear_duration}秒。',
            notes: ['多个连接不能同时作用于一个目标。'],
        },
        {
            ...
            name: '驱使恶灵',
            description:
                '释放恶灵偷走敌方单位和建筑的生命。恶灵需要回到她身上才能再次攻击。持续时间结束后，死亡先知根据造成的伤害量，获得一定比例的治疗。对建筑造成50%{伤害。持续}abilityduration%秒。<br/>开启后会提升死亡先知的移动速度。',
            lore: '伴随着无数次的死亡，她前世死亡幻化出的女妖们总是萦绕于现世。',
            scepter_description:
                '敌人受到死亡先知的技能作用，或被死亡先知攻击时，会有一只恶灵飞出攻击敌人，造成减速和高出平常的伤害，再返回使自身回复生命。',
            notes: ['作用范围代表死亡先知周围的恶灵寻找目标的范围。', '伤害格挡类技能不能减少恶灵伤害。'],
        },
        {
        ...
        },
        {
            ...
            name: '哀悼仪式',
            description: '死亡先知延缓承受一定百分比的伤害，短时间内每隔一段时间受到伤害。',
            notes: ['延缓的伤害与初始伤害的类型相同，并且无视护甲、魔法抗性和伤害格挡。'],
        },
    ],
    TalentArray: [
        {
