...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "dragon_form_bonus_pct",
                    text: ""
                },
                {
                    ability_special: "duration",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "dragon_cast_range",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "is_green_dragon",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "is_blue_dragon",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            name: "古龙形态",
            description: "龙骑士能够变身成为三种强大的古龙形态之一。移动速度和攻击力得到提升，飞龙之怒的攻击效果会施加给目标附近所有敌人。神龙摆尾的施法距离得到提升。神龙之血的生命恢复和护甲加成得到提升。",
            ...
            notes: [
                "腐蚀吐息的毒素伤害可以致死。",
                "近战或远程物品的冷却时间不同时将根据龙骑士在使用物品时处于远程或近战形态而定。"
            ]
        }
    ],
    TalentArray: [
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "冰霜吐息减速",
            description: "移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，攻击速度降低{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}，治疗效果降低{MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_TARGET}%。"
        },
        {
