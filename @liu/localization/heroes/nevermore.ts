...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            name: '毁灭阴影',
            description:
                '影魔对其正前方区域释放毁灭能量，对该区域中的敌人造成伤害。在目标身上施加一个连中效果，持续时间内再被毁灭阴影击中将受到额外伤害。',
            lore: '奈文摩尔标志性的灵魂收割手段。',
            shard_description: '每击中一名敌方英雄后冷却时间减少{cooldown_reduction_on_hero_hit}秒。',
            notes: ['连中效果的持续时间在每次连中时刷新。'],
        },
        {
            ...
            name: '毁灭阴影',
            description:
                '影魔对其正前方稍远处释放毁灭能量，对该区域中的敌人造成伤害。在目标身上施加一个连中效果，持续时间内再被毁灭阴影击中将受到额外伤害。',
            lore: '奈文摩尔标志性的灵魂收割手段。',
            shard_description: '每击中一名敌方英雄后冷却时间减少{cooldown_reduction_on_hero_hit}秒。',
            notes: ['连中效果的持续时间在每次连中时刷新。'],
        },
        {
            ...
            name: '毁灭阴影',
            description:
                '影魔对其正前方较远处释放毁灭能量，对该区域中的敌人造成伤害。在目标身上施加一个连中效果，持续时间内再被毁灭阴影击中将受到额外伤害。',
            lore: '奈文摩尔标志性的灵魂收割手段。',
            shard_description: '每击中一名敌方英雄后冷却时间减少{cooldown_reduction_on_hero_hit}秒。',
            notes: ['连中效果的持续时间在每次连中时刷新。'],
        },
        {
            ...
            notes: ['反补、杀死中立生物也能收集到灵魂。', '破坏会使技能无法获得新的叠加效果。', '破坏不会使现有叠加效果提供的加成失效。'],
        },
        {
        ...
        },
        {
            ...
            name: '魂之挽歌',
            description:
                '影魔聚集捕获的灵魂，以多道魔能的形式释放。若距离影魔过近将受到数道魔能的伤害。敌方单位受到魂之挽歌伤害的同时，每道魔能还将造成恐惧和减速效果，并且降低魔法抗性，持续{requiem_slow_duration}秒，最高可达{requiem_slow_duration_max}秒。每个通过支配死灵收集的灵魂会为魂之挽歌创造一道魔能。<br><br>死亡时会自动释放魂之挽歌，不占用主动大招的冷却时间。',
            lore: '那些死者的灵魂被捕获后尽数释放，毁灭他们生前的盟友。',
            scepter_description: '降低冷却时间，并且魂之挽歌可以回归影魔。回归的伤害波造成较低的伤害，但是影魔会回复与伤害值相等的生命。',
            notes: ['影魔收集的灵魂中，每{requiem_soul_conversion}个会产生一道伤害波。', '死亡时释放的魂之挽歌不会施加恐惧和减速效果。'],
        },
    ],
    TalentArray: [
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '阴影泥沼 | 经久不衰',
            description:
                '在附近敌方英雄阵亡后魔王降临的降低护甲效果将会暂时提升。每次击杀英雄会使支配死灵的灵魂上限增加{s:bonus_max_soul_increase_on_hero_kill}个，直到影魔阵亡。 毁灭阴影会减缓敌人的移动速度。',
            related_abilities: [
                {
                    ability_classname: 'imba_nevermore_shadowraze1',
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '毁灭阴影',
            description:
                '每次受到毁灭阴影作用时额外承受{MODIFIER_PROPERTY_TOOLTIP}点伤害。移动速度被减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。',
        },
        {
