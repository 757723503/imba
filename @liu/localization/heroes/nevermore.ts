...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "shadowraze_radius",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "shadowraze_cooldown",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "procs_attack",
                    text: ""
                },
                {
                    ability_special: "movement_speed_debuff",
                    text: ""
                },
                {
                    ability_special: "attack_speed_debuff",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "cooldown_reduction_on_hero_hit",
                    text: ""
                }
            ],
            name: "毁灭阴影",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "souls_per_kill",
                    text: ""
                },
                {
                    ability_special: "necromastery_soul_release",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "soul_release_tooltip",
                    text: ""
                },
                {
                    ability_special: "max_soul_increase_on_hero_kill",
                    text: ""
                }
            ],
            name: "支配死灵",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "cast_speed_pct",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "requiem_radius",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "requiem_soul_conversion",
                    text: ""
                },
                {
                    ability_special: "requiem_line_width_start",
                    text: ""
                },
                {
                    ability_special: "requiem_line_width_end",
                    text: ""
                },
                {
                    ability_special: "requiem_line_speed",
                    text: ""
                },
                {
                    ability_special: "soul_death_release",
                    text: ""
                },
                {
    ...
    ModifierArray: [
        ...
        {
            modifier_classname: "modifier_imba_nevermore_necromastery_shard_description",
            name: "影魔每次攻击可以消耗1个灵魂，造成190%伤害。击杀敌人可以额外获得一个灵魂。冷却时间：3秒。"
        },
        {
        ...
        },
        {
            ...
            name: "魂之挽歌",
            description: "移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%， 攻击力降低{MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE}%。"
        },
        {
        ...
        {
            modifier_classname: "modifier_imba_nevermore_shadowraze_debuff_description",
            name: "每次受到毁灭阴影作用时额外承受{MODIFIER_PROPERTY_TOOLTIP}点伤害。移动速度被减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。"
        },
        {
