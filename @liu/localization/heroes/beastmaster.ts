...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "min_throw_duration",
                    text: ""
                },
                {
                    ability_special: "max_throw_duration",
                    text: ""
                }
            ],
            name: "野性之斧",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "boar_base_damage",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "boar_bonus_damage",
                    text: ""
                },
                {
                    ability_special: "boar_base_xp_bounty",
                    text: ""
                },
                {
                    ability_special: "boar_base_movespeed",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "perch_flight_height",
                    text: ""
                },
                {
                    ability_special: "perch_tree_height",
                    text: ""
                },
                {
                    ability_special: "flight_speed",
                    text: ""
                },
                {
                    ability_special: "perching_tree_height",
                    text: ""
                },
                {
                    ability_special: "perched_spot_height",
                    text: ""
                },
                {
                    ability_special: "top_level_height",
                    text: ""
                }
            ],
            name: "",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "hawk_base_gold_bounty",
                    text: ""
                },
                {
                    ability_special: "hawk_base_vision_range",
                    text: ""
                },
                {
                    ability_special: "hawk_base_xp_bounty",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "roaming_radius",
                    text: ""
                },
                {
                    ability_special: "roaming_seconds_per_rotation",
                    text: ""
                },
                {
                    ability_special: "hawk_base_attack_interval",
                    text: ""
                },
                {
                    ability_special: "min_move_speed",
                    text: ""
                },
                {
                    ability_special: "max_move_speed",
                    text: ""
                }
            ],
            name: "野性呼唤战鹰",
            description: "兽王召唤一只战鹰环绕在他周围，战鹰以{hawk_base_attack_interval}秒的基础攻击间隔俯冲攻击敌人，造成并缠绕。战鹰提升攻击速度后会提升攻击频率。以英雄优先。",
            lore: "度过了与异兽互惠互助的孩童时期，兽王学会了如何随时召唤野兽。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "push_distance",
                    text: ""
                },
                {
                    ability_special: "push_duration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "movement_speed_duration",
                    text: ""
                },
                {
                    ability_special: "AbilityCooldown",
            ...
            name: "原始咆哮",
            description: "兽王发出震耳欲聋的咆哮，使目标敌方单位受到伤害并眩晕，同时在兽王和他的猎物之间清出一条通道。通道上的所有单位都被震开，也受到伤害并被降低移动和攻击速度。另外，兽王和他的单位获得{movement_speed}%移动速度提升，持续3秒。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "stack_decay_time",
                    text: ""
                },
                {
            ...
            name: "斯洛姆战鼓",
            description: "兽王或周围他控制的单位攻击敌人都会使他敲下战鼓，对附近单位造成伤害，并且治疗自身和他控制的单位，数值为造成伤害的一定百分比。每次攻击都会降低敲鼓的间隔，{max_stacks}次攻击后降低至最短{min_drum_hit_interval}秒敲击一次。如果没有发动攻击，每隔1秒敲鼓间隔都会逐渐变长。<br><br>使用原始咆哮时根据原始咆哮的等级自动增加10/15/20层敲鼓叠加效果。",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "damage_block_pct_fifty_tooltip",
                    text: ""
                },
                {
                    ability_special: "damage_block_pct_vs_creeps",
                    text: ""
                }
            ],
            name: "刚毅",
            description: "兽王对非英雄单位的近战英雄伤害格挡几率从{damage_block_pct_fifty_tooltip}{提升至{damage_block_pct_vs_creeps}}。",
            lore: "",
            notes: []
        }
    ],
    ...
    ModifierArray: [
        ...
        {
            modifier_classname: "modifier_imba_beastmaster_axe_stack_counter_description",
            name: "兽王和他的单位造成的伤害增加。"
        },
        {
        ...
        },
        {
            ...
            name: "豪猪之毒",
            description: "攻击速度降低{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_PERCENTAGE}%，攻击速度降低{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}。"
        },
        {
