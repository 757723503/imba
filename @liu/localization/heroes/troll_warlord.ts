...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: "狂战士之怒",
            description: "近战形态下巨魔战将的攻击有几率触发诱捕，阻止目标移动或使用位移类技能。另外近战形态下还拥有额外移动速度和护甲。<br><br>远程形态下巨魔战将的攻击有几率使目标残废，造成额外伤害，并且降低目标的移动和攻击速度。",
            lore: "跟巨魔战将的怒火一样，他的斧头也是源源不断。",
            notes: [
                "近战或远程物品的冷却时间不同时将根据巨魔战将在使用物品时处于远程或近战形态而定。"
            ]
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "bonus_range_pct",
                    text: ""
                }
            ],
            name: "",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "axe_width",
                    text: ""
                },
                {
                    ability_special: "axe_speed",
                    text: ""
                },
                {
                    ability_special: "axe_range",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "axe_spread",
                    text: ""
                },
                {
                    ability_special: "axe_count",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "axe_movement_speed",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "extra_attack_chance_per_stack",
                    text: ""
                },
                {
                    ability_special: "base_chance",
                    text: ""
                },
                {
            ...
            shard_description: "热血战魂的叠加上限提升{bonus_max_stacks}次，并且巨魔有{base_chance}{ + 热血战魂叠加次数*{extra_attack_chance_per_stack}}的几率对远程攻击距离 + {range_buffer}范围内任意单位发动一次额外的远程攻击。",
            notes: [
                "破坏会使技能无法获得新的叠加效果。",
                "破坏会使阿哈利姆魔晶的几率触发失效。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "attack_speed_share_percent",
                    text: ""
                },
                {
                    ability_special: "movement_speed",
            ...
            name: "战斗专注",
            description: "巨魔战将释放出强大的战斗专注，强迫自身持续攻击{range}距离内最近的敌方单位，以英雄优先。专注期间不会因伤害而阵亡。提供额外吸血，攻击速度和移动速度。施放时施加弱驱散。 \\n\\n驱散类型：弱驱散",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "skeletons_created",
                    text: ""
                },
                {
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: "战斗专注",
            description: "获得{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}攻击速度，{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%移动速度和吸血。巨魔战将在战斗专注期间不会阵亡。"
        },
        {
