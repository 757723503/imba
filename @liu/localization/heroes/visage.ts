    ...
    AbilityArray: [
        {
            ...
            notes: ['两个状态效果是分开驱散的。', '速度加成和目标的速度减少相互独立。', '维萨吉周围{radius}内的佣兽也将获得黄泉颤抖的加成效果。'],
        },
        {
            ...
            name: '灵魂超度',
            description:
                '每次附近英雄（不论敌我）受到的伤害超过{damage_limit}点，维萨吉就能集聚灵魂精华的能量。将精华释放后，会对目标单位造成基础伤害，每一点集聚的能量还将造成额外伤害。',
            lore: '收集的死者亡魂四散而去带回生魂。',
            notes: ['能量点数只计算来自玩家或肉山的伤害，必须大于{damage_min}点小于{damage_max}点。自残型伤害和灵魂超度造成的伤害不计算在内。'],
        },
        {
        ...
        },
        {
            ...
            name: '召唤佣兽',
            description:
                '召唤{familiar_count}只盲眼的佣兽为维萨吉作战。佣兽拥有石像形态技能，可以化为石像，在落地时使敌人眩晕。在石像形态中的佣兽无敌，并且迅速回复生命值。佣兽被击杀时给予高额奖励。',
            lore: '死灵飞龙的佣兽，也是狭窄迷宫的守卫，俯视着他的领地。',
            notes: ['施放召唤佣兽后已有的佣兽将会死亡。', '佣兽在维萨吉周围时将获得当前陵卫斗篷的承伤降低效果和黄泉颤抖的加成效果。'],
        },
        {
            ...
            name: '静如古墓',
            description:
                '维萨吉和佣兽变为隐形，并获得移动速度加成，自身移动类型升级为飞行。维萨吉或佣兽脱离隐身时，短时间内造成的伤害会增加。持续{invis_duration}秒。攻击或施法都会脱离隐身。',
            notes: [],
        },
        {
            ...
            name: '石像形态',
            description:
                '命令离维萨吉最近的佣兽在当前地点施放石像形态，化为石像并坠向地面，对范围的所有敌人造成眩晕和伤害。此时佣兽无敌，并非常迅速地恢复生命值。{stone_duration}秒后佣兽自动解除石像形态。<br><br>可以设为多样施法，命令最近的佣兽移动至目标地点再施放石像形态。',
            notes: ['尽管石像形态无法被驱散，但眩晕效果可以被强驱散移除。'],
        },
        {
            ...
            name: '石像形态',
            description:
                '短暂延迟后，佣兽化为石像并坠向地面，对范围的所有敌人造成眩晕及伤害。此时佣兽无敌，并非常迅速地恢复生命值。{stone_duration}秒后佣兽自动解除石像形态。<br><br>可以设为多样施法，命令佣兽移动至目标地点再施放石像形态。',
            notes: [],
        },
        {
            ...
            name: '潜伏',
            description:
                '只要维萨吉没有受到伤害，他的技能冷却时间就会缩短。<br><br>维萨吉每{stack_gain_time}秒没有受到伤害就会获得一层叠加效果。每层叠加效果提供{cooldown_speed_per_stack}%冷却时间减少，最多为{max_stacks}层。叠加效果会在受到任意伤害{linger_duration}秒后消失。',
            notes: ['破坏会使技能无法获得新的叠加效果。', '破坏不会使现有叠加效果提供的加成失效。', '影响维萨吉的技能冷却时间，包括正在冷却的技能。'],
        },
    ],
    TalentArray: [
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '圣龛 | 忠实部下 | 死亡代价',
            description:
                '黄泉颤抖还会作用于目标附近的单位。维萨吉也能召回他的佣兽。 佣兽会自动跟随维萨吉，并攻击他的目标。 灵魂超度击杀时会提供最多{s:bonus_gold_max_tooltip}额外金钱。',
            related_abilities: [
                {
                    ability_classname: 'imba_visage_grave_chill',
                ...
                },
                {
                    ability_classname: 'imba_visage_soul_assumption',
                    description:
                        '灵魂超度击杀时每点灵魂能量会提供{bonus_soul_charge_gold}金，最高为{bonus_gold_max_tooltip}金。击杀非英雄时获得的金钱有所减少。灵魂超度作用于敌方英雄后{gold_grace_period_hero}秒内英雄阵亡也会获得金钱。',
                },
                {
                    ability_classname: 'imba_visage_summon_familiars',
                    description:
                        '佣兽会攻击维萨吉最后尝试攻击的目标，如果目标超出了维萨吉的攻击距离，或者维萨吉下达了取消当前动作或固守原地的命令后，佣兽会返回。<br><br>技能可以设为自动施法，命令佣兽回到维萨吉身旁，在技能关闭前不会离开。',
                },
            ],
            related_talents: [],
        },
