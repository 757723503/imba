    ...
    AbilityArray: [
        {
            ...
            name: '寒冰碎片',
            description:
                '巨牙海民将数块寒冰碎片压缩成蕴含冰冻能量的冰球，对所有接触到冰球的敌人造成伤害。冰球到达目标地点时会产生一个障碍物，持续{shard_duration}秒。',
        ...
        },
        {
            ...
            name: '雪球',
            description:
                '巨牙海民开始卷成雪球。右键点击{snowball_grab_radius}范围内的友方英雄能使其加入雪球。发动雪球后，雪球经过的单位将会被眩晕并受到伤害。雪球每卷入一个英雄，它的伤害都会得到提升。',
        ...
        },
        {
            ...
            name: '摔角行家',
            description:
                '主动使用后暂时施加一个负面效果的光环，使作用范围内的敌人被攻击时承受额外物理伤害，并且移动速度被减缓。持续{debuff_duration}秒。',
            lore: '就算远离钴蓝冰原，巨牙海民骨子里还是有着“寒战屏障”。',
            notes: ['影响来自友方英雄、巨牙海民和他控制的所有单位的普通攻击。'],
        },
        {
            ...
            name: '酒友',
            description:
                '巨牙海民伸出手来触碰友方单位，拉近彼此。触碰后巨牙海民和他的友军获得移动速度和攻击力加成。可以设为多样施法，只把巨牙海民拉向他的友军。',
            notes: ['如果巨牙海民和目标友军相距在{min_distance}距离以内，就不会拉动他们。', '在雪球期间无法使用。'],
        },
        {
        ...
        },
        {
            ...
            name: '海象飞踢',
            description:
                '将最近的敌方单位向目标方向踢上一脚，对其造成眩晕，伤害和减速。另外对落地区域{search_radius}范围内所有英雄造成伤害。飞踢非英雄单位会使冷却时间减少{creep_cooldown_reduction_pct}%。',
    ...
    FacetArray_B: [
        {
            ...
            name: '摔角行家 | 酒友',
            description:
                "巨牙海民可以施放<b color='white'>摔角行家</b>，使附近敌人受到攻击时承受额外伤害。 巨牙海民可以施放<b color='white'>酒友</b>，把他和一名队友拉近，双方都会获得移动速度和攻击力加成。",
            related_abilities: [],
            related_talents: [
                {
