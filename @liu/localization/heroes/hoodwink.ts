...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            name: '猎手旋镖',
            description:
                '掷出一把沿弧线飞行的回旋镖。击中后会飞回至森海飞霞。回旋镖对沿途击中的敌人都会造成伤害，并且施加一个猎手印记，使受到作用的敌人被减速，承受的技能伤害增加。',
        ...
        },
        {
            ...
            name: '诱敌奇术',
            description:
                '森海飞霞进入隐身，提升移动速度，并且产生一个引诱敌人的幻象，幻象会瞄准最近的敌方英雄开始蓄力准备发射伤害较低的一箭穿心。如果幻象被攻击或被指向性技能击中，幻象将被摧毁并且攻击者将受到较弱的野地奇袭效果。',
            notes: [],
        },
        {
            ...
            name: '爆栗出击',
            description:
                '森海飞霞向目标单位发射一颗橡栗，可以弹射至附近敌人，减缓他们的移动速度，并造成攻击伤害的一定百分比和额外伤害。\\n可以对地面施放，在目标地点种出一棵树，而橡栗会弹射至附近目标。设为多样施法后会强制沿用该行为。',
        ...
        },
        {
            ...
            notes: ['若树木被摧毁，被影响的单位将解除眩晕。', '野地奇袭不会击中隐身单位。'],
        },
        {
        ...
        },
        {
            ...
            name: '一箭穿心',
            description:
                '森海飞霞装载她的弩机，射出致命的一箭，对一名敌方英雄造成高额伤害，并施加破坏和减速效果。伤害和负面状态持续时间随着装载时间增加，{max_charge_time}秒后达到最大效果，弩箭在{misfire_time}秒后自动发射。\\n由于弩箭的威力，森海飞霞后退{recoil_distance}距离。弩箭穿过的非英雄单位会受到半额伤害。',
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '密林奔走',
            description:
                '获得{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%移动速度加成，{MODIFIER_PROPERTY_ATTACK_RANGE_BONUS}攻击和施法距离加成，还可以穿越单位和树木。',
        },
        {
