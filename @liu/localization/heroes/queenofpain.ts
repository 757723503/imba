    ...
    AbilityArray: [
        {
            ...
            name: '暗影突袭',
            description:
                '投出一把淬毒匕首，造成大量初始伤害，并持续造成后续伤害。中毒的单位移动速度被减缓，持续{duration}秒。每{damage_interval}秒会再造成一次伤害。',
            lore: '阿卡莎的淬毒匕首让她从受害者的痛苦中得到愉悦。',
            scepter_description:
                '暗影突袭变为{aoe_radius}范围型技能，并且初始伤害提升。暗影突袭效果结束后或重新施加给敌方英雄时，目标将放出痛苦尖叫，伤害附近所有敌人。',
            notes: ['受到作用的单位在持续时间内将逐秒缓慢地恢复至初始移动速度。', '受到暗影突袭作用的单位在生命值低于最大值25%时可以被队友反补。'],
        },
        {
        ...
        },
        {
            ...
            notes: ['距离为{max_radius}时效果最低，为{spell_lifesteal}%，距离在{close_radius}时提升至{spell_lifesteal}%。'],
        },
        {
