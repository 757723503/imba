...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            shard_description: '{recast_delay}秒延迟后目标会再次受到{recast_effectiveness_pct}%威力的洗礼。',
            notes: [],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '全能之存在',
            description: '全能骑士对退化光环下的英雄造成更多伤害。',
            related_abilities: [
                {
                    ability_classname: 'imba_omniknight_degen_aura',
                    description: '目标受到光环作用的时间每达到{stack_interval}秒，全能骑士对该目标的伤害都会增加{bonus_damage_per_stack}%。',
                },
            ],
            related_talents: [],
        },
    ...
    ModifierArray: [
        {
            ...
            name: '驱逐',
            description:
                '状态抗性提升{MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING}%，力量提升{MODIFIER_PROPERTY_STATS_STRENGTH_BONUS}点，生命恢复提升{MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT}点/秒。',
        },
        {
