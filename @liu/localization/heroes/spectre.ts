    ...
    AbilityArray: [
        {
            ...
            name: '幽鬼之刃',
            description:
                '幽鬼掷出一把匕首，留下一条暗影之径，对路径上的敌人造成伤害并减缓其移动速度。被匕首击中的单位移动时也会留下暗影之径。幽鬼在暗影之径上可以无视地形移动。',
            lore: '墨丘利的匕首将物质位面遮蔽于暗影中，凡人在其中畏缩不前，但幽鬼们相当强势。',
            notes: ['在离开暗影之径后{dagger_grace_period}秒内碰撞体积依然为0，作为缓冲时间。', '不会触发法术抵抗或法术反弹。'],
        },
        {
        ...
        },
        {
            ...
            shard_description:
                '折射可以主动施放，吸收和反弹的伤害比例提升{activation_bonus_pct}%，持续{activation_duration}秒。冷却时间为{activation_cooldown}秒。魔法消耗为{activation_manacost}点。',
            notes: ['幽鬼本身不承受被折射的伤害。', '幻象并不继承此技能。', '伤害在减免前折射，并且折射的伤害与原伤害类型相同。'],
        },
        {
        ...
        },
        {
            ...
            name: '如影随形',
            description:
                '创造一个复仇鬼影攻击视野内单个敌方英雄。在技能持续期间内幽鬼可以使用空降将她和鬼影互换位置。\\n\\n鬼影无法控制，受到额外伤害，造成的伤害低于幽鬼本体。鬼影移动无视地形。',
