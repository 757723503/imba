    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "dagger_path_duration",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "buff_persistence",
                    text: ""
                },
                {
                    ability_special: "dagger_radius",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "dagger_grace_period",
                    text: ""
                },
                {
                    ability_special: "applies_desolate",
                    text: ""
                }
            ],
            name: "幽鬼之刃",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "only_creep_allies_damage_pct",
                    text: ""
                }
            ],
            name: "荒芜",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "activation_bonus_pct",
                    text: ""
                },
                {
                    ability_special: "activation_duration",
                    text: ""
                }
            ],
            name: "折射",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "illusion_damage_outgoing",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "illusion_damage_incoming",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "attack_delay",
                    text: ""
                },
                {
                    ability_special: "destroy_if_target_is_dead",
                    text: ""
                }
            ],
            name: "鬼影重重",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "cast_dagger_on_target",
                    text: ""
                },
                {
