...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "damage_modifier",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "split_shot_bonus_range",
                    text: ""
                }
            ],
            name: "分裂箭",
            description: "美杜莎施展魔法将她的箭分裂成若干支箭矢。分裂箭造成的伤害为正常攻击力的一定百分比。\\n\\n额外目标不会受到其他攻击特效（比如致命一击）的作用。",
            lore: "遇到了被诅咒的蛇发女妖，那就会领教到她的愤怒。",
            notes: [
                "次级目标将是除了主要目标外距离最近的敌方单位。",
                "如果在分裂箭激活的状态下创造幻象，幻象也将继承此技能。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "snake_damage_pct",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "initial_speed",
                    text: ""
                },
                {
                    ability_special: "return_speed",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "mana_per_damage",
                    text: ""
                },
                {
                    ability_special: "attack_buff_duration",
                    text: ""
                }
            ],
            name: "秘术异蛇",
            description: "放出一条秘术异蛇在敌人之间跳跃，造成伤害。每次跳跃后伤害和速度都会增加。抵达最后一个目标后，它会返回到美杜莎身上为其恢复魔法值。异蛇会返还所有目标最大魔法值一定百分比的魔法。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "absorption_pct",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "aspd_increase_smoothness",
                    text: ""
                },
                {
                    ability_special: "aspd_increase_rate_pct",
                    text: ""
                },
                {
                    ability_special: "aspd_increase_max_tooltip",
                    text: ""
                },
                {
                    ability_special: "aspd_increase_buff_duration",
                    text: ""
                },
                {
                    ability_special: "aspd_increase_mana_cost_pct",
                    text: ""
                },
                {
                    ability_special: "aspd_increase_max_aspd_time",
                    text: ""
                },
                {
                    ability_special: "attack_buff_cooldown",
                    text: ""
                },
                {
                    ability_special: "min_duration",
                    text: ""
                }
            ],
            name: "魔法盾",
            description: "创造一个魔法护盾，消耗美杜莎的魔法值以吸收{absorption_pct}{的伤害，美杜莎每次升级都会使伤害吸收系数提升。幻象的伤害吸收系数减少{illusion_percentage}}。",
            lore: "尽管美杜莎生来没被赐以永恒的生命，但她所受的诅咒赋予了她独一无二的防御力量。",
            notes: [
                "伤害的吸收先于任何伤害减免机制，所以提高物理护甲，物理格挡和魔法抗性都不能减少吸收相同伤害所需的魔法。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "face_duration",
                    text: ""
                },
                {
                    ability_special: "vision_cone",
                    text: ""
                },
                {
            ...
            name: "石化凝视",
            description: "任何盯着蛇发女妖的敌方单位的攻击速度和移动速度均将被减缓。如果一单位在石化凝视期间盯着蛇发女妖超过{face_duration}秒，该单位会被完全石化。被石化的单位处于眩晕状态，受到物理攻击时承受额外伤害。",
            lore: "美杜莎的美貌感天动地。",
            notes: [
                "无论敌方单位是在美杜莎施放技能期间的何时受到石化凝视作用，他受到的技能效果都是满额的持续时间。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "volley_interval",
                    text: ""
                },
                {
                    ability_special: "volley_spread_pct",
                    text: ""
                },
                {
                    ability_special: "volley_count",
                    text: ""
                },
                {
                    ability_special: "duration",
            ...
            name: "罗网箭阵",
            description: "美杜莎沿着一条直线射出{volley_count}组箭矢，每组都比上一组更大。被齐射的箭矢击中的敌人会受到初始爆发伤害，被缠绕，被敌人发现，而且受到每秒伤害。",
            lore: "",
            notes: []
        },
        {
    ...
    ModifierArray: [
        {
            ...
            name: "秘术异蛇",
            description: "移动速度减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，转身速率降低{MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE}%。"
        },
        {
            modifier_classname: "modifier_imba_medusa_mana_shield",
            name: "魔法盾",
            description: "以每点魔法吸收%fMODIFIER_PROPERTY_TOOLTIP2%点伤害的代价吸收{MODIFIER_PROPERTY_TOOLTIP}%的伤害。"
        },
        {
