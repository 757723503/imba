...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '抓树',
            description:
                '抓起一棵树砸向敌人的头，可以使用一定次数。攻击距离得到提升。攻击造成更多伤害，并且路径上的单位受到溅射伤害。可以将树木扔出，对远距离的敌人造成攻击伤害。',
            lore: '木棍和石头就能让骨头散架，而建筑也将马上步其后尘。',
        ...
        },
        {
            ...
            shard_description: '扔出的树木造成的伤害提升{bonus_bonus_damage}点。',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            name: '稳如磐石',
            description:
                '小小的攻击速度无法超过或低于{max_attack_speed}，但他本应从物品或加成效果中获得的攻击速度的{attack_speed_to_damage}%将转化为攻击力。',
            notes: [],
        },
        {
    ...
    FacetArray_B: [
        {
            ...
            name: '紧急着陆',
            description: '被投掷的单位会被减速，并且对投掷目的地的其他单位造成额外伤害。',
            related_abilities: [
                {
                    ability_classname: 'imba_tiny_toss',
                    description: '被投掷的单位会被减速，并且对投掷目的地的其他单位造成额外伤害。',
