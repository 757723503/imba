    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "projectile_speed_bonus",
                    text: ""
                },
                {
                    ability_special: "tree_destruction_radius",
                    text: ""
                },
                {
                    ability_special: "attack_point",
                    text: ""
                },
                {
            ...
            name: "严寒烧灼",
            description: "寒冬飞龙乘着一股极地寒风扶摇而上，移动将无视地形，每次攻击都将呼出逼人的寒气。高飞时，她的攻击距离更远，攻击弹道速度也更快，被攻击的敌人在寒意作用下，移动速度会被减缓，同时每秒损失{percent_damage}%当前生命值。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "projectile_max_time",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "secondary_projectile_speed",
                    text: ""
                },
                {
            ...
            name: "碎裂冲击",
            description: "向一个单位发射一团易碎的冰球。冰球一击中目标就会碎裂，而目标单位将不会受到任何效果，但是附近{split_radius}基础范围内敌人都将因碎片的冲击受到伤害，并且移动速度减缓{movespeed_slow_tooltip}%。",
            lore: "这些冰渣由她冰冻的咽喉中特殊的囊泡慢慢生成，寒冬飞龙正借此轰击她的敌人。",
            notes: [
                "主弹道的移动速度为{projectile_speed}。",
                "主弹道无法被躲避，而且不能以寒冬飞龙自身为目标。"
            ]
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "shard_splinter_range",
                    text: ""
                }
            ],
            name: "极寒之拥",
            ...
            shard_description: "极寒之拥结束时会在该地点放出一次碎裂冲击，打击{shard_splinter_range}范围内的敌人。冷却时间减少{shard_cooldown_reduction}秒。",
            notes: []
        },
        {
            ...
            name: "寒冬诅咒",
            description: "寒冬飞龙驱散一个敌方目标并将其冻在原地，附近的其他敌人将受到癫狂诅咒，对冻住的队友进行攻击，而且攻击速度得到提升。冻住的目标和被诅咒攻击队友的敌人不会受到任何来自敌方的伤害，不过寒冬飞龙或她控制的单位造成的魔法伤害除外，而且伤害还得到了加深。",
            lore: "这个诅咒在书龙咒语中最为古老，也是那句老话的真相：有时候我的敌人的敌人还是我的敌人。",
            notes: [
                "如果目标被其队友击杀，击杀者将仍是寒冰飞龙。",
                "无视主目标的减益免疫状态，但是对目标周围的减益免疫队友无效。"
            ]
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "share_percentage",
                    text: ""
                }
            ],
            name: "古龙学者",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "attack_range_per_damage",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "attack_range_min",
                    text: ""
                }
            ],
            name: "飞龙视野",
