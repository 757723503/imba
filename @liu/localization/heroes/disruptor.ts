    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "strike_damage_bonus",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "shard_ground_delay",
                    text: ""
                },
                {
                    ability_special: "hits_units_inside_kinetic",
                    text: ""
                }
            ],
            name: "风雷之击",
            description: "用闪电反复打击目标单位。每次打击会伤害附近小范围内的敌方单位，并施加{slow_duration}秒的{slow_amount}%攻击速度和移动速度降低效果。提供目标的视野。",
            lore: "干扰者的充能线圈有时会超负荷，然后他的敌人就只剩一块烤焦的盔甲碎片或者一簇毛皮了。",
            shard_description: "提升风雷之击的施法距离和打击次数。还可以对地施放，使风雷之击先潜伏最多{shard_ground_delay}秒，并附着到第一个进入作用范围的敌人身上。",
            notes: []
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "backtrack_time",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            lore: "",
            notes: [
                "{damage_reset_interval}秒后伤害计数会重置。"
            ]
        },
        {
