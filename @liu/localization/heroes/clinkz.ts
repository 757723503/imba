    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "strafe_skeleton_radius",
                    text: ""
                },
                {
                    ability_special: "archer_attack_speed_pct",
                    text: ""
                },
                {
            ...
            name: "扫射",
            description: "克林克兹获得攻击速度和攻击距离加成。克林克兹{strafe_skeleton_radius}范围内现有的骷髅弓手也会获得攻击距离加成和{archer_attack_speed_pct}%攻击速度加成。<br><br>施放扫射不会脱离骨隐步的隐身状态。",
            lore: "",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "archers_use_barrage",
                    text: ""
                }
            ],
            name: "炽烈火雨",
            description: "持续施法 - 克林克兹持续朝目标方向射出多支灼热的箭矢，击中所有敌人，造成克林克兹攻击伤害的一定百分比并施加攻击特效，同时敌人会受到焦油炸弹的减速效果。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "skeleton_offset",
                    text: ""
                },
                {
                    ability_special: "skeleton_offset_min",
                    text: ""
                }
            ],
            name: "骨隐步",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "skeletons_spawned",
                    text: ""
                },
                {
                    ability_special: "spawn_skeleton_on_origin",
                    text: ""
                },
                {
            ...
            name: "死亡契约",
            description: "克林克兹以敌方非英雄单位或友方骷髅弓手为吞噬的目标，吞噬后在原地产生一个骷髅弓手，治疗并获得最大生命值。不会使克林克兹脱离骨隐步。<br><br>同一时间死亡契约召唤的骷髅弓手只有一个。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "skeleton_health",
                    text: ""
                },
                {
            ...
            name: "骨头和箭头",
            description: "克林克兹死亡时会召唤一个骷髅弓手。骷髅弓手不能移动，需要多次英雄攻击才会被击杀。骷髅弓手继承克林克兹一定百分比的攻击力，对建筑造成的伤害较低。攻击距离与克林克兹相同。<br><br>克林克兹的其他部分技能也可以召唤骷髅弓手。",
            lore: "",
            notes: []
        },
        {
            ...
            name: "焦油炸弹",
            description: "克林克兹对敌方目标扔出一个涂满焦油的弹道，击中时造成魔法伤害。击中后焦油会溅到地上，并留在地面上，持续{ground_duration}秒。经过的敌人都会被减速，并且受到来自克林克兹或他的骷髅弓手的攻击都会承受额外物理伤害。<br><br>焦油炸弹击中时，攻击距离内的骷髅弓手都会攻击该目标。",
            lore: "",
            notes: []
        },
        {
