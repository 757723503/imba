    ...
    AbilityArray: [
        {
            ...
            name: '寒霜之足',
            description:
                '在一个敌方单位身上释放死亡雾霜叠加效果，但目标只要远离施法点足够距离即可消除。如果敌方单位没有在4秒内走出消除距离，则将被眩晕并冻在原地。',
        ...
        },
        {
            ...
            name: '极寒之触',
            description:
                '使远古冰魄的普通攻击具有攻击距离加成，并附带高额魔法伤害。施加死亡雾霜叠加层数，持续{duration}秒。额外施加持续{slow_duration}秒的{slow}%减速。',
        ...
        },
        {
            ...
            name: '冰晶爆轰',
            description:
                '向地图的任意位置发出爆炸冰球，在冰球飞行时再次施放此技能将使其停下，使所在区域产生毁灭性的冰爆。冰球飞行的距离越长，冰爆影响的范围也将越大。冰爆范围内的所有敌方单位将马上受到大量伤害，而处于冰球飞行路径上的敌方英雄将与冰爆范围内的敌方英雄一同受到寒霜诅咒的作用，获得死亡雾霜叠加层数，同时无法回复生命。在此期间如果生命值低于一定百分比，该英雄将立刻死亡。',
