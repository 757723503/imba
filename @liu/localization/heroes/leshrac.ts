...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            shard_description:
                '撕裂大地在相同地点再重复{shard_max_count}次，重复间隔为{shard_secondary_delay}秒。每次作用范围增加{shard_radius_increase}。撕裂大地的重复地点对双方队伍可见。',
            notes: ['撕裂大地将摧毁作用范围内的树木。', '技能经过{delay}秒延迟后生效。'],
        },
        {
        ...
        },
        {
            ...
            name: '虚无主义',
            description:
                '使拉席克和范围内所有敌人变为虚无状态，他们无法攻击，并且承受的魔法伤害增加，移动速度被减缓。拉席克的移动速度得到提升，而不是减缓。拉席克受到的魔法伤害不会增加。',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            name: '时光滋养',
            description:
                '拉席克攻击敌人后会回复{mana_pct_per_hit}%造成伤害的魔法。只有在攻击拥有魔法的敌人时才会获得魔法。攻击非英雄单位时回复的魔法减少{mana_pct_per_hit}%。',
            notes: [],
        },
        {
            ...
            name: '大肆污染',
            description: '拉席克的每点智力都会提供作用范围加成。',
            notes: [],
        },
    ],
    TalentArray: [
    ...
    FacetArray_B: [
        {
            ...
            name: '时光滋养 | 厌世',
            description: '拉席克的攻击会回复魔法。 提升恶魔敕令的爆炸速度，但是不再对建筑造成伤害。',
            related_abilities: [
                {
                    ability_classname: 'imba_leshrac_diabolic_edict',
                    description: '恶魔敕令以更高的爆炸速度击中敌人，但是不再对建筑造成伤害。',
                },
            ],
            related_talents: [],
        },
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '虚无主义',
            description:
                '减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%移动速度并且受到的魔法伤害增加{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。',
        },
    ],
};
