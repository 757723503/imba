    ...
    AbilityArray: [
        {
            ...
            shard_description:
                '天怒法师施放奥法鹰隼时，会产生{total_bolt_count}个鹰隼，其中一个飞往原目标，而另一个飞往原目标附近{extra_bolt_search_radius}范围内一个随机敌人。以英雄为首要目标。',
            scepter_description:
                '天怒法师施放奥法鹰隼时，会产生{total_bolt_count}个鹰隼，其中一个飞往原目标，而其他的——飞往原目标附近{extra_bolt_search_radius}范围内随机敌人。以英雄为首要目标。',
            notes: ['鹰群移动得非常缓慢（500移速），提供325范围的视野。击中目标后，将给予目标区域的视野，持续3.34秒。', '奥法鹰隼无法被躲避。'],
        },
        {
            ...
            name: '震荡光弹',
            description:
                '天怒法师释放一个远距离的光弹，将击中超大范围内最近的英雄。击中后会对英雄附近范围内所有单位造成伤害和减速。对非英雄单位造成{creep_damage_pct}%伤害。',
        ...
        },
        {
            ...
            name: '神秘之耀',
            description:
                '天怒法师操控终极魔力，召唤精准致命的奥术力场毁灭对手。{duration}秒期间对范围内所有敌方英雄造成大量伤害，伤害由所有英雄平摊。',
        ...
        },
        {
            ...
            name: '天裔之盾',
            description:
                '每次天怒法师用技能对敌方英雄造成魔法伤害时，他都会获得一个魔法伤害护盾，数值等于{damage_barrier_base} + 英雄等级 * {damage_barrier_per_level}。每个加成状态独立叠加。',
            notes: [],
        },
        {
