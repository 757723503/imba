    ...
    AbilityArray: [
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "targets_buildings",
                    text: ""
                }
            ],
            name: "锚击",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "duration_pct",
                    text: ""
                },
                {
                    ability_special: "range_pct",
                    text: ""
                }
            ],
            name: "深海触须",
            description: "潮汐猎人释放出大量触手，对触及的敌人造成伤害和眩晕。触须造成{damage_pct}{毁灭的伤害和眩晕，距离为{range_pct}}毁灭的作用范围。",
            lore: "",
            notes: []
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "model_scale_base",
                    text: ""
                },
                {
                    ability_special: "model_scale_per_level",
                    text: ""
                },
                {
                    ability_special: "attack_range_base",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "anchor_smash_radius_base",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "health_bar_offset_base",
                    text: ""
                },
                {
                    ability_special: "health_bar_offset_per_level",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "damage_cleanse",
                    text: ""
                },
                {
