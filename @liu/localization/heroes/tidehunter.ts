...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            notes: ['破坏会使技能无法获得新的海妖坚壳叠加效果。', '破坏不会使现有的海妖坚壳叠加效果提供的加成失效。'],
        },
        {
        ...
        },
        {
            ...
            notes: ['毁灭能伤害隐身单位。', '毁灭以{speed}的速度向外扩散。'],
        },
        {
            ...
            name: '深海触须',
            description:
                '潮汐猎人释放出大量触手，对触及的敌人造成伤害和眩晕。触须造成{damage_pct}%毁灭的伤害和眩晕，距离为{damage_pct}%毁灭的作用范围。',
            notes: [],
        },
        {
            ...
            name: '重如铁锚',
            description:
                '潮汐猎人将一只重锚栓到一名敌方英雄身上。被栓到锚上的英雄处于被束缚状态。尝试移动到距离巨锚{chain_length}距离外会导致英雄的移动速度降低至{max_movement_speed}，而且会一直拽着长锚。巨锚承受{attacks_to_destroy}次英雄攻击后会被摧毁。',
            notes: [],
        },
        {
            ...
            name: '食虾猎人',
            description:
                '潮汐猎人在比赛开始时体形会小很多，并且攻击距离-{attack_range_base}，锚击作用范围-{anchor_smash_radius_base}。随着经验的增加，潮汐猎人会变大，每升一级都会获得攻击距离和锚击范围。基础力量减少，力量成长提升。',
            notes: [],
        },
        {
            ...
            name: '鲸脂',
            description:
                '潮汐猎人的外皮在他受到的伤害超过{damage_cleanse}点后还将移除负面的状态效果。会移除大部分负面效果，即使通常无法净化。\\n\\n驱散类型：强驱散',
            notes: [
