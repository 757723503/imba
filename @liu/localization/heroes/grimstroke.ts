...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: '幻影之拥',
            description:
                '召唤一个快速向目标移动的幻影，到达时将其缠住。缠住后对其造成伤害和沉默。若她在纠缠期间存活，将会撕裂目标，造成大量伤害，并刷新幻影之拥的冷却时间。\\n\\n英雄对幻影的单次攻击记为3次。',
            lore: '天涯墨客并不为族人的毁灭感到悲伤。只有对瑶薇，他最亲近的女子，他才稍稍感觉到思念。',
            notes: ['幻影在目标隐身或进入减益免疫状态后掉下。', '目标在纠缠期间阵亡后幻影将会回归。'],
        },
        {
        ...
        },
        {
            ...
            name: '浓墨重彩',
            description:
                '使敌方目标包裹在墨汁中，持续{duration}秒，攻击速度降低{attack_speed}，移动速度减缓{move_speed}%，并在持续时间内总共造成{total_damage}点伤害。',
            notes: [],
        },
        {
            ...
            name: '墨涌',
            description:
                '天涯墨客将一个友方单位笼罩在一片墨汁中，目标的移动速度得到提升。友方单位附近的敌人会持续被墨须伤害。{buff_duration}秒后将根据墨须对英雄造成伤害的时间对区域内单位造成伤害和眩晕。',
            lore: '既然高涨的墨潮不再对天涯墨客构成威胁，那么力量的墨须就不难为他所用。',
            shard_description:
                '墨涌造成的伤害增加{shard_bonus_damage_pct}%，并且治疗目标，治疗量为墨涌造成伤害的{shard_bonus_damage_pct}%。结束时目标会受到一次强驱散效果。<br><br>驱散类型：强驱散',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            name: '缚魂',
            description:
                '将一名敌方英雄与束缚作用范围内最接近的队友相连，阻止他们远离彼此。任何指向性技能击中任一英雄时，这两名敌方英雄都会受到作用。若连接在效果截止前断裂，初始目标将再次与其距离内最接近的队友相连。',
            lore: '飞升之人皆为烬州城的选召之子，通过自己的灵魂和他们应守护的族人之间创造的束缚获得了巨大的力量。在同胞毁灭的多年之后，天涯墨客发现束缚仪式更为凶险的用途……',
            notes: ['如果与另一个单位一起被束缚，作用下单位均被束缚，而且无法使用闪烁类技能。', '被束缚的单位都将提供视野。'],
        },
        {
    ...
    ModifierArray: [
        ...
        },
        {
            ...
            name: '浓墨重彩',
            description:
                '每{MODIFIER_PROPERTY_TOOLTIP}秒受到{MODIFIER_PROPERTY_TOOLTIP}点伤害。移动速度被减缓{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%，攻击速度降低{MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}。',
        },
        {
