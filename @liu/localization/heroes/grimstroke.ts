    ...
    AbilityArray: [
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "vector_stroke",
                    text: ""
                },
                {
                    ability_special: "vector_min_cos_facing_angle",
                    text: ""
                },
                {
                    ability_special: "vector_strength",
                    text: ""
                },
                {
                    ability_special: "vector_max_travel_time_multiplier",
                    text: ""
                },
                {
                    ability_special: "vector_acceptable_radian_to_snap_velocity",
                    text: ""
                },
                {
                    ability_special: "vector_distance_to_start_force_turning",
                    text: ""
                },
                {
                    ability_special: "vector_deg_turn_divisor",
                    text: ""
                },
                {
                    ability_special: "vector_deg_turn_max",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "hero_attack_multiplier",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "infection_search_radius",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "latched_unit_offset",
                    text: ""
                },
                {
                    ability_special: "latched_unit_offset_short",
                    text: ""
                }
            ],
            name: "幻影之拥",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "images_do_damage_percent",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "images_take_damage_percent",
                    text: ""
                },
                {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "can_end_early",
                    text: ""
                },
                {
                    ability_special: "shard_bonus_damage_pct",
                    text: ""
                },
                {
                    ability_special: "shard_heal_pct",
                    text: ""
                },
                {
                    ability_special: "shard_creep_penalty",
                    text: ""
                }
            ],
            name: "墨涌",
            ...
            shard_description: "墨涌造成的伤害增加{shard_bonus_damage_pct}{，并且治疗目标，治疗量为墨涌造成伤害的{shard_heal_pct}}。结束时目标会受到一次强驱散效果。<br><br>驱散类型：强驱散",
            notes: []
        },
        {
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "chain_break_distance",
                    text: ""
                },
                {
                    ability_special: "leash_limit_multiplier",
                    text: ""
                },
                {
                    ability_special: "leash_radius_buffer",
                    text: ""
                },
                {
                    ability_special: "creep_duration_pct",
                    text: ""
                },
                {
                    ability_special: "bonus_reflected_spell_damage",
                    text: ""
                }
            ],
            name: "缚魂",
