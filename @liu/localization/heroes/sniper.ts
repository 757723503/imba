...
export const data: LocalizationData = {
    AbilityArray: [
        ...
        },
        {
            ...
            name: "榴霰弹",
            description: "消耗一点能量射出一发带有爆炸弹片的榴霰弹，在目标区域降下弹雨。区域内的敌军受到伤害并被减速。榴霰弹将给予目标区域的视野。榴霰弹的能量每过{abilitychargerestoretime}秒恢复1点。",
            lore: "卡德尔的模块化步枪还能发射燃烧弹，对攻击战壕中的敌人很有用。",
            notes: [
                "总共造成11次伤害，第一次在技能生效时，接下来每秒造成一次伤害。",
                "不会对建筑造成伤害。",
                "将拥有目标区域的视野。"
            ]
        },
        {
            ...
            name: "爆头",
            description: "狙击手提高他的精确度，有一定概率造成额外伤害并击退敌人。敌人距离狙击手越近，击退距离越远。爆头会短暂地降低敌人{slow}%移动和攻击速度。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "does_root",
                    text: ""
                },
                {
                    ability_special: "require_target",
                    text: ""
                },
                {
                    ability_special: "no_reveal",
                    text: ""
                }
            ],
            name: "瞄准",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "scatter_range",
                    text: ""
                },
                {
                    ability_special: "scatter_width",
                    text: ""
                },
                {
                    ability_special: "scatter_damage_pct",
                    text: ""
                },
                {
                    ability_special: "cooldown_reduction_on_kill",
                    text: ""
                }
            ],
            name: "暗杀",
            description: "狙击手锁定一个目标敌方单位，经过短时间瞄准后从远距离射出一发毁灭性的子弹，对目标造成狙击手的攻击伤害 + 额外伤害及短暂眩晕。每当狙击手击杀敌方英雄时就会重置暗杀的冷却时间。",
