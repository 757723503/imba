    ...
    AbilityArray: [
        {
            ...
            name: '弹无虚发',
            description:
                '琼英碧灵向一个敌方单位或一棵树发射一颗幽灵子弹。子弹击中时会对敌人造成伤害和短暂减速，然后沿矢量目标的方向弹去。<br><br>跳弹将会对穿过的所有单位造成伤害，击中英雄后停下。被跳弹击中的英雄会被恐惧。',
        ...
        },
        {
            ...
            name: '唤魂',
            description:
                '召唤{num_revenants}个亡魂，缓慢地环绕目标地点。在区域内的敌人会被减速，攻击速度也会降低。亡魂会在敌人穿过时造成伤害和沉默。',
        ...
        },
        {
            ...
            shard_description:
                '琼英碧灵在越界的持续时间内获得{spell_lifesteal}%技能吸血。<br>越界生效时每次击杀敌方英雄或有敌方英雄在附近阵亡时琼英碧灵都会永久获得{spell_lifesteal}%技能增强。永久加成具有追溯效果。',
            notes: ['琼英碧灵在变身期间可以躲避弹道。', '琼英碧灵在变身后无法攻击建筑。', '其他虚无效果也不会阻止琼英碧灵发动攻击。'],
        },
        {
            ...
            name: '祭台',
            description:
                '琼英碧灵在目标地点放下一座神圣的祭台，靠近时可以提升她的攻击速度。<br><br>复活时琼英碧灵会获得{pierce_the_veil_duration_pct}%持续时间的越界加成效果，并且在祭台处复活。<br><br>琼英碧灵可以选择祭台，强行将其摧毁。同一时间只能存在一个祭台。',
            notes: [],
        },
        {
        ...
        },
        {
            ...
            name: '临别一枪',
            description:
                '琼英碧灵精准地射中一名英雄的灵魂，将其从身体中分离，并击退{knockback_distance}距离。<br>灵魂无法作为目标，被锁闭、缴械，并且是无敌状态，持续{debuff_duration}秒。<br>身体在持续时间内为眩晕状态，具有{damage_reduction_percent}%伤害减免效果。<br><br>效果结束后灵魂强制回到身体，并施加强驱散。即使英雄阵亡，灵魂也会存活到效果结束。',
            notes: ['减益免疫单位会受到枪击的伤害，但是不会从身体中分离。', '临别一枪击中友方英雄不会造成伤害。'],
        },
    ],
    TalentArray: [
        {
