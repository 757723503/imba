...
export const data: LocalizationData = {
    AbilityArray: [
        {
            ...
            name: "喷气背包",
            description: "发条技师开动喷气背包，获得飞行移动状态，飞行视野和移动速度加成。发条技师的转身速率大幅降低，并且无法攻击。施放发射钩爪会使喷气背包中止。",
            lore: "",
            notes: []
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "hookshot_damage_bonus_pct",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "rocket_flare_interval",
                    text: ""
                },
                {
                    ability_special: "rocket_flare_offset_pct",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "jetpack_turn_rate",
                    text: ""
                }
            ],
            name: "超速运转",
            description: "使发条技师的所有技能变得强力：弹幕冲击可以作用于范围内所有敌人；发条技师在能量齿轮内攻击速度大幅提升；照明火箭的冷却时间减少，并且发射时向目标两侧各额外发射一枚；发射钩爪的眩晕范围和时间均有提升；喷气背包移动得更快。持续时间结束后发条技师的移动和攻击速度降到最低。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "mana_burn_as_damage_pct",
                    text: ""
                },
                {
                    ability_special: "magic_barrier",
                    text: ""
                },
                {
                ...
                {
                    ability_special: "cogs_pullin",
                    text: ""
                },
                {
                    ability_special: "trigger_distance",
                    text: ""
                },
                {
                    ability_special: "extra_pull_buffer",
                    text: ""
                },
                {
            ...
            name: "能量齿轮",
            description: "在发条技师周围形成一圈通电的齿轮，困住附近的单位。在外侧的敌人碰到齿轮会被电流震退，损失一定的生命和魔法。同时造成{mana_burn_as_damage_pct}{损失魔法的伤害。一个齿轮发动过一次震击后就会报废。<br><br>敌人攻击齿轮数次后可将其摧毁，而发条技师需要攻击一次会将齿轮推出}projectile_distance%距离。",
        ...
        },
        {
            ...
            ability_specials: [
                ...
                {
                    ability_special: "projectile_vision_radius",
                    text: ""
                },
                {
                    ability_special: "projectile_vision_duration",
                    text: ""
                },
                {
                    ability_special: "projectile_vision_tick_rate",
                    text: ""
                }
            ],
            name: "照明火箭",
        ...
        },
        {
            ...
            name: "发射钩爪",
            description: "向目标位置高速射出钩爪，如果命中一个单位，发条技师会将自己牵引到目标身边，对目标附近{stun_radius}范围内所有敌人造成眩晕和伤害。对牵引时冲撞到的单位也造成伤害和眩晕。",
        ...
        },
        {
            ...
            ability_specials: [
                {
                    ability_special: "damage_per_armor",
                    text: ""
                }
            ],
            name: "装甲力量",
    ...
    ModifierArray: [
        ...
        {
            modifier_classname: "modifier_imba_rattletrap_cog_immune_description",
            name: "能量齿轮内减益免疫。"
        },
        {
        ...
        {
            modifier_classname: "modifier_imba_rattletrap_cog_leash_description",
            name: "被束缚"
        },
        {
        ...
        {
            modifier_classname: "modifier_imba_rattletrap_cog_barrier_description",
            name: "吸收魔法伤害中。"
        },
        {
        ...
        {
            modifier_classname: "modifier_imba_rattletrap_jetpack_description",
            name: "飞行中，移动速度提升{MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}%。"
        },
        {
