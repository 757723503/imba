  ...
  AbilityArray: [
    {
      ...
      ability_specials: [
        { ability_special: 'self_damage', text: '' },
        { ability_special: 'missile_speed', text: '' },
        { ability_special: 'target_damage', text: '' },
    ...
    },
    {
      ...
      ability_specials: [
        ...
        { ability_special: 'absorb_to_damage', text: '' },
        { ability_special: 'absorb_damage_aoe', text: '' },
      ],
    },
    {
      ability_classname: 'imba_abaddon_the_quickening',
      ability_specials: [
        { ability_special: 'cooldown_reduction_creeps', text: '' },
        { ability_special: 'cooldown_reduction_heroes', text: '' },
        { ability_special: 'radius', text: '' },
      ],
    },
    {
    ...
    },
    {
      ...
      ability_specials: [
        ...
        { ability_special: 'curse_duration', text: '' },
        { ability_special: 'curse_slow', text: '' },
        { ability_special: 'curse_attack_speed', text: '' },
        { ability_special: 'curse_dps', text: '' },
        { ability_special: 'tower_dps_pct', text: '' },
    ...
    },
    {
      ...
      ability_specials: [
        { ability_special: 'AbilityCooldown', text: '' },
        { ability_special: 'hp_threshold', text: '' },
        { ability_special: 'duration', text: '' },
        { ability_special: 'duration_scepter', text: '' },
        { ability_special: 'ally_threshold_scepter', text: '' },
        { ability_special: 'redirect_range_scepter', text: '' },
